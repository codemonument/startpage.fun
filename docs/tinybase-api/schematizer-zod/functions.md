...
The [`createZodSchematizer`](https://tinybase.org/api/schematizer-zod/functions/creation/createzodschematizer/) function creates a [`ZodSchematizer`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/) object that can convert Zod schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-zod/functions/creation/createzodschematizer/).
