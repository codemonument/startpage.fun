  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-zod`](https://tinybase.org/api/schematizer-zod/)
        * [Interfaces](https://tinybase.org/api/schematizer-zod/interfaces/)
          * [`ZodSchematizer`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-zod/functions/)
...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of Zod object schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/totablesschema/)(schemas: {[tableId: string]: any}): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `schemas`  | `{[tableId: string]: any}`  | A mapping of table IDs to Zod object schemas.  |  
...
const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/totablesschema/)({
  pets: z.object({
    species: z.string(),
    age: z.number(),
