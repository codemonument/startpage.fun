...
# `toValuesSchema`
The `toValuesSchema` method converts a mapping of Zod schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
toValuesSchema[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/tovaluesschema/)(schemas: {[valueId: string]: any}): ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/)
```
...
const valuesSchema = schematizer.toValuesSchema[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/methods/conversion/tovaluesschema/)({
