...
The `createZodSchematizer` function creates a [`ZodSchematizer`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/) object that can convert Zod schemas into TinyBase schemas.

```
createZodSchematizer[](https://tinybase.org/api/schematizer-zod/functions/creation/createzodschematizer/)(): ZodSchematizer[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/)
```
  
| returns  | `ZodSchematizer[](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/)`  | A new [`ZodSchematizer`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/) instance.  |  
| --- | --- | --- |  
