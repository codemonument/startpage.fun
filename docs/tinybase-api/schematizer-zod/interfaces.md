...
# Interfaces
## `ZodSchematizer`
The [`ZodSchematizer`](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/) interface represents a schematizer specifically for converting Zod schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-zod/interfaces/schematizer/zodschematizer/).
