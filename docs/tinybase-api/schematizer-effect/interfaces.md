...
# Interfaces
## `EffectSchematizer`
The [`EffectSchematizer`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/) interface represents a schematizer specifically for converting Effect Schema schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/).
