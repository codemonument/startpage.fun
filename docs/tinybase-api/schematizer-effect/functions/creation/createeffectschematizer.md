...
The `createEffectSchematizer` function creates an [`EffectSchematizer`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/) instance for converting Effect Schema schemas to TinyBase schemas.

```
createEffectSchematizer[](https://tinybase.org/api/schematizer-effect/functions/creation/createeffectschematizer/)(): EffectSchematizer[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/)
```
  
| returns  | `EffectSchematizer[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/)`  | A new [`EffectSchematizer`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/) instance.  |  
| --- | --- | --- |  
## Example
