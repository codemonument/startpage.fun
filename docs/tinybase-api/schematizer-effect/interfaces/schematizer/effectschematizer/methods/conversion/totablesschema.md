  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-effect`](https://tinybase.org/api/schematizer-effect/)
        * [Interfaces](https://tinybase.org/api/schematizer-effect/interfaces/)
          * [`EffectSchematizer`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-effect/functions/)
...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of Effect Schema struct schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/totablesschema/)(schemas: {[tableId: string]: any}): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
...
const schematizer = createEffectSchematizer[](https://tinybase.org/api/schematizer-effect/functions/creation/createeffectschematizer/)();

const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/totablesschema/)({
  pets: Struct({
    species: String,
    age: Number,
    sold: Boolean,
...
store.setRow[](https://tinybase.org/api/the-essentials/setting-data/setrow/)('pets', 'fido', {species: 'dog', age: 3, sold: false});
