...
# `toValuesSchema`
The `toValuesSchema` method converts a mapping of Effect Schema schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
toValuesSchema[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/tovaluesschema/)(schemas: {[valueId: string]: any}): ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/)
```
...
const valuesSchema = schematizer.toValuesSchema[](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/tovaluesschema/)({
  open: Boolean,
  employees: Number,
});
...
store.setValues[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setvalues/)({open: true, employees: 3});
