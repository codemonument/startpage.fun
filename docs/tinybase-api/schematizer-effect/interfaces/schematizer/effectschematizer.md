...
# `EffectSchematizer`
The `EffectSchematizer` interface represents a schematizer specifically for converting Effect Schema schemas into TinyBase schemas.
## Since
v7.1.0
## `toTablesSchema`
The `toTablesSchema` method converts a mapping of Effect Schema struct schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/). [Read more](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/totablesschema/).
## `toValuesSchema`
The `toValuesSchema` method converts a mapping of Effect Schema schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/). [Read more](https://tinybase.org/api/schematizer-effect/interfaces/schematizer/effectschematizer/methods/conversion/tovaluesschema/).
