...
# Other components
[![RelationshipInHtmlTable example](https://tinybase.org/shots/relationshipinhtmltable-react-demo.png)](https://tinybase.org/api/ui-react-dom/functions/other-components/relationshipinhtmltable/)
## `RelationshipInHtmlTable`
The [`RelationshipInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/other-components/relationshipinhtmltable/) component renders the contents of the two [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) linked by a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react-dom/functions/other-components/relationshipinhtmltable/).
[![SliceInHtmlTable example](https://tinybase.org/shots/sliceinhtmltable-react-demo.png)](https://tinybase.org/api/ui-react-dom/functions/other-components/sliceinhtmltable/)
## `SliceInHtmlTable`
The [`SliceInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/other-components/sliceinhtmltable/) component renders the contents of a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) as an HTML
<table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](/api/ui-react-dom/functions/other-components/sliceinhtmltable/).
