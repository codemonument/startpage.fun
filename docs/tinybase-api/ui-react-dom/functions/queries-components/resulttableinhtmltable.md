      ...
      * [`ui-react-dom`](https://tinybase.org/api/ui-react-dom/)
        * [Functions](https://tinybase.org/api/ui-react-dom/functions/)
          ...
          * [Queries components](https://tinybase.org/api/ui-react-dom/functions/queries-components/)
            * [`ResultSortedTableInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/queries-components/resultsortedtableinhtmltable/)
            * [`ResultTableInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/)
...
The `ResultTableInHtmlTable` component renders the contents of a single query's [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render.

```
ResultTableInHtmlTable[](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/)(props: (
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `props`  | `( ResultTableInHtmlTableProps[](https://tinybase.org/api/ui-react-dom/type-aliases/props/resulttableinhtmltableprops/) & HtmlTableProps[](https://tinybase.org/api/ui-react-dom/type-aliases/props/htmltableprops/) )`  | The props for this component.  |  
| returns  | `ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)`  | A rendering of the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a <table> element.  |  
See the [<ResultTableInHtmlTable /> (React)](https://tinybase.org/demos/ui-components-react/resulttableinhtmltable-react/) demo for this component in action:
...
## Examples
This example creates a Provider context into which a default [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object is provided. The `ResultTableInHtmlTable` component within it then renders the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a <table> element with a CSS class.
...
const Pane = () => (
  <ResultTableInHtmlTable[](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/) queryId="petColors" className="table" />
);
