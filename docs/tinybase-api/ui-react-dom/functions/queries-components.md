...
# Queries components
[![ResultSortedTableInHtmlTable example](https://tinybase.org/shots/resultsortedtableinhtmltable-react-demo.png)](https://tinybase.org/api/ui-react-dom/functions/queries-components/resultsortedtableinhtmltable/)
## `ResultSortedTableInHtmlTable`
The [`SortedTableInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/store-components/sortedtableinhtmltable/) component renders the contents of a single query's sorted [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react-dom/functions/queries-components/resultsortedtableinhtmltable/).
[![ResultTableInHtmlTable example](https://tinybase.org/shots/resulttableinhtmltable-react-demo.png)](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/)
## `ResultTableInHtmlTable`
The [`ResultTableInHtmlTable`](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/) component renders the contents of a single query's [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react-dom/functions/queries-components/resulttableinhtmltable/).
