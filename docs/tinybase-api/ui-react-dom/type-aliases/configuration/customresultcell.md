...
{
  label?: string;
  component?: ComponentType<ResultCellProps[](https://tinybase.org/api/ui-react/type-aliases/props/resultcellprops/)>;
  getComponentProps?: (rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/), cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)) => ExtraProps[](https://tinybase.org/api/ui-react/type-aliases/props/extraprops/);
}
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `label?`  | `string`  | An optional string that will be used as the label at the top of the table column for this [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| `component?`  | `ComponentType<ResultCellProps[](https://tinybase.org/api/ui-react/type-aliases/props/resultcellprops/)>`  | An optional custom component for rendering each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) (to override the default [`ResultCellView`](https://tinybase.org/api/ui-react/functions/queries-components/resultcellview/) component).  |  
| `getComponentProps?`  | `(rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/), cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)) => ExtraProps[](https://tinybase.org/api/ui-react/type-aliases/props/extraprops/)`  | An optional function for generating extra props for each custom [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) component based on [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) and [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).  |  
## Since
v4.1.0
