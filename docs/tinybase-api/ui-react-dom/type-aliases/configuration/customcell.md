...
{
  label?: string;
  component?: ComponentType<CellProps[](https://tinybase.org/api/ui-react/type-aliases/props/cellprops/)>;
...
| `component?`  | `ComponentType<CellProps[](https://tinybase.org/api/ui-react/type-aliases/props/cellprops/)>`  | An optional custom component for rendering each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) (to override the default [`CellView`](https://tinybase.org/api/ui-react/functions/store-components/cellview/) component).  |  
