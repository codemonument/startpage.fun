      ...
      * [`ui-react-dom`](https://tinybase.org/api/ui-react-dom/)
        ...
        * [Type Aliases](https://tinybase.org/api/ui-react-dom/type-aliases/)
          * [Configuration type aliases](https://tinybase.org/api/ui-react-dom/type-aliases/configuration/)
            * [`ExtraRowCell`](https://tinybase.org/api/ui-react-dom/type-aliases/configuration/extrarowcell/)
            * [`CustomCell`](https://tinybase.org/api/ui-react-dom/type-aliases/configuration/customcell/)
            * [`CustomResultCell`](https://tinybase.org/api/ui-react-dom/type-aliases/configuration/customresultcell/)
            * [`ExtraValueCell`](https://tinybase.org/api/ui-react-dom/type-aliases/configuration/extravaluecell/)
