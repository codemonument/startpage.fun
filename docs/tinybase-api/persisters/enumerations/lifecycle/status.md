    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`persisters`](https://tinybase.org/api/persisters/)
        ...
        * [Enumerations](https://tinybase.org/api/persisters/enumerations/)
          * [Lifecycle enumerations](https://tinybase.org/api/persisters/enumerations/lifecycle/)
            * [`Status`](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
          * [Mergeable enumerations](https://tinybase.org/api/persisters/enumerations/mergeable/)
...
# `Status`
The `Status` enum is used to indicate whether a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is idle, or loading or saving data.
...
|   | Value  | Description  |  
| --- | --- | --- |  
| `Idle`  | `0`  | Indicates that the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is neither loading or saving data.  |  
| `Loading`  | `1`  | Indicates that the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is loading data.  |  
| `Saving`  | `2`  | Indicates that the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is saving data.  |  
The enum is intended to be used to understand the status of the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) in conjunction with the getStatus and [`addStatusListener`](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/listener/addstatuslistener/) methods.
Note that a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) cannot be loading and saving data at the same time.
## Since
v5.3.0
