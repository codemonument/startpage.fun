      ...
      * [`persisters`](https://tinybase.org/api/persisters/)
        ...
        * [Enumerations](https://tinybase.org/api/persisters/enumerations/)
          ...
          * [Mergeable enumerations](https://tinybase.org/api/persisters/enumerations/mergeable/)
            * [`Persists`](https://tinybase.org/api/persisters/enumerations/mergeable/persists/)
...
## `Persists`
The [`Persists`](https://tinybase.org/api/persisters/enumerations/mergeable/persists/) enum is used to indicate whether a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) can support a regular [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/), or both. [Read more](https://tinybase.org/api/persisters/enumerations/mergeable/persists/).
