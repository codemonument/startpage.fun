...
## `Status`
The [`Status`](https://tinybase.org/api/persisters/enumerations/lifecycle/status/) enum is used to indicate whether a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is idle, or loading or saving data. [Read more](https://tinybase.org/api/persisters/enumerations/lifecycle/status/).
