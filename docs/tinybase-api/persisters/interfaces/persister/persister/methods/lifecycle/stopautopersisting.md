...
```
stopAutoPersisting[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/stopautopersisting/)(stopSaveFirst?: boolean): Promise<Persister[](https://tinybase.org/api/persisters/interfaces/persister/persister/)<Persist>>
```
...
This simply runs the stopAutoLoad and [`stopAutoSave`](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/save/stopautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
...
await persister.stopAutoPersisting[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/stopautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/save/isautosaving/)());
// -> false
console.log(persister.isAutoLoading[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/load/isautoloading/)());
// -> false
