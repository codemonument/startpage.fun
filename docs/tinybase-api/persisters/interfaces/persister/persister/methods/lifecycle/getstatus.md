...
```
getStatus[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/getstatus/)(): Status[](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
```
...
console.log(persister.getStatus[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/getstatus/)());
// -> 0
