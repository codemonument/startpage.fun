...
): Promise<Persister[](https://tinybase.org/api/persisters/interfaces/persister/persister/)<Persist>>
```
...
This simply runs the startAutoLoad and [`startAutoSave`](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/save/startautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
This method can take `initialContent` to pass to the [`startAutoLoad`](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/load/startautoload/) method. See its documentation for more details.
...
await persister.startAutoPersisting[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/startautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/save/isautosaving/)());
// -> true
console.log(persister.isAutoLoading[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/load/isautoloading/)());
// -> true

persister.destroy[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/destroy/)();
