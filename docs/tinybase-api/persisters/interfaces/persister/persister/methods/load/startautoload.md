...
```
startAutoLoad[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<Persister[](https://tinybase.org/api/persisters/interfaces/persister/persister/)<Persist>>
```
...
| returns  | `Promise<Persister[](https://tinybase.org/api/persisters/interfaces/persister/persister/)<Persist>>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
