...
## `Persister`
Essential
A [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object lets you save and load [`Store`](https://tinybase.org/api/store/interfaces/store/store/) data to and from different locations, or underlying storage types. [Read more](https://tinybase.org/api/persisters/interfaces/persister/persister/).
