...
# `PersisterStats`
The `PersisterStats` type describes the number of times a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) object has loaded or saved data.
...
A `PersisterStats` object is returned from the [`getStats`](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/development/getstats/) method.
## Since
v1.0.0
