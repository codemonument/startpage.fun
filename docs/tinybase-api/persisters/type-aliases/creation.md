...
The [`DatabaseChangeListener`](https://tinybase.org/api/persisters/type-aliases/creation/databasechangelistener/) type describes a function that is used to listen for changes to the data in a database. [Read more](https://tinybase.org/api/persisters/type-aliases/creation/databasechangelistener/).
## `DatabaseExecuteCommand`
The [`DatabaseExecuteCommand`](https://tinybase.org/api/persisters/type-aliases/creation/databaseexecutecommand/) type describes a function that is used to execute commands against a database. [Read more](https://tinybase.org/api/persisters/type-aliases/creation/databaseexecutecommand/).
## `PersisterListener`
A [`PersisterListener`](https://tinybase.org/api/persisters/type-aliases/creation/persisterlistener/) is a generic representation of the callback that lets a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) inform the store that a change has happened to the underlying data. [Read more](https://tinybase.org/api/persisters/type-aliases/creation/persisterlistener/).
