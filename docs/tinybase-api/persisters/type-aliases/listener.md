...
## `StatusListener`
The [`StatusListener`](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/) type describes a function that is used to listen to changes to the loading and saving status of the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/). [Read more](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/).
