...
## `PersisterStats`
The [`PersisterStats`](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/) type describes the number of times a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) object has loaded or saved data. [Read more](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/).
