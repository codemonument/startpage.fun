      ...
      * [`persisters`](https://tinybase.org/api/persisters/)
        ...
        * [Type Aliases](https://tinybase.org/api/persisters/type-aliases/)
          ...
          * [Mergeable type aliases](https://tinybase.org/api/persisters/type-aliases/mergeable/)
            * [`PersistedStore`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedstore/)
            * [`AnyPersister`](https://tinybase.org/api/persisters/type-aliases/mergeable/anypersister/)
            * [`PersistedChanges`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedchanges/)
            * [`PersistedContent`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedcontent/)
...
## `PersistedStore`
The [`PersistedStore`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedstore/) type is a generic representation of the type of store being handled by a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/). [Read more](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedstore/).
## `AnyPersister`
The [`AnyPersister`](https://tinybase.org/api/persisters/type-aliases/mergeable/anypersister/) type is a convenient alias for any type of [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) that can persist [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) or [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects. [Read more](https://tinybase.org/api/persisters/type-aliases/mergeable/anypersister/).
## `PersistedChanges`
The [`PersistedChanges`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedchanges/) type is a generic representation of changes made to the type of store being handled by a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/). [Read more](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedchanges/).
## `PersistedContent`
The [`PersistedContent`](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedcontent/) type is a generic representation of the content in the type of store being handled by a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/). [Read more](https://tinybase.org/api/persisters/type-aliases/mergeable/persistedcontent/).
