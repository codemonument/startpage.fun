...
# `AnyPersister`
The `AnyPersister` type is a convenient alias for any type of [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that can persist [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) or [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects.

```
Persister[](https://tinybase.org/api/persisters/interfaces/persister/persister/)<Persists[](https://tinybase.org/api/persisters/enumerations/mergeable/persists/)>
```
