...
## Listener type aliases
  * [`StatusListener`](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)
...
## Development type aliases
  * [`PersisterStats`](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/)
