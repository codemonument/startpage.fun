...
The `PersisterOrPersisterId` type is used when you need to refer to a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) object in a ui-svelte function or component.
...
Many functions and components in this [`ui-svelte`](https://tinybase.org/api/ui-svelte/) module take this type as a parameter or a prop, allowing you to pass in either the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) or its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
## Since
v8.1.0
