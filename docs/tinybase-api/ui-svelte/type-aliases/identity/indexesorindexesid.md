...
# `IndexesOrIndexesId`
The `IndexesOrIndexesId` type is used when you need to refer to an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object in a ui-svelte function or component.
...
Many functions and components in this [`ui-svelte`](https://tinybase.org/api/ui-svelte/) module take this type as a parameter or a prop, allowing you to pass in either the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object or its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
## Since
v8.1.0
