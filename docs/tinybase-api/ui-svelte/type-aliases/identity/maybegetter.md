...
When a getter function is provided to a reactive function, its internal `$effect` will re-run whenever the getter's reactive dependencies change. This is the mechanism that makes Svelte 5 props reactive in these functions.
## Since
v8.1.0
