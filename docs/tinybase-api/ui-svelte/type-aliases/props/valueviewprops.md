...
# `ValueViewProps`
`ValueViewProps` props are used for components that refer to a single [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), such as the [`ValueView`](https://tinybase.org/api/ui-svelte/functions/component/valueview/) component.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `valueId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to be rendered.  |  
