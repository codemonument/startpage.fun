...
`CurrentCheckpointViewProps` props are used for components that refer to the current checkpoint in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, such as the [`CurrentCheckpointView`](https://tinybase.org/api/ui-svelte/functions/component/currentcheckpointview/) component.

```
{
  checkpoints?: CheckpointsOrCheckpointsId[](https://tinybase.org/api/ui-svelte/type-aliases/identity/checkpointsorcheckpointsid/);
  debugIds?: boolean;
  checkpoint?: Snippet<[checkpointId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]>;
}
```
...
| `debugIds?`  | `boolean`  | Whether the component should also render the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the current checkpoint to assist with debugging.  |  
| `checkpoint?`  | `Snippet<[checkpointId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]>`  | A snippet for rendering the current checkpoint in the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.  |  
## Since
v8.1.0
