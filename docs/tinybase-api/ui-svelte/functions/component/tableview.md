...
TableView[](https://tinybase.org/api/ui-svelte/functions/component/tableview/)(
  this: void,
  props: TableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tableviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<TableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tableviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `TableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tableviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<TableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tableviewprops/)>): void; }`  |   |  
## Since
v8.1.0
