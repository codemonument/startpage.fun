...
MetricView[](https://tinybase.org/api/ui-svelte/functions/component/metricview/)(
  this: void,
  props: MetricViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/metricviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<MetricViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/metricviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `MetricViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/metricviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<MetricViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/metricviewprops/)>): void; }`  |   |  
## Since
v8.1.0
