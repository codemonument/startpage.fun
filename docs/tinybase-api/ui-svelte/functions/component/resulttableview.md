...
ResultTableView[](https://tinybase.org/api/ui-svelte/functions/component/resulttableview/)(
  this: void,
  props: ResultTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resulttableviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<ResultTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resulttableviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `ResultTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resulttableviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<ResultTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resulttableviewprops/)>): void; }`  |   |  
## Since
v8.1.0
