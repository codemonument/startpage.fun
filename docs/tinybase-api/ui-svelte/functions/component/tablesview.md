...
TablesView[](https://tinybase.org/api/ui-svelte/functions/component/tablesview/)(
  this: void,
  props: TablesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tablesviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<TablesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tablesviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `TablesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tablesviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<TablesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/tablesviewprops/)>): void; }`  |   |  
## Since
v8.1.0
