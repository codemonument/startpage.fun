...
LocalRowsView[](https://tinybase.org/api/ui-svelte/functions/component/localrowsview/)(
  this: void,
  props: LocalRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/localrowsviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<LocalRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/localrowsviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `LocalRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/localrowsviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<LocalRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/localrowsviewprops/)>): void; }`  |   |  
## Since
v8.1.0
