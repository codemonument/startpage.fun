...
ValuesView[](https://tinybase.org/api/ui-svelte/functions/component/valuesview/)(
  this: void,
  props: ValuesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valuesviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<ValuesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valuesviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `ValuesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valuesviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<ValuesViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valuesviewprops/)>): void; }`  |   |  
## Since
v8.1.0
