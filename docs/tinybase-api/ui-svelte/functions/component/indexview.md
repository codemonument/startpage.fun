...
IndexView[](https://tinybase.org/api/ui-svelte/functions/component/indexview/)(
  this: void,
  props: IndexViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/indexviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<IndexViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/indexviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `IndexViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/indexviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<IndexViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/indexviewprops/)>): void; }`  |   |  
## Since
v8.1.0
