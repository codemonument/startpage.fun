...
SortedTableView[](https://tinybase.org/api/ui-svelte/functions/component/sortedtableview/)(
  this: void,
  props: SortedTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sortedtableviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<SortedTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sortedtableviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `SortedTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sortedtableviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<SortedTableViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sortedtableviewprops/)>): void; }`  |   |  
## Since
v8.1.0
