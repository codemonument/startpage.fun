...
CurrentCheckpointView[](https://tinybase.org/api/ui-svelte/functions/component/currentcheckpointview/)(
  this: void,
  props: CurrentCheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/currentcheckpointviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<CurrentCheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/currentcheckpointviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `CurrentCheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/currentcheckpointviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<CurrentCheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/currentcheckpointviewprops/)>): void; }`  |   |  
## Since
v8.1.0
