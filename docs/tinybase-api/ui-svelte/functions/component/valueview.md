...
ValueView[](https://tinybase.org/api/ui-svelte/functions/component/valueview/)(
  this: void,
  props: ValueViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valueviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<ValueViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valueviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `ValueViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valueviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<ValueViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/valueviewprops/)>): void; }`  |   |  
## Since
v8.1.0
