...
CheckpointView[](https://tinybase.org/api/ui-svelte/functions/component/checkpointview/)(
  this: void,
  props: CheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/checkpointviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<CheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/checkpointviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `CheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/checkpointviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<CheckpointViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/checkpointviewprops/)>): void; }`  |   |  
## Since
v8.1.0
