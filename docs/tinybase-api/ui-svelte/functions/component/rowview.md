...
RowView[](https://tinybase.org/api/ui-svelte/functions/component/rowview/)(
  this: void,
  props: RowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/rowviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<RowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/rowviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `RowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/rowviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<RowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/rowviewprops/)>): void; }`  |   |  
## Since
v8.1.0
