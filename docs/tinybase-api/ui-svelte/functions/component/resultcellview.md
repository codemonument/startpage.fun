...
ResultCellView[](https://tinybase.org/api/ui-svelte/functions/component/resultcellview/)(
  this: void,
  props: ResultCellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resultcellviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<ResultCellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resultcellviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `ResultCellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resultcellviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<ResultCellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resultcellviewprops/)>): void; }`  |   |  
## Since
v8.1.0
