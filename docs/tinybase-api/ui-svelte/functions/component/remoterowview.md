...
RemoteRowView[](https://tinybase.org/api/ui-svelte/functions/component/remoterowview/)(
  this: void,
  props: RemoteRowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/remoterowviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<RemoteRowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/remoterowviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `RemoteRowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/remoterowviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<RemoteRowViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/remoterowviewprops/)>): void; }`  |   |  
## Since
v8.1.0
