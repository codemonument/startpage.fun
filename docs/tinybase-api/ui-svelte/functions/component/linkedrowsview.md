...
LinkedRowsView[](https://tinybase.org/api/ui-svelte/functions/component/linkedrowsview/)(
  this: void,
  props: LinkedRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/linkedrowsviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<LinkedRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/linkedrowsviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `LinkedRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/linkedrowsviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<LinkedRowsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/linkedrowsviewprops/)>): void; }`  |   |  
## Since
v8.1.0
