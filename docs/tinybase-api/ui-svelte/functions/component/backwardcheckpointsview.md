...
BackwardCheckpointsView[](https://tinybase.org/api/ui-svelte/functions/component/backwardcheckpointsview/)(
  this: void,
  props: BackwardCheckpointsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/backwardcheckpointsviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<BackwardCheckpointsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/backwardcheckpointsviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `BackwardCheckpointsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/backwardcheckpointsviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<BackwardCheckpointsViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/backwardcheckpointsviewprops/)>): void; }`  |   |  
## Since
v8.1.0
