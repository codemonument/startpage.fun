...
SliceView[](https://tinybase.org/api/ui-svelte/functions/component/sliceview/)(
  this: void,
  props: SliceViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sliceviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<SliceViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sliceviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `SliceViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sliceviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<SliceViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/sliceviewprops/)>): void; }`  |   |  
## Since
v8.1.0
