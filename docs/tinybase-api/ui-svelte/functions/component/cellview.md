...
CellView[](https://tinybase.org/api/ui-svelte/functions/component/cellview/)(
  this: void,
  props: CellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/cellviewprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<CellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/cellviewprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `CellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/cellviewprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<CellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/cellviewprops/)>): void; }`  |   |  
## Since
v8.1.0
