...
# `provideQueries`
The `provideQueries` function registers a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object with a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) into the current Provider context.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `queriesId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to register the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object under.  |  
| `queries`  | `Queries[](https://tinybase.org/api/queries/interfaces/queries/queries/)`  | The [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object to register.  |  
