...
# `provideIndexes`
The `provideIndexes` function registers an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object with a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) into the current Provider context.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexesId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to register the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object under.  |  
| `indexes`  | `Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)`  | The [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object to register.  |  
