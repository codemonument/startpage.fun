...
# `provideMetrics`
The `provideMetrics` function registers a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object with a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) into the current Provider context.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricsId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to register the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object under.  |  
| `metrics`  | `Metrics[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)`  | The [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object to register.  |  
