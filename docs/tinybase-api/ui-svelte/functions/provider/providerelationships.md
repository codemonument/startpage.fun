      ...
      * [`ui-svelte`](https://tinybase.org/api/ui-svelte/)
        * [Functions](https://tinybase.org/api/ui-svelte/functions/)
          ...
          * [Provider functions](https://tinybase.org/api/ui-svelte/functions/provider/)
            * [`provideStore`](https://tinybase.org/api/ui-svelte/functions/provider/providestore/)
            * [`provideCheckpoints`](https://tinybase.org/api/ui-svelte/functions/provider/providecheckpoints/)
            * [`provideIndexes`](https://tinybase.org/api/ui-svelte/functions/provider/provideindexes/)
            * [`provideMetrics`](https://tinybase.org/api/ui-svelte/functions/provider/providemetrics/)
            * [`providePersister`](https://tinybase.org/api/ui-svelte/functions/provider/providepersister/)
            * [`provideQueries`](https://tinybase.org/api/ui-svelte/functions/provider/providequeries/)
            * [`provideRelationships`](https://tinybase.org/api/ui-svelte/functions/provider/providerelationships/)
            * [`provideSynchronizer`](https://tinybase.org/api/ui-svelte/functions/provider/providesynchronizer/)
...
The `provideRelationships` function registers a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object with a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) into the current Provider context.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipsId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to register the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object under.  |  
| `relationships`  | `Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)`  | The [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object to register.  |  
