...
# `provideSynchronizer`
The `provideSynchronizer` function registers a [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) with a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) into the current Provider context.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `synchronizerId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to register the [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) under.  |  
| `synchronizer`  | `Synchronizer[](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/)`  | The [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) to register.  |  
