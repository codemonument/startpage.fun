...
The [`createGoBackwardCallback`](https://tinybase.org/api/ui-svelte/functions/callback/creategobackwardcallback/) function returns a callback function that, when called, moves the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object backward to the previous checkpoint. [Read more](https://tinybase.org/api/ui-svelte/functions/callback/creategobackwardcallback/).
## `createGoForwardCallback`
The [`createGoForwardCallback`](https://tinybase.org/api/ui-svelte/functions/callback/creategoforwardcallback/) function returns a callback function that, when called, moves the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object forward to the next checkpoint. [Read more](https://tinybase.org/api/ui-svelte/functions/callback/creategoforwardcallback/).
