...
# Interfaces
## `YupSchematizer`
The [`YupSchematizer`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/) interface represents a schematizer specifically for converting Yup schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/).
