...
The `createYupSchematizer` function creates a [`YupSchematizer`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/) instance for converting Yup schemas to TinyBase schemas.

```
createYupSchematizer[](https://tinybase.org/api/schematizer-yup/functions/creation/createyupschematizer/)(): YupSchematizer[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/)
```
  
| returns  | `YupSchematizer[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/)`  | A new [`YupSchematizer`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/) instance.  |  
| --- | --- | --- |  
## Example
