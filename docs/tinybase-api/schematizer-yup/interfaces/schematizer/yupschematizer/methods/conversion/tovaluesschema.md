  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-yup`](https://tinybase.org/api/schematizer-yup/)
        * [Interfaces](https://tinybase.org/api/schematizer-yup/interfaces/)
          * [`YupSchematizer`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-yup/functions/)
...
# `toValuesSchema`
The `toValuesSchema` method converts a mapping of Yup schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
toValuesSchema[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/tovaluesschema/)(schemas: {[valueId: string]: any}): ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/)
```
...
This method extracts basic type information (string, number, boolean), default values, and nullable flags from Yup schemas.
## Example
...
const schematizer = createYupSchematizer[](https://tinybase.org/api/schematizer-yup/functions/creation/createyupschematizer/)();

const valuesSchema = schematizer.toValuesSchema[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/tovaluesschema/)({
