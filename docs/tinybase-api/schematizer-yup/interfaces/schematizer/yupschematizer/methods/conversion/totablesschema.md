...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of Yup object schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/totablesschema/)(schemas: {[tableId: string]: any}): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `schemas`  | `{[tableId: string]: any}`  | A mapping of table IDs to Yup object schemas.  |  
...
const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/methods/conversion/totablesschema/)({
  pets: object({
    species: string(),
    age: number(),
