...
The [`createYupSchematizer`](https://tinybase.org/api/schematizer-yup/functions/creation/createyupschematizer/) function creates a [`YupSchematizer`](https://tinybase.org/api/schematizer-yup/interfaces/schematizer/yupschematizer/) instance for converting Yup schemas to TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-yup/functions/creation/createyupschematizer/).
