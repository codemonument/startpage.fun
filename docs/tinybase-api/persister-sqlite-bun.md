...
The `persister-sqlite-bun` module of the TinyBase project lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a local Bun SQLite database (in an appropriate environment).
## See also
