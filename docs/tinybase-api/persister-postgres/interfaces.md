...
# Interfaces
## `PostgresPersister`
The [`PostgresPersister`](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/) interface represents a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that lets you save and load [`Store`](https://tinybase.org/api/store/interfaces/store/store/) data to and from a local PostgreSQL database. [Read more](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/).
