...
```
delListener[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/listener/dellistener/)(listenerId: string): this
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/listener/addstatuslistener/)((_persister, status) => {
