...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/load/stopautoload/)(): Promise<PostgresPersister[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/load/stopautoload/)();
