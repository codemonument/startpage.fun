...
# `getSql`
The `getSql` method returns a reference to the database connection the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getSql[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/getter/getsql/)(): Sql<{}>
```
  
| returns  | `Sql<{}>`  | A reference to the database connection.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the database connection back out again.
...
console.log(persister.getSql[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/getter/getsql/)() == sql);
// -> true
