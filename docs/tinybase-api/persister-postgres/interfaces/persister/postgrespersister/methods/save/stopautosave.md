...
# `stopAutoSave`
The `stopAutoSave` method stops the automatic save of data to storage previously started with the [`startAutoSave`](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/save/startautosave/) method.

```
stopAutoSave[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/save/stopautosave/)(): Promise<PostgresPersister[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/)>
```
...
await persister.stopAutoSave[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/save/stopautosave/)();
