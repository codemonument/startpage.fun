...
```
getStatus[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/lifecycle/getstatus/)(): Status[](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
```
...
console.log(persister.getStatus[](https://tinybase.org/api/persister-postgres/interfaces/persister/postgrespersister/methods/lifecycle/getstatus/)());
// -> 0
