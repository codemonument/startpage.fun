...
# Interfaces
## `WsServer`
The [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) interface represents an object that facilitates synchronization between clients that are using [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) instances. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/).
