...
# `WsServer`
The `WsServer` interface represents an object that facilitates synchronization between clients that are using [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) instances.
You should use the [`createWsServer`](https://tinybase.org/api/synchronizer-ws-server/functions/creation/createwsserver/) function to create a `WsServer` object.
## Since
v5.0.0
## Getter methods
