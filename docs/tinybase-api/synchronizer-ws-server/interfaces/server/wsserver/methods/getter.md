        ...
        * [Interfaces](https://tinybase.org/api/synchronizer-ws-server/interfaces/)
          * [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/)
            * [Getter methods](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/)
              * [`destroy`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/destroy/)
              * [`getClientIds`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getclientids/)
              * [`getPathIds`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getpathids/)
              * [`getWebSocketServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getwebsocketserver/)
...
# Getter methods
## `destroy`
The [`destroy`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/destroy/) method provides a way to clean up the server at the end of its use. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/destroy/).
## `getClientIds`
The [`getClientIds`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getclientids/) method method returns the active clients that the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling for a given path. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getclientids/).
## `getPathIds`
The [`getPathIds`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getpathids/) method returns the active paths that the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getpathids/).
## `getWebSocketServer`
The [`getWebSocketServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getwebsocketserver/) method returns a reference to the WebSocketServer being used for this [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/). [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getwebsocketserver/).
