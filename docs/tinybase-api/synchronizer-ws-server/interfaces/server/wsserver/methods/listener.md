...
The [`addClientIdsListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addclientidslistener/) method registers a listener function with the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) that will be called whenever there is a change in the clients connected to a path that a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addclientidslistener/).
## `addPathIdsListener`
The [`addPathIdsListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addpathidslistener/) method registers a listener function with the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) that will be called whenever there is a change in the active paths that a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addpathidslistener/).
## `delListener`
The [`delListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/dellistener/) method removes a listener that was previously added to the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/). [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/dellistener/).
