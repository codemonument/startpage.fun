        ...
        * [Interfaces](https://tinybase.org/api/synchronizer-ws-server/interfaces/)
          * [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/)
            ...
            * [Development methods](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/)
              * [`getStats`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/getstats/)
...
# `getStats`
The `getStats` method provides a set of statistics about the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/), and is used for debugging purposes.

```
getStats[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/getstats/)(): WsServerStats[](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/)
```
  
| returns  | `WsServerStats[](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/)`  | A [`WsServerStats`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/) object containing statistics.  |  
| --- | --- | --- |  
The [`WsServerStats`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/) object contains the number of paths and clients that are active on the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) and is intended to be used during development.
## Example
This example creates a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) that facilitates some synchronization, demonstrating the statistics of the paths and clients handled as a result.
...
console.log(server.getStats[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/getstats/)());
// -> {paths: 1, clients: 2}
