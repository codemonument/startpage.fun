...
# `getWebSocketServer`
The `getWebSocketServer` method returns a reference to the WebSocketServer being used for this [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/).

```
getWebSocketServer[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getwebsocketserver/)(): WebSocketServer
```
  
| returns  | `WebSocketServer`  | The WebSocketServer reference.  |  
| --- | --- | --- |  
## Example
This example creates a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) and then gets the WebSocketServer reference back out again.
...
console.log(server.getWebSocketServer[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getwebsocketserver/)() == webSocketServer);
// -> true
