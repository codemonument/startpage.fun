...
```
destroy[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/destroy/)(): Promise<void>
```
  
| returns  | `Promise<void>`  |   |  
| --- | --- | --- |  
This closes the underlying WebSocketServer that was provided when the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) was created. This method is asynchronous.
## Example
This example creates a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) and then destroys it again, closing the underlying WebSocketServer.
