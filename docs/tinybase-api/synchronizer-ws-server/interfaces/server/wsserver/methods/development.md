...
# Development methods
## `getStats`
The [`getStats`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/getstats/) method provides a set of statistics about the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/), and is used for debugging purposes. [Read more](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/getstats/).
