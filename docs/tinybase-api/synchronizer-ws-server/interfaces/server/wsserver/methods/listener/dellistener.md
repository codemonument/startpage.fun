...
# `delListener`
The `delListener` method removes a listener that was previously added to the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/).

```
delListener[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/dellistener/)(listenerId: string): WsServer[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listenerId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the listener to remove.  |  
| returns  | `WsServer[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/)`  | A reference to the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/).  |  
Use the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) returned by whichever method was used to add the listener. Note that the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) may re-use this [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for future listeners added to it.
## Example
This example registers a listener to a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) and then removes it.
