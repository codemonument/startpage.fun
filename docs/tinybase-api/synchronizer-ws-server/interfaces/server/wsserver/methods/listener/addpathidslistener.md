      ...
      * [`synchronizer-ws-server`](https://tinybase.org/api/synchronizer-ws-server/)
        * [Interfaces](https://tinybase.org/api/synchronizer-ws-server/interfaces/)
          * [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/)
            * [Getter methods](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/)
            * [Listener methods](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/)
              * [`addClientIdsListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addclientidslistener/)
              * [`addPathIdsListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addpathidslistener/)
              * [`delListener`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/dellistener/)
            * [Development methods](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/development/)
...
# `addPathIdsListener`
The `addPathIdsListener` method registers a listener function with the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) that will be called whenever there is a change in the active paths that a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling.

```
addPathIdsListener[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addpathidslistener/)(listener: PathIdsListener[](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/pathidslistener/)): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `PathIdsListener[](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/pathidslistener/)`  | The function that will be called whenever the path [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) handled by the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) change.  |  
...
The provided listener is a [`PathIdsListener`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/pathidslistener/) function, and will be called with a reference to the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) and a callback you can use to get information about the change.
## Example
This example creates a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/), and listens to changes to the active paths when clients connect to and disconnect from it.
...
const listenerId = server.addPathIdsListener[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/addpathidslistener/)(
  (server, pathId, addedOrRemoved) => {
    console.log(pathId + (addedOrRemoved == 1 ? ' added' : ' removed'));
    console.log(server.getPathIds[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/getter/getpathids/)());
  },
);
...
server.delListener[](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/methods/listener/dellistener/)(listenerId);
