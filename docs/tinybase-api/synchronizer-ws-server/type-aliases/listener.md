...
## `ClientIdsListener`
The [`ClientIdsListener`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/clientidslistener/) type describes a function that is used to listen to clients joining and leaving the active paths that a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling. [Read more](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/clientidslistener/).
## `PathIdsListener`
The [`PathIdsListener`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/pathidslistener/) type describes a function that is used to listen to changes of active paths that a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) is handling. [Read more](https://tinybase.org/api/synchronizer-ws-server/type-aliases/listener/pathidslistener/).
