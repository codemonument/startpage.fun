...
## `WsServerStats`
The [`WsServerStats`](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/) type describes the number of paths and clients that are active on the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/). [Read more](https://tinybase.org/api/synchronizer-ws-server/type-aliases/development/wsserverstats/).
