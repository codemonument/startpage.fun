...
# `getDbName`
The `getDbName` method returns the unique key of the IndexedDB the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getDbName[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/getter/getdbname/)(): string
```
  
| returns  | `string`  | The unique key of the IndexedDB.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the unique key of the IndexedDB back out again.
...
console.log(persister.getDbName[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/getter/getdbname/)());
// -> 'petStore'
