...
```
destroy[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/lifecycle/destroy/)(): Promise<IndexedDbPersister[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)>
```
...
console.log(store.getListenerStats[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/development/getlistenerstats/)().transaction);
// -> 1
