...
```
stopAutoPersisting[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/lifecycle/stopautopersisting/)(stopSaveFirst?: boolean): Promise<IndexedDbPersister[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)>
```
...
This simply runs the stopAutoLoad and [`stopAutoSave`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/save/stopautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
...
await persister.stopAutoPersisting[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/lifecycle/stopautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/save/isautosaving/)());
// -> false
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/isautoloading/)());
// -> false
