      ...
      * [`persister-indexed-db`](https://tinybase.org/api/persister-indexed-db/)
        * [Interfaces](https://tinybase.org/api/persister-indexed-db/interfaces/)
          * [`IndexedDbPersister`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)
            * [Getter methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<IndexedDbPersister[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)>
```
...
| returns  | `Promise<IndexedDbPersister[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
