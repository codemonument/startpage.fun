...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/stopautoload/)(): Promise<IndexedDbPersister[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-indexed-db/interfaces/persister/indexeddbpersister/methods/load/stopautoload/)();
