      ...
      * [`indexes`](https://tinybase.org/api/indexes/)
        ...
        * [Type Aliases](https://tinybase.org/api/indexes/type-aliases/)
          ...
          * [Concept type aliases](https://tinybase.org/api/indexes/type-aliases/concept/)
            * [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/)
            * [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/)
...
# `Slice`
The `Slice` type represents the concept of a set of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects that comprise part of an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).

```
Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```

The [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in a `Slice` represent [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects from a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that all have a derived string value in common, as described by the [`setIndexDefinition`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/setindexdefinition/) method.
Note that the `Slice` type is not actually used in the [API](https://tinybase.org/api/), and you instead get [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) directly with the [`getSliceRowIds`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/getslicerowids/) method.
## Since
v1.0.0
