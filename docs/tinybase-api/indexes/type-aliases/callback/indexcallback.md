      ...
      * [`indexes`](https://tinybase.org/api/indexes/)
        ...
        * [Type Aliases](https://tinybase.org/api/indexes/type-aliases/)
          ...
          * [Callback type aliases](https://tinybase.org/api/indexes/type-aliases/callback/)
            * [`IndexCallback`](https://tinybase.org/api/indexes/type-aliases/callback/indexcallback/)
            * [`SliceCallback`](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/)
...
# `IndexCallback`
The `IndexCallback` type describes a function that takes an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) within it.

```
(
  indexId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/),
  forEachSlice: (sliceCallback: SliceCallback[](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/)) => void,
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) that the callback can operate on.  |  
| `forEachSlice`  | `(sliceCallback: SliceCallback[](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/)) => void`  | A function that will let you iterate over the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) objects in this [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).  |  
| returns  | `void`  | This has no return value.  |  
A `IndexCallback` is provided when using the [`forEachIndex`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachindex/) method, so that you can do something based on every [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) in the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object. See that method for specific examples.
## Since
v1.0.0
