...
# `SliceCallback`
The `SliceCallback` type describes a function that takes a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) within it.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `sliceId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) that the callback can operate on.  |  
| `forEachRow`  | `(rowCallback: RowCallback[](https://tinybase.org/api/store/type-aliases/callback/rowcallback/)) => void`  | A function that will let you iterate over the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects in this [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/).  |  
| returns  | `void`  | This has no return value.  |  
A `SliceCallback` is provided when using the [`forEachSlice`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/) method, so that you can do something based on every [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) in an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). See that method for specific examples.
## Since
v1.0.0
