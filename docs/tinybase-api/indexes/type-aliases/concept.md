...
## `Index`
The [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) type represents the concept of a map of [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) objects, keyed by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). [Read more](https://tinybase.org/api/indexes/type-aliases/concept/index/).
## `Slice`
The [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) type represents the concept of a set of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects that comprise part of an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). [Read more](https://tinybase.org/api/indexes/type-aliases/concept/slice/).
