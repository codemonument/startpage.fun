...
## `SliceRowIdsListener`
The [`SliceRowIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/slicerowidslistener/) type describes a function that is used to listen to changes to the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/). [Read more](https://tinybase.org/api/indexes/type-aliases/listener/slicerowidslistener/).
## `IndexIdsListener`
The [`IndexIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/indexidslistener/) type describes a function that is used to listen to [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) definitions being added or removed. [Read more](https://tinybase.org/api/indexes/type-aliases/listener/indexidslistener/).
## `SliceIdsListener`
The [`SliceIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/sliceidslistener/) type describes a function that is used to listen to changes to the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). [Read more](https://tinybase.org/api/indexes/type-aliases/listener/sliceidslistener/).
