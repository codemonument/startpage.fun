    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`indexes`](https://tinybase.org/api/indexes/)
        ...
        * [Type Aliases](https://tinybase.org/api/indexes/type-aliases/)
          * [Listener type aliases](https://tinybase.org/api/indexes/type-aliases/listener/)
            * [`SliceRowIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/slicerowidslistener/)
            * [`IndexIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/indexidslistener/)
            * [`SliceIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/sliceidslistener/)
          * [Callback type aliases](https://tinybase.org/api/indexes/type-aliases/callback/)
          * [Concept type aliases](https://tinybase.org/api/indexes/type-aliases/concept/)
          * [Development type aliases](https://tinybase.org/api/indexes/type-aliases/development/)
...
# `SliceRowIdsListener`
The `SliceRowIdsListener` type describes a function that is used to listen to changes to the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/).
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexes`  | `Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)`  | A reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object that changed.  |  
| `indexId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) that changed.  |  
| `sliceId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) that changed.  |  
| returns  | `void`  | This has no return value.  |  
A `SliceRowIdsListener` is provided when using the [`addSliceRowIdsListener`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/listener/addslicerowidslistener/) method. See that method for specific examples.
When called, a `SliceRowIdsListener` is given a reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) that changed, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) whose [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) changed.
## Since
v1.0.0
