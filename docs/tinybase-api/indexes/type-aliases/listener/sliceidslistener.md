...
# `SliceIdsListener`
The `SliceIdsListener` type describes a function that is used to listen to changes to the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).
...
A `SliceIdsListener` is provided when using the [`addSliceIdsListener`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/listener/addsliceidslistener/) method. See that method for specific examples.
When called, a `SliceIdsListener` is given a reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) that changed.
## Since
v1.0.0
