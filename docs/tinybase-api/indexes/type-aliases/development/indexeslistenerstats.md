      ...
      * [`indexes`](https://tinybase.org/api/indexes/)
        ...
        * [Type Aliases](https://tinybase.org/api/indexes/type-aliases/)
          ...
          * [Development type aliases](https://tinybase.org/api/indexes/type-aliases/development/)
            * [`IndexesListenerStats`](https://tinybase.org/api/indexes/type-aliases/development/indexeslistenerstats/)
...
The `IndexesListenerStats` type describes the number of listeners registered with the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, and can be used for debugging purposes.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `sliceIds`  | `number`  | The number of SlideIdsListener functions registered with the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.  |  
| `sliceRowIds`  | `number`  | The number of [`SliceRowIdsListener`](https://tinybase.org/api/indexes/type-aliases/listener/slicerowidslistener/) functions registered with the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.  |  
A `IndexesListenerStats` object is returned from the [`getListenerStats`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/development/getlistenerstats/) method.
## Since
v1.0.0
