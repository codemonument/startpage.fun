...
## `IndexCallback`
The [`IndexCallback`](https://tinybase.org/api/indexes/type-aliases/callback/indexcallback/) type describes a function that takes an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) within it. [Read more](https://tinybase.org/api/indexes/type-aliases/callback/indexcallback/).
## `SliceCallback`
The [`SliceCallback`](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/) type describes a function that takes a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) within it. [Read more](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/).
