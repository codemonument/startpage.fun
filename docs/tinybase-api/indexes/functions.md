...
# Functions
## `createIndexes`
The [`createIndexes`](https://tinybase.org/api/indexes/functions/creation/createindexes/) function creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, and is the main entry point into the [`indexes`](https://tinybase.org/api/indexes/) module. [Read more](https://tinybase.org/api/indexes/functions/creation/createindexes/).
