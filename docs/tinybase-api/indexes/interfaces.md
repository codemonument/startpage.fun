...
# Interfaces
## `Indexes`
An [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object lets you look up all the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that have a certain [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) value. [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/).
  ...
  * [`getListenerStats`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/development/getlistenerstats/)
