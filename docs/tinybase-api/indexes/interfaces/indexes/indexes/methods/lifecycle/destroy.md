        ...
        * [Interfaces](https://tinybase.org/api/indexes/interfaces/)
          * [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)
            ...
            * [Lifecycle methods](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/)
              * [`destroy`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/destroy/)
...
# `destroy`
The `destroy` method should be called when this [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object is no longer used.

```
destroy[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/destroy/)(): void
```
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object with a definition (that registers a [`RowListener`](https://tinybase.org/api/store/type-aliases/listener/rowlistener/) with the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/)), and then destroys it again, removing the listener.
...
console.log(store.getListenerStats[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/development/getlistenerstats/)().row);
// -> 1

indexes.destroy[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/destroy/)();
