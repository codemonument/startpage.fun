...
## `delIndexDefinition`
The [`delIndexDefinition`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/delindexdefinition/) method removes an existing [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) definition. [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/delindexdefinition/).
## `setIndexDefinition`
The [`setIndexDefinition`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/setindexdefinition/) method lets you set the definition of an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/setindexdefinition/).
