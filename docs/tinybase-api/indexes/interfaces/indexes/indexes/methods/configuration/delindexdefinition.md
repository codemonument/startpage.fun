        ...
        * [Interfaces](https://tinybase.org/api/indexes/interfaces/)
          * [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)
            ...
            * [Configuration methods](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/)
              * [`delIndexDefinition`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/delindexdefinition/)
              * [`setIndexDefinition`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/setindexdefinition/)
...
# `delIndexDefinition`
The `delIndexDefinition` method removes an existing [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) definition.

```
delIndexDefinition[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/delindexdefinition/)(indexId: string): Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) to remove.  |  
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, defines a simple [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/), and then removes it.
...
indexes.delIndexDefinition[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/configuration/delindexdefinition/)('bySpecies');
console.log(indexes.getIndexIds[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/getindexids/)());
// -> []
