...
| `sliceId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) in the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).  |  
| returns  | `Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)`  | The [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/), or an empty array.  |  
If the identified [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) or [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) do not exist (or if the definition references a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that does not exist) then an empty array is returned.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, and defines a simple [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). It then uses getSliceRowIds to see the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) (and also the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in Slices that do not exist).
...
// -> []
console.log(indexes.getSliceRowIds[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/getslicerowids/)('byColor', 'brown'));
// -> []
