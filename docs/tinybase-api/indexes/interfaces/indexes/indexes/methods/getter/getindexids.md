...
# `getIndexIds`
The `getIndexIds` method returns an array of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) registered with this [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.

```
getIndexIds[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/getindexids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| --- | --- | --- |  
## Example
This example creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object with two definitions, and then gets the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of the definitions.
