...
# `hasIndex`
The `hasIndex` method returns a boolean indicating whether a given [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) exists in the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.

```
hasIndex[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/hasindex/)(indexId: string): boolean
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) in the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.  |  
| returns  | `boolean`  | Whether an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
This example shows two simple [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) existence checks.
...
console.log(indexes.hasIndex[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/hasindex/)('bySpecies'));
// -> true
console.log(indexes.hasIndex[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/hasindex/)('byColor'));
// -> false
