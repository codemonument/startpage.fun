...
# `getTableId`
The `getTableId` method returns the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the underlying [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that is backing an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).

```
getTableId[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/gettableid/)(indexId: string): undefined | string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of an [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).  |  
| returns  | `undefined | string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) backing the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/), or `undefined`.  |  
If the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) is invalid, the method returns `undefined`.
## Example
This example creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, a single [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) definition, and then queries it (and a non-existent definition) to get the underlying [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
...
console.log(indexes.getTableId[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/gettableid/)('bySpecies'));
// -> 'pets'
console.log(indexes.getTableId[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/getter/gettableid/)('byColor'));
// -> undefined
