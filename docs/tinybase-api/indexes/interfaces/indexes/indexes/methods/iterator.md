...
# Iterator methods
## `forEachIndex`
The [`forEachIndex`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachindex/) method takes a function that it will then call for each [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) in a specified [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object. [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachindex/).
## `forEachSlice`
The [`forEachSlice`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/) method takes a function that it will then call for each [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) in a specified [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/). [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/).
