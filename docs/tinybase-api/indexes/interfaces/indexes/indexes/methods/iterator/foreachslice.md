        ...
        * [Interfaces](https://tinybase.org/api/indexes/interfaces/)
          * [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)
            ...
            * [Iterator methods](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/)
              * [`forEachIndex`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachindex/)
              * [`forEachSlice`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/)
...
# `forEachSlice`
The `forEachSlice` method takes a function that it will then call for each [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) in a specified [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/).

```
forEachSlice[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/)(
  indexId: string,
  sliceCallback: SliceCallback[](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/),
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `indexId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) to iterate over.  |  
| `sliceCallback`  | `SliceCallback[](https://tinybase.org/api/indexes/type-aliases/callback/slicecallback/)`  | The function that should be called for every [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/) structure of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) in a functional style. The `rowCallback` parameter is a [`RowCallback`](https://tinybase.org/api/store/type-aliases/callback/rowcallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and value of each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in the [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/).
## Example
This example iterates over each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/), and lists its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
...
indexes.forEachSlice[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/iterator/foreachslice/)('bySpecies', (sliceId, forEachRow) => {
  console.log(sliceId);
