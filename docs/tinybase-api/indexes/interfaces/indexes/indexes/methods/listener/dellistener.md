...
# `delListener`
The `delListener` method removes a listener that was previously added to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.

```
delListener[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/listener/dellistener/)(listenerId: string): Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listenerId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the listener to remove.  |  
| returns  | `Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/)`  | A reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object.  |  
Use the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) returned by whichever method was used to add the listener. Note that the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object may re-use this [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for future listeners added to it.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, registers a listener, and then removes it.
...
const listenerId = indexes.addSliceIdsListener[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/listener/addsliceidslistener/)('bySpecies', () => {
