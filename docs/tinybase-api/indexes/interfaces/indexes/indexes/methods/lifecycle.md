...
# Lifecycle methods
## `destroy`
The [`destroy`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/destroy/) method should be called when this [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object is no longer used. [Read more](https://tinybase.org/api/indexes/interfaces/indexes/indexes/methods/lifecycle/destroy/).
