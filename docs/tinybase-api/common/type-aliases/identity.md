...
## `Id`
The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) type is a simple alias for a string, but is used to indicate that the string should be considered to be the key of an object (such as a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) string used in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/)). [Read more](https://tinybase.org/api/common/type-aliases/identity/id/).
## `IdOrNull`
The [`IdOrNull`](https://tinybase.org/api/common/type-aliases/identity/idornull/) type is a simple alias for the union of a string or `null` value, where the string should be considered to be the key of an objects (such as a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) string used in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/)), and typically `null` indicates a wildcard - such as when used in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) [`addRowListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addrowlistener/) method. [Read more](https://tinybase.org/api/common/type-aliases/identity/idornull/).
## `Ids`
The [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) type is a simple alias for an array of strings, but is used to indicate that the strings should be considered to be the keys of objects (such as the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) strings used in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/)). [Read more](https://tinybase.org/api/common/type-aliases/identity/ids/).
