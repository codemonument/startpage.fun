...
# `Hash`
The `Hash` type is used within TinyBase (for example in the [`mergeable-store`](https://tinybase.org/api/mergeable-store/) module) to quickly compare the content of two objects.
