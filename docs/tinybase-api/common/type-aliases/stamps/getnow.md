...
| returns  | `number`  |   |  
| --- | --- | --- |  
This is used internally within the [`mergeable-store`](https://tinybase.org/api/mergeable-store/) module, but is used for the [`createMergeableStore`](https://tinybase.org/api/the-essentials/creating-stores/createmergeablestore/) function's second optional argument to allow applications to override the clock used to generate timestamps.
## Since
v6.2.0
