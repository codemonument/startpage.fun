...
## `Callback`
The [`Callback`](https://tinybase.org/api/common/type-aliases/callback/callback/) type represents a function that is used as a callback and which does not take a parameter. [Read more](https://tinybase.org/api/common/type-aliases/callback/callback/).
## `ParameterizedCallback`
The [`ParameterizedCallback`](https://tinybase.org/api/common/type-aliases/callback/parameterizedcallback/) type represents a generic function that will take an optional parameter - such as the handler of a DOM event. [Read more](https://tinybase.org/api/common/type-aliases/callback/parameterizedcallback/).
