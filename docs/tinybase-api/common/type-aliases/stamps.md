...
# Stamps type aliases
## `GetNow`
The [`GetNow`](https://tinybase.org/api/common/type-aliases/stamps/getnow/) type is used to represent a function that returns the current time in milliseconds. [Read more](https://tinybase.org/api/common/type-aliases/stamps/getnow/).
## `Hash`
The [`Hash`](https://tinybase.org/api/common/type-aliases/stamps/hash/) type is used within TinyBase (for example in the [`mergeable-store`](https://tinybase.org/api/mergeable-store/) module) to quickly compare the content of two objects. [Read more](https://tinybase.org/api/common/type-aliases/stamps/hash/).
## `Hlc`
The [`Hlc`](https://tinybase.org/api/common/type-aliases/stamps/hlc/) type is a string that represents a Hybrid Logical Clock (HLC) value. [Read more](https://tinybase.org/api/common/type-aliases/stamps/hlc/).
