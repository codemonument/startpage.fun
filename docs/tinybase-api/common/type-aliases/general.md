...
## `AnyArray`
The [`AnyArray`](https://tinybase.org/api/common/type-aliases/general/anyarray/) type is a simple alias for an array with unknown values. [Read more](https://tinybase.org/api/common/type-aliases/general/anyarray/).
## `AnyObject`
The [`AnyObject`](https://tinybase.org/api/common/type-aliases/general/anyobject/) type is a simple alias for a plain object with string keys and unknown values. [Read more](https://tinybase.org/api/common/type-aliases/general/anyobject/).
## `Json`
The [`Json`](https://tinybase.org/api/common/type-aliases/general/json/) type is a simple alias for a string, but is used to indicate that the string should be considered to be a JSON serialization of an object. [Read more](https://tinybase.org/api/common/type-aliases/general/json/).
