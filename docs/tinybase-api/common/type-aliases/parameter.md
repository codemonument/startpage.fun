...
## `SortKey`
The [`SortKey`](https://tinybase.org/api/common/type-aliases/parameter/sortkey/) type represents a value that can be used by a sort function. [Read more](https://tinybase.org/api/common/type-aliases/parameter/sortkey/).
