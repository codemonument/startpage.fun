...
# Stamps functions
## `getHlcFunctions`
The [`getHlcFunctions`](https://tinybase.org/api/common/functions/stamps/gethlcfunctions/) function returns a set of utility functions for working with the TinyBase Hybrid Logical Clock (HLC). [Read more](https://tinybase.org/api/common/functions/stamps/gethlcfunctions/).
