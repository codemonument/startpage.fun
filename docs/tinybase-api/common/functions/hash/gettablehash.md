...
# `getTableHash`
The `getTableHash` function returns a hash for a single [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), based on each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash.

```
getTableHash[](https://tinybase.org/api/common/functions/hash/gettablehash/)(rowHashes: {[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}): Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `rowHashes`  | `{[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}`  | An object containing each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and its hash.  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).  |  
## Example
This example gets the hash of a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).
...
console.log(getTableHash[](https://tinybase.org/api/common/functions/hash/gettablehash/)(rowHashes));
// -> 4262151841
