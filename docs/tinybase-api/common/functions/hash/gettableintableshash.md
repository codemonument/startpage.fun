...
The `getTableInTablesHash` function returns a hash for a single [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), based on its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash (in turn produced from its Rows).

```
getTableInTablesHash[](https://tinybase.org/api/common/functions/hash/gettableintableshash/)(
  tableId: string,
  tableHash: number,
): Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).  |  
| `tableHash`  | `number`  | The hash of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) based on its content and [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).  |  
## Example
This example gets the hash of a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) and its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
...
console.log(getTableInTablesHash[](https://tinybase.org/api/common/functions/hash/gettableintableshash/)(tableId, tableHash));
// -> 278115833
