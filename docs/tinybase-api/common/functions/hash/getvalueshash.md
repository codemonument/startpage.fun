...
# `getValuesHash`
The `getValuesHash` function returns a hash for a [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) object, based on each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash.

```
getValuesHash[](https://tinybase.org/api/common/functions/hash/getvalueshash/)(valueHashes: {[valueId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}): Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `valueHashes`  | `{[valueId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}`  | An object containing each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and its hash.  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Values`](https://tinybase.org/api/store/type-aliases/store/values/).  |  
## Example
This example gets the hash of a [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) object.
...
console.log(getValuesHash[](https://tinybase.org/api/common/functions/hash/getvalueshash/)(valueHashes));
// -> 4229195646
