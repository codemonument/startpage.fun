      ...
      * [`common`](https://tinybase.org/api/common/)
        * [Functions](https://tinybase.org/api/common/functions/)
          ...
          * [Hash functions](https://tinybase.org/api/common/functions/hash/)
            * [`getTableInTablesHash`](https://tinybase.org/api/common/functions/hash/gettableintableshash/)
            * [`getTablesHash`](https://tinybase.org/api/common/functions/hash/gettableshash/)
            * [`getRowInTableHash`](https://tinybase.org/api/common/functions/hash/getrowintablehash/)
            * [`getTableHash`](https://tinybase.org/api/common/functions/hash/gettablehash/)
            * [`getCellInRowHash`](https://tinybase.org/api/common/functions/hash/getcellinrowhash/)
            * [`getRowHash`](https://tinybase.org/api/common/functions/hash/getrowhash/)
            * [`getCellHash`](https://tinybase.org/api/common/functions/hash/getcellhash/)
            * [`getValueInValuesHash`](https://tinybase.org/api/common/functions/hash/getvalueinvalueshash/)
            * [`getValuesHash`](https://tinybase.org/api/common/functions/hash/getvalueshash/)
            * [`getValueHash`](https://tinybase.org/api/common/functions/hash/getvaluehash/)
            * [`addOrRemoveHash`](https://tinybase.org/api/common/functions/hash/addorremovehash/)
            * [`getHash`](https://tinybase.org/api/common/functions/hash/gethash/)
...
# `getTablesHash`
The `getTablesHash` function returns a hash for the tabular part of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), based on each [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash.

```
getTablesHash[](https://tinybase.org/api/common/functions/hash/gettableshash/)(tableHashes: {[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}): Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableHashes`  | `{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}`  | An object containing each [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and its hash.  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/).  |  
## Example
This example gets the hash of the tabular part of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
console.log(getTablesHash[](https://tinybase.org/api/common/functions/hash/gettableshash/)(tableHashes));
// -> 278115833
