...
# `getRowInTableHash`
The `getRowInTableHash` function returns a hash for a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/), based on its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash (in turn produced from its Cells).
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `rowId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).  |  
| `rowHash`  | `number`  | The hash of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) based on its content and [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).  |  
## Example
This example gets the hash of a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) and its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
...
console.log(getRowInTableHash[](https://tinybase.org/api/common/functions/hash/getrowintablehash/)(rowId, rowHash));
// -> 4262151841
