...
# `getCellInRowHash`
The `getCellInRowHash` function returns a hash for a single [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), based on its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash (in turn produced from its value).
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `cellId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| `cellHash`  | `number`  | The hash of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) based on its content and [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).  |  
## Example
This example gets the hash of a [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) and its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
...
console.log(getCellInRowHash[](https://tinybase.org/api/common/functions/hash/getcellinrowhash/)(cellId, cellHash));
// -> 3777304796
