...
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | The resulting hash of the two hashes added to or removed from each other.  |  
This is used internally within TinyBase to collate hashes of objects, such as producing a hash for a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) which is composed of the hashes of its Rows.
## Example
...
console.log(addOrRemoveHash[](https://tinybase.org/api/common/functions/hash/addorremovehash/)(hash1, hash2));
// -> 1032168868

console.log(addOrRemoveHash[](https://tinybase.org/api/common/functions/hash/addorremovehash/)(1032168868, hash1));
// -> 987654321
console.log(addOrRemoveHash[](https://tinybase.org/api/common/functions/hash/addorremovehash/)(1032168868, hash2));
// -> 123456789
