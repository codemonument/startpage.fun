...
# `getRowHash`
The `getRowHash` function returns a hash for a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/), based on each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and hash.

```
getRowHash[](https://tinybase.org/api/common/functions/hash/getrowhash/)(cellHashes: {[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}): Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `cellHashes`  | `{[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}`  | An object containing each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and its hash.  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).  |  
## Example
This example gets the hash of a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).
...
console.log(getRowHash[](https://tinybase.org/api/common/functions/hash/getrowhash/)(cellHashes));
// -> 1810444343
