...
# `getValueHash`
The `getValueHash` function returns a hash for a single [`Value`](https://tinybase.org/api/store/type-aliases/store/value/), based on its value and the HLC of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/).

```
getValueHash[](https://tinybase.org/api/common/functions/hash/getvaluehash/)(
  value: ValueOrUndefined[](https://tinybase.org/api/store/type-aliases/store/valueorundefined/),
  valueHlc: string,
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `value`  | `ValueOrUndefined[](https://tinybase.org/api/store/type-aliases/store/valueorundefined/)`  | The [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) (or `undefined`).  |  
| `valueHlc`  | `string`  | The HLC of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/).  |  
| returns  | `Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)`  | A hash of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/).  |  
## Example
This example gets the hash of a [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) and its HLC.
...
console.log(getValueHash[](https://tinybase.org/api/common/functions/hash/getvaluehash/)(value, valueHlc));
// -> 312420374
