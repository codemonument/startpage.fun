...
# Interfaces
## `Middleware`
A [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/) object lets you intercept and validate writes to a [`Store`](https://tinybase.org/api/store/interfaces/store/store/). [Read more](https://tinybase.org/api/middleware/interfaces/middleware/middleware/).
