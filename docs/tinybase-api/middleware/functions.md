...
# Functions
## `createMiddleware`
The [`createMiddleware`](https://tinybase.org/api/middleware/functions/creation/createmiddleware/) function creates a [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/) object, and is the main entry point into the [`middleware`](https://tinybase.org/api/middleware/) module. [Read more](https://tinybase.org/api/middleware/functions/creation/createmiddleware/).
