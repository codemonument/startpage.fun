...
# `WillDelCellCallback`
The `WillDelCellCallback` type describes a function that is called before a [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) is deleted from the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) containing the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| `rowId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) containing the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| `cellId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) being deleted.  |  
| returns  | `boolean`  | `true` to allow the deletion, `false` to prevent it.  |  
The callback receives the table [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), row [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), and cell [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) about to be deleted. It returns `true` to allow the deletion, or `false` to prevent it.
Multiple `WillDelCellCallback` functions can be registered and they will be called sequentially. If any callback returns `false`, the chain short-circuits and the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) will not be deleted.
## Since
v8.0.0
