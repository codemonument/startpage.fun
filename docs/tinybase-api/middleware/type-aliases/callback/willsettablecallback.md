...
The `WillSetTableCallback` type describes a function that is called before a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) is set in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
): Table[](https://tinybase.org/api/store/type-aliases/store/table/) | undefined
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) being set.  |  
| `table`  | `Table[](https://tinybase.org/api/store/type-aliases/store/table/)`  | The [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) object about to be set.  |  
| returns  | `Table[](https://tinybase.org/api/store/type-aliases/store/table/) | undefined`  | The [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) to use (possibly transformed), or `undefined` to prevent the write.  |  
The callback receives the table [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) object that is about to be set. It can return the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) (possibly transformed) to allow the write, or `undefined` to prevent the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) from being set.
Multiple `WillSetTableCallback` functions can be registered and they will be called sequentially, the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) being updated successively. If any callback returns `undefined`, the chain short-circuits and the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) will not be set.
## Since
v8.0.0
