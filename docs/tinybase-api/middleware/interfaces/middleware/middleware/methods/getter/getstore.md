        ...
        * [Interfaces](https://tinybase.org/api/middleware/interfaces/)
          * [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/)
            * [Getter methods](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/getter/)
              * [`getStore`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/getter/getstore/)
...
# `getStore`
The `getStore` method returns a reference to the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) that is backing this [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/) object.

```
getStore[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/getter/getstore/)(): Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)
```
...
| --- | --- | --- |  
## Example
This example creates a [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets its reference in order to update its data.

```
import {createMiddleware, createStore} from 'tinybase';

const middleware = createMiddleware[](https://tinybase.org/api/middleware/functions/creation/createmiddleware/)(createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)());
console.log(middleware.getStore[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/getter/getstore/)().getTables[](https://tinybase.org/api/store/interfaces/store/store/methods/getter/gettables/)());
// -> {}
