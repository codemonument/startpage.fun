...
The `addWillDelTableCallback` method registers a [`WillDelTableCallback`](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablecallback/) that will be called before any [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) is deleted from the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
addWillDelTableCallback[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/configuration/addwilldeltablecallback/)(callback: WillDelTableCallback[](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablecallback/)): Middleware[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `callback`  | `WillDelTableCallback[](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablecallback/)`  | The [`WillDelTableCallback`](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablecallback/) to register.  |  
...
## Example
This example registers a callback that prevents deleting the 'pets' table from the pet store.
...
store.setTable[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settable/)('pets', {fido: {species: 'dog'}, felix: {species: 'cat'}});

middleware.addWillDelTableCallback[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/configuration/addwilldeltablecallback/)((tableId) => tableId !== 'pets');
