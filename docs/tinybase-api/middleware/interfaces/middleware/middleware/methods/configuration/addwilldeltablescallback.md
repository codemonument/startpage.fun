...
The `addWillDelTablesCallback` method registers a [`WillDelTablesCallback`](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablescallback/) that will be called before all [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) are deleted from the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
addWillDelTablesCallback[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/configuration/addwilldeltablescallback/)(callback: WillDelTablesCallback[](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablescallback/)): Middleware[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `callback`  | `WillDelTablesCallback[](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablescallback/)`  | The [`WillDelTablesCallback`](https://tinybase.org/api/middleware/type-aliases/callback/willdeltablescallback/) to register.  |  
...
## Example
This example registers a callback that prevents deleting all [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) from the pet store.
...
store.setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {species: 'dog'}, felix: {species: 'cat'}}});

middleware.addWillDelTablesCallback[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/configuration/addwilldeltablescallback/)(() => false);
