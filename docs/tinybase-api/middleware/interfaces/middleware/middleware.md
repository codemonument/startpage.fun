...
# `Middleware`
A `Middleware` object lets you intercept and validate writes to a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
This is useful for enforcing business rules, data validation, or transformation logic before data is persisted in the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
Create a `Middleware` object easily with the [`createMiddleware`](https://tinybase.org/api/middleware/functions/creation/createmiddleware/) function.
## Example
This example shows a very simple lifecycle of a `Middleware` object: from creation, to getting the [`Store`](https://tinybase.org/api/store/interfaces/store/store/) reference, and then destroying it.
...
console.log(middleware.getStore[](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/getter/getstore/)() == store);
// -> true
...
## Lifecycle methods
  * [`destroy`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/methods/lifecycle/destroy/)
