...
# `persister-pglite`
The `persister-pglite` module of the TinyBase project lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a PGlite database (in an appropriate environment).
## See also
