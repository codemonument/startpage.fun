...
# Functions
## `createYjsPersister`
The [`createYjsPersister`](https://tinybase.org/api/persister-yjs/functions/creation/createyjspersister/) function creates a [`YjsPersister`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a Yjs document. [Read more](https://tinybase.org/api/persister-yjs/functions/creation/createyjspersister/).
