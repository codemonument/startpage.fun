...
# `startAutoSave`
The [`save`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/save/) method takes data from the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with which the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is associated and persists it into storage, once, and then continuously.

```
startAutoSave[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/startautosave/)(): Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>
```
