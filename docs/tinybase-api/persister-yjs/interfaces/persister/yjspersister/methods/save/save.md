...
```
save[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/save/)(): Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>
```
