...
# Lifecycle methods
## `destroy`
The [`destroy`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/destroy/) method should be called when this [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object is no longer used. [Read more](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/destroy/).
## `getStatus`
The [`getStatus`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/getstatus/) method lets you find out if the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently in the process of loading or saving content. [Read more](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/getstatus/).
## `schedule`
The [`schedule`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/schedule/) method allows you to queue up a series of asynchronous actions that must run in sequence during persistence. [Read more](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/schedule/).
## `startAutoPersisting`
The startAutoPersist method is a convenience method that starts both automatic loading and saving of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data. [Read more](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/startautopersisting/).
## `stopAutoPersisting`
The stopAutoPersist method is a convenience method that stops both automatic loading and saving of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data. [Read more](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/stopautopersisting/).
