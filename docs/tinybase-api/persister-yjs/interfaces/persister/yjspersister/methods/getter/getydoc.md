...
# `getYDoc`
The `getYDoc` method returns the Yjs document the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getYDoc[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/getydoc/)(): Doc
```
  
| returns  | `Doc`  | The Yjs document.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the Yjs document back out again.
...
console.log(persister.getYDoc[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/getydoc/)() == doc);
// -> true
