...
```
addStatusListener[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>): string
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
persister.delListener[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/dellistener/)(listenerId);
