      ...
      * [`persister-yjs`](https://tinybase.org/api/persister-yjs/)
        * [Interfaces](https://tinybase.org/api/persister-yjs/interfaces/)
          * [`YjsPersister`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)
            * [Getter methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>
```
...
| returns  | `Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
...
await persister.destroy[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/destroy/)();
