...
```
schedule[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/schedule/)(actions: (() => Promise<any>)[]): Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `actions`  | `(() => Promise<any>)[]`  | One or many functions which will be scheduled, and which can be asynchronous.  |  
| returns  | `Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>`  | A reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
const persister = createCustomPersister[](https://tinybase.org/api/persisters/functions/creation/createcustompersister/)(
  ...
  async (getContent) => {
    // setPersisted
    await persister.schedule[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/schedule/)(
      () => checkRemoteSystemIsReady(),
