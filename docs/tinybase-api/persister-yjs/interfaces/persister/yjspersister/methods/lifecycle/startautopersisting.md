        ...
        * [Interfaces](https://tinybase.org/api/persister-yjs/interfaces/)
          * [`YjsPersister`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)
            ...
            * [Lifecycle methods](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/)
              * [`destroy`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/destroy/)
              * [`getStatus`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/getstatus/)
              * [`schedule`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/schedule/)
              * [`startAutoPersisting`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/startautopersisting/)
              * [`stopAutoPersisting`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/stopautopersisting/)
...
): Promise<YjsPersister[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/)>
```
...
This simply runs the startAutoLoad and [`startAutoSave`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/startautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
This method can take `initialContent` to pass to the [`startAutoLoad`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/startautoload/) method. See its documentation for more details.
...
await persister.startAutoPersisting[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/startautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/isautosaving/)());
// -> true
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/load/isautoloading/)());
// -> true

persister.destroy[](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/lifecycle/destroy/)();
