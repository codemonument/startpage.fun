...
# `YjsPersister`
The `YjsPersister` interface represents a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a Yjs document.
You should use the [`createYjsPersister`](https://tinybase.org/api/persister-yjs/functions/creation/createyjspersister/) function to create a `YjsPersister` object.
It is a minor extension to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) interface and simply provides an extra [`getYDoc`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/getydoc/) method for accessing the Yjs document the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.
## Since
v4.3.14
## Getter methods
  * [`getStore`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/getstore/)
  * [`getYDoc`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/getter/getydoc/)


## Listener methods
  * [`addStatusListener`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/addstatuslistener/)
  * [`delListener`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/listener/dellistener/)
...
## Save methods
  * [`isAutoSaving`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/isautosaving/)
  * [`save`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/save/)
  * [`startAutoSave`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/startautosave/)
  * [`stopAutoSave`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/save/stopautosave/)


## Development methods
  * [`getStats`](https://tinybase.org/api/persister-yjs/interfaces/persister/yjspersister/methods/development/getstats/)
