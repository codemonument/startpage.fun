...
# `middleware`
The `middleware` module of the TinyBase project provides the ability to intercept and validate incoming writes to [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) objects.
The main entry point to this module is the [`createMiddleware`](https://tinybase.org/api/middleware/functions/creation/createmiddleware/) function, which returns a new [`Middleware`](https://tinybase.org/api/middleware/interfaces/middleware/middleware/) object. From there, you can register hooks that are called before data is written to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
## Since
v8.0.0
## Interfaces
