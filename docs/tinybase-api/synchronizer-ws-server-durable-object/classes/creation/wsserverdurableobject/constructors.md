...
# Constructors
## `constructor`
The constructor is used to create the Durable Object that will synchronize the TinyBase clients. [Read more](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/constructors/creation/constructor/).
