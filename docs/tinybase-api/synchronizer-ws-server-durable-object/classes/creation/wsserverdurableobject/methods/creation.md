...
# Creation methods
## `createPersister`
The [`createPersister`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/creation/createpersister/) method is used to return a persister for the Durable Object to preserve [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data when clients are not connected. [Read more](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/creation/createpersister/).
