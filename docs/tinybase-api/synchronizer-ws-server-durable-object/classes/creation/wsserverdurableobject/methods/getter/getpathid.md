...
# `getPathId`
The `getPathId` method is used to get the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the path that is being served.

```
getPathId[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getpathid/)(): string
```
  
| returns  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the path being served by the Durable Object.  |  
| --- | --- | --- |  
...
export class MyDurableObject extends WsServerDurableObject[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/) {
  onMessage[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onmessage/)() {
    console.info('Message received on path: ', this.getPathId[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getpathid/)());
  }
}
