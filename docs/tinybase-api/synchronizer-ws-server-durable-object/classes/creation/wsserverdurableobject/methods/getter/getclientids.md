          ...
          * [`WsServerDurableObject`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/)
            ...
            * [Methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/)
              * [Getter methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/)
                * [`getClientIds`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/)
                * [`getPathId`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getpathid/)
...
```
getClientIds[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
  
| returns  | `Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)`  | The [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of the clients being served by the Durable Object.  |  
| --- | --- | --- |  
Note that if you call this method from within the [`onClientId`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onclientid/) method as a client is getting removed, it will still be returned in the list of client [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/).
## Example
...
export class MyDurableObject extends WsServerDurableObject[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/) {
  onMessage[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onmessage/)() {
    console.info('Clients on path: ', this.getClientIds[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/)());
  }
}
