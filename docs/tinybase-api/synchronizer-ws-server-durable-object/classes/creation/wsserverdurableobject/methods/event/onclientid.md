      ...
      * [`synchronizer-ws-server-durable-object`](https://tinybase.org/api/synchronizer-ws-server-durable-object/)
        * [Classes](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/)
          * [`WsServerDurableObject`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/)
            * [Constructors](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/constructors/)
            * [Methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/)
              * [Getter methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/)
              * [Creation methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/creation/)
              * [Event methods](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/)
                * [`onClientId`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onclientid/)
                * [`onMessage`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onmessage/)
                * [`onPathId`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onpathid/)
...
onClientId[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onclientid/)(
  pathId: string,
  clientId: string,
  addedOrRemoved: IdAddedOrRemoved[](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/),
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `pathId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the path being served by the Durable Object.  |  
| `clientId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the client joining or leaving.  |  
| `addedOrRemoved`  | `IdAddedOrRemoved[](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/)`  | Whether the client is joining or leaving.  |  
| returns  | `void`  | This has no return value.  |  
This method is called with the path [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), the client [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), and an [`IdAddedOrRemoved`](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/) flag indicating whether it this is being triggered by the client joining (`1`) or the client leaving (`-1`).
Note that if you call the [`getClientIds`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/) method from within this method as a client is getting removed, it will still be returned in the list of client [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/).
## Example
This example logs every client that joins (the client [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) is 'added') or leaves (the client [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) is 'removed') on the path being served by the Durable Object.
...
export class MyDurableObject extends WsServerDurableObject[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/) {
  onClientId[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/event/onclientid/)(pathId, clientId, addedOrRemoved) {
    console.info(
