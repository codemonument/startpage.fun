...
# Getter methods
## `getClientIds`
The [`getClientIds`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/) method is used to access a list of all the connected clients on the path. [Read more](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getclientids/).
## `getPathId`
The [`getPathId`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getpathid/) method is used to get the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the path that is being served. [Read more](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/getter/getpathid/).
