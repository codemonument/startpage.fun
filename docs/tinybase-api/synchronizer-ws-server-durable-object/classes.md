...
Essential
A [`WsServerDurableObject`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/) is the server component (running as a Cloudflare Durable Object) for synchronization between clients that are using [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) instances. [Read more](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/).
