...
The `persister-electric-sql` module of the TinyBase project lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a local ElectricSQL database (in an appropriate environment).
## See also
