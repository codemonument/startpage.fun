...
# Enumerations
## `Message`
The [`Message`](https://tinybase.org/api/synchronizers/enumerations/synchronization/message/) enum is used to indicate the type of the message being passed between [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) instances. [Read more](https://tinybase.org/api/synchronizers/enumerations/synchronization/message/).
