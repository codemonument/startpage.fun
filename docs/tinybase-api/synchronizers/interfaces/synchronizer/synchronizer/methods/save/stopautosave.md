...
# `stopAutoSave`
The `stopAutoSave` method stops the automatic save of data to storage previously started with the [`startAutoSave`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/startautosave/) method.

```
stopAutoSave[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/stopautosave/)(): Promise<Synchronizer[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/)>
```
...
await persister.stopAutoSave[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/stopautosave/)();
