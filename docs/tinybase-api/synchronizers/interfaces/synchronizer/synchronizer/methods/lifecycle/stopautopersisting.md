...
```
stopAutoPersisting[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/stopautopersisting/)(stopSaveFirst?: boolean): Promise<Synchronizer[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/)>
```
...
This simply runs the stopAutoLoad and [`stopAutoSave`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/stopautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
...
await persister.stopAutoPersisting[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/stopautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/isautosaving/)());
// -> false
console.log(persister.isAutoLoading[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/isautoloading/)());
// -> false
