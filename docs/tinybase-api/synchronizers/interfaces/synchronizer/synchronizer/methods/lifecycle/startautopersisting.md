...
): Promise<Synchronizer[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/)>
```
...
This simply runs the startAutoLoad and [`startAutoSave`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/startautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
This method can take `initialContent` to pass to the [`startAutoLoad`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/startautoload/) method. See its documentation for more details.
...
await persister.startAutoPersisting[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/startautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/isautosaving/)());
// -> true
console.log(persister.isAutoLoading[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/isautoloading/)());
// -> true

persister.destroy[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/destroy/)();
