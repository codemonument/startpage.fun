...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/stopautoload/)(): Promise<Synchronizer[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/stopautoload/)();
