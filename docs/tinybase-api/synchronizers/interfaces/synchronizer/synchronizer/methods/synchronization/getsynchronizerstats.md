...
```
getSynchronizerStats[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/getsynchronizerstats/)(): SynchronizerStats[](https://tinybase.org/api/synchronizers/type-aliases/development/synchronizerstats/)
```
...
console.log(synchronizer1.getSynchronizerStats[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/getsynchronizerstats/)());
// -> {receives: 4, sends: 5}
console.log(synchronizer2.getSynchronizerStats[](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/getsynchronizerstats/)());
// -> {receives: 5, sends: 4}
