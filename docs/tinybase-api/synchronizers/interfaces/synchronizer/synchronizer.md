      ...
      * [`synchronizers`](https://tinybase.org/api/synchronizers/)
        * [Interfaces](https://tinybase.org/api/synchronizers/interfaces/)
          * [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/)
            * [Getter methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/getter/)
            * [Listener methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/)
            * [Save methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/)
            * [Synchronization methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/)
            * [Development methods](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/development/)
...
# `Synchronizer`
Essential
A `Synchronizer` object lets you synchronize [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) data with another TinyBase client or system.
This is useful for sharing data between users, or between devices of a single user. This is especially valuable when there is the possibility that there has been a lack of immediate connectivity between clients and the synchronization requires some negotiation to orchestrate merging the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects together.
Creating a `Synchronizer` depends on the choice of underlying medium over which the synchronization will take place. Options include the [`createWsSynchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/createwssynchronizer/) function (for a `Synchronizer` that will sync over web-sockets), and the [`createLocalSynchronizer`](https://tinybase.org/api/synchronizer-local/functions/creation/createlocalsynchronizer/) function (for a `Synchronizer` that will sync two [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects in memory on one system). The [`createCustomSynchronizer`](https://tinybase.org/api/synchronizers/functions/creation/createcustomsynchronizer/) function can also be used to easily create a fully customized way to send and receive the messages of the synchronization protocol.
Note that, as an interface, it is an extension to the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) interface, since they share underlying implementations. Think of a `Synchronizer` as 'persisting' your [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) to another client (and vice-versa).
## Example
...
v5.0.0
## Getter methods
  * [`getStore`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/getter/getstore/)


## Listener methods
  * [`addStatusListener`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/listener/addstatuslistener/)
  * [`delListener`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/listener/dellistener/)


## Lifecycle methods
  * [`destroy`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/destroy/)
  * [`getStatus`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/getstatus/)
  * [`schedule`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/schedule/)
  * [`startAutoPersisting`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/startautopersisting/)
  * [`stopAutoPersisting`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/lifecycle/stopautopersisting/)


## Load methods
  * [`isAutoLoading`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/isautoloading/)
  * [`load`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/load/)
  * [`startAutoLoad`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/startautoload/)
  * [`stopAutoLoad`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/load/stopautoload/)


## Save methods
  * [`isAutoSaving`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/isautosaving/)
  * [`save`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/save/)
  * [`startAutoSave`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/startautosave/)
  * [`stopAutoSave`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/save/stopautosave/)


## Synchronization methods
  * [`getSynchronizerStats`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/getsynchronizerstats/)
  * [`startSync`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/startsync/)
  * [`stopSync`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/stopsync/)


## Development methods
  * [`getStats`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/development/getstats/)
