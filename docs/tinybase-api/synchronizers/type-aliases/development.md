...
## `SynchronizerStats`
The [`SynchronizerStats`](https://tinybase.org/api/synchronizers/type-aliases/development/synchronizerstats/) type describes the number of times a [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) object has sent or received data. [Read more](https://tinybase.org/api/synchronizers/type-aliases/development/synchronizerstats/).
