      ...
      * [`synchronizers`](https://tinybase.org/api/synchronizers/)
        ...
        * [Type Aliases](https://tinybase.org/api/synchronizers/type-aliases/)
          ...
          * [Development type aliases](https://tinybase.org/api/synchronizers/type-aliases/development/)
            * [`SynchronizerStats`](https://tinybase.org/api/synchronizers/type-aliases/development/synchronizerstats/)
...
# `SynchronizerStats`
The `SynchronizerStats` type describes the number of times a [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) object has sent or received data.
...
A `SynchronizerStats` object is returned from the [`getSynchronizerStats`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/methods/synchronization/getsynchronizerstats/) method.
## Since
v5.0.0
