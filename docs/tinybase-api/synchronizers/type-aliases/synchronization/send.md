...
```
(
  toClientId: IdOrNull[](https://tinybase.org/api/common/type-aliases/identity/idornull/),
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `toClientId`  | `IdOrNull[](https://tinybase.org/api/common/type-aliases/identity/idornull/)`  | The optional [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the other client (in other words, the other system) to which the message should be sent. If omitted, this is to be a broadcast.  |  
| `requestId`  | `IdOrNull[](https://tinybase.org/api/common/type-aliases/identity/idornull/)`  | The optional [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the message, which should be awaited in the response (if requested) to constitute a matched request/response transaction.  |  
