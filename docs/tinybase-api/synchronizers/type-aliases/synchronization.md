...
## `Receive`
The [`Receive`](https://tinybase.org/api/synchronizers/type-aliases/synchronization/receive/) type describes a function that knows how to handle the arrival of a message as part of the synchronization protocol. [Read more](https://tinybase.org/api/synchronizers/type-aliases/synchronization/receive/).
## `Send`
The [`Send`](https://tinybase.org/api/synchronizers/type-aliases/synchronization/send/) type describes a function that knows how to dispatch a message as part of the synchronization protocol. [Read more](https://tinybase.org/api/synchronizers/type-aliases/synchronization/send/).
