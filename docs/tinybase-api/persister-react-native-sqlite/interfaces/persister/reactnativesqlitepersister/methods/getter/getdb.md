...
# `getDb`
The `getDb` method returns a reference to the database instance the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getDb[](https://tinybase.org/api/persister-react-native-sqlite/interfaces/persister/reactnativesqlitepersister/methods/getter/getdb/)(): SQLiteDatabase
```
  
| returns  | `SQLiteDatabase`  | A reference to the database instance.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the database instance back out again.
...
console.log(persister.getDb[](https://tinybase.org/api/persister-react-native-sqlite/interfaces/persister/reactnativesqlitepersister/methods/getter/getdb/)() == db);
// -> true
