...
```
getStatus[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/lifecycle/getstatus/)(): Status[](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
```
...
console.log(persister.getStatus[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/lifecycle/getstatus/)());
// -> 0
