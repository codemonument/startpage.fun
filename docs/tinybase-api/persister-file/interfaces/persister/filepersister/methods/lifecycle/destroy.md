...
```
destroy[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/lifecycle/destroy/)(): Promise<FilePersister[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/)>
```
...
await persister.startAutoSave[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/save/startautosave/)();
