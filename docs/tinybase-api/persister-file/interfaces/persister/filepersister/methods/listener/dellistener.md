...
```
delListener[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/listener/dellistener/)(listenerId: string): this
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/listener/addstatuslistener/)((_persister, status) => {
