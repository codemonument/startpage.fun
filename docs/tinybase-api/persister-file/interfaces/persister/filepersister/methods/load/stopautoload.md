...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/load/stopautoload/)(): Promise<FilePersister[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/load/stopautoload/)();
