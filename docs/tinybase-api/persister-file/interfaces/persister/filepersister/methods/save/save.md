...
```
save[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/save/save/)(): Promise<FilePersister[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/)>
```
