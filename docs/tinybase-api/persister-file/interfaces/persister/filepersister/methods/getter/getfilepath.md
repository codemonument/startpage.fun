...
# `getFilePath`
The `getFilePath` method returns the location of the local file the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getFilePath[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/getter/getfilepath/)(): string
```
  
| returns  | `string`  | The location of the local file.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the file location back out again.
...
console.log(persister.getFilePath[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/methods/getter/getfilepath/)());
// -> '/app/persisted.json'
