...
# Interfaces
## `FilePersister`
The [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) interface represents a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that lets you save and load [`Store`](https://tinybase.org/api/store/interfaces/store/store/) data to and from a local file system. [Read more](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/).
