...
# `createFilePersister`
The `createFilePersister` function creates a [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local file.
...
| `filePath`  | `string`  | The location of the local file to persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to.  |  
...
| returns  | `FilePersister[](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/)`  | A reference to the new [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) object.  |  
A [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) supports both regular [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects.
As well as providing a reference to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to persist, you must provide a `filePath` parameter which identifies the file to persist it to.
## Example
This example creates a [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) object and persists the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local file.
...
const persister = createFilePersister[](https://tinybase.org/api/persister-file/functions/creation/createfilepersister/)(store, '/app/persisted.json');
