...
# Functions
## `createFilePersister`
The [`createFilePersister`](https://tinybase.org/api/persister-file/functions/creation/createfilepersister/) function creates a [`FilePersister`](https://tinybase.org/api/persister-file/interfaces/persister/filepersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local file. [Read more](https://tinybase.org/api/persister-file/functions/creation/createfilepersister/).
