...
# Lifecycle methods
## `destroy`
The [`destroy`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/destroy/) method should be called when this [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object is no longer used. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/destroy/).
