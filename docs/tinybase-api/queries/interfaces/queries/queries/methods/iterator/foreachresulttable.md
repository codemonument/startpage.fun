        ...
        * [Interfaces](https://tinybase.org/api/queries/interfaces/)
          * [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/)
            ...
            * [Iterator methods](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/)
              * [`forEachResultTable`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresulttable/)
              * [`forEachResultRow`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultrow/)
              * [`forEachResultCell`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultcell/)
              * [`forEachQuery`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachquery/)
...
# `forEachResultTable`
The `forEachResultTable` method takes a function that it will then call for each [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.

```
forEachResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresulttable/)(tableCallback: ResultTableCallback[](https://tinybase.org/api/queries/type-aliases/callback/resulttablecallback/)): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableCallback`  | `ResultTableCallback[](https://tinybase.org/api/queries/type-aliases/callback/resulttablecallback/)`  | The function that should be called for every query's [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over all the ResultTables of the queries in a functional style. The `tableCallback` parameter is a [`ResultTableCallback`](https://tinybase.org/api/queries/type-aliases/callback/resulttablecallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of each [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/), and with a function that can then be used to iterate over each [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) of the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/), should you wish.
## Example
This example iterates over each query's [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.
...
queries.forEachResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresulttable/)((queryId, forEachRow) => {
  console.log(queryId);
