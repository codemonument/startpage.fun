        ...
        * [Interfaces](https://tinybase.org/api/queries/interfaces/)
          * [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/)
            ...
            * [Development methods](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/)
              * [`getListenerStats`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/getlistenerstats/)
...
# `getListenerStats`
The `getListenerStats` method provides a set of statistics about the listeners registered with the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, and is used for debugging purposes.

```
getListenerStats[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/getlistenerstats/)(): QueriesListenerStats[](https://tinybase.org/api/queries/type-aliases/development/querieslistenerstats/)
```
  
| returns  | `QueriesListenerStats[](https://tinybase.org/api/queries/type-aliases/development/querieslistenerstats/)`  | A [`QueriesListenerStats`](https://tinybase.org/api/queries/type-aliases/development/querieslistenerstats/) object containing [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) listener statistics.  |  
| --- | --- | --- |  
...
## Example
This example gets the listener statistics of a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.
...
queries.addResultTableListener[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addresulttablelistener/)(null, () => console.log('Result changed'));

console.log(queries.getListenerStats[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/getlistenerstats/)().table);
// -> 1
console.log(queries.getListenerStats[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/getlistenerstats/)().row);
// -> 0
