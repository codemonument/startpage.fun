...
# Iterator methods
## `forEachResultTable`
The [`forEachResultTable`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresulttable/) method takes a function that it will then call for each [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresulttable/).
## `forEachResultRow`
The [`forEachResultRow`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultrow/) method takes a function that it will then call for each [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) in the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) of a query. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultrow/).
## `forEachResultCell`
The [`forEachResultCell`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultcell/) method takes a function that it will then call for each [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) in the [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) of a query. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultcell/).
## `forEachQuery`
The [`forEachQuery`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachquery/) method takes a function that it will then call for each Query in the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachquery/).
