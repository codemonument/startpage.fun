...
# `hasResultTable`
The `hasResultTable` method returns a boolean indicating whether a given [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) exists.

```
hasResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/hasresulttable/)(queryId: string): boolean
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible query.  |  
| returns  | `boolean`  | Whether a [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) for that query [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
This example shows two simple [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) existence checks.
...
console.log(queries.hasResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/hasresulttable/)('dogColors'));
// -> true
console.log(queries.hasResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/hasresulttable/)('catColors'));
// -> false
