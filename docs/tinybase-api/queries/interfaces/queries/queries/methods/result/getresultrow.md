...
# `getResultRow`
The `getResultRow` method returns an object containing the entire data of a single [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) in the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) of the given query.

```
getResultRow[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresultrow/)(
  queryId: string,
  rowId: string,
): ResultRow[](https://tinybase.org/api/queries/type-aliases/result/resultrow/)
```
...
console.log(queries.getResultRow[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresultrow/)('dogColors', 'fido'));
// -> {color: 'brown'}

console.log(queries.getResultRow[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresultrow/)('dogColors', 'felix'));
// -> {}
