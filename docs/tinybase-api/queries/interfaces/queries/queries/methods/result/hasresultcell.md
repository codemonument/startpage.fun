...
# `hasResultCell`
The `hasResultCell` method returns a boolean indicating whether a given [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) exists.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible query.  |  
| `rowId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/).  |  
| `cellId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/).  |  
| returns  | `boolean`  | Whether a [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) for that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
This example shows two simple [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) existence checks.
...
console.log(queries.hasResultCell[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/hasresultcell/)('dogColors', 'fido', 'color'));
// -> true
console.log(queries.hasResultCell[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/hasresultcell/)('dogColors', 'fido', 'species'));
// -> false
