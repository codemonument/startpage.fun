...
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query to update the params for.  |  
| `paramValues`  | `ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)`  | An object containing the param [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) and values to set.  |  
| returns  | `Queries[](https://tinybase.org/api/queries/interfaces/queries/queries/)`  | A reference to the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object for convenient chaining.  |  
## Example
...
queries.setParamValues[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalues/)('query', {species: 'cat', minAge: 2});
console.log(queries.getResultTable[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresulttable/)('query'));
// -> {felix: {color: 'black'}}
