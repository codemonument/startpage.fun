...
setParamValue[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalue/)(
  queryId: string,
  paramId: string,
  value: ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/),
): Queries[](https://tinybase.org/api/queries/interfaces/queries/queries/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query to update the param for.  |  
| `paramId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the param to set.  |  
| `value`  | `ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/)`  | The value to set for the param.  |  
