...
## `setParamValues`
The [`setParamValues`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalues/) method sets multiple param values for a parameterized query at once, causing the query to re-evaluate with the new param values. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalues/).
## `setParamValue`
The [`setParamValue`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalue/) method sets a single param value for a parameterized query, causing the query to re-evaluate with the new param value. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalue/).
## `delQueryDefinition`
The [`delQueryDefinition`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/delquerydefinition/) method removes an existing query definition. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/delquerydefinition/).
## `setQueryDefinition`
The [`setQueryDefinition`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setquerydefinition/) method lets you set the definition of a query. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setquerydefinition/).
