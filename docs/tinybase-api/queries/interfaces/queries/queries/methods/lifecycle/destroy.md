        ...
        * [Interfaces](https://tinybase.org/api/queries/interfaces/)
          * [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/)
            ...
            * [Lifecycle methods](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/)
              * [`destroy`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/destroy/)
...
# `destroy`
The `destroy` method should be called when this [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object is no longer used.

```
destroy[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/destroy/)(): void
```
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object with a definition (that registers a [`RowListener`](https://tinybase.org/api/store/type-aliases/listener/rowlistener/) with the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/)), and then destroys it again, removing the listener.
...
queries.setQueryDefinition[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setquerydefinition/)('species', 'species', ({select}) => {
  select('species');
});
console.log(store.getListenerStats[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/development/getlistenerstats/)().row);
// -> 1

queries.destroy[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/lifecycle/destroy/)();
