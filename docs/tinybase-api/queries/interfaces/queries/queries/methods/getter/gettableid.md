        ...
        * [Interfaces](https://tinybase.org/api/queries/interfaces/)
          * [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/)
            * [Getter methods](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/)
              * [`getStore`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getstore/)
              * [`getTableId`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/gettableid/)
              * [`getParamValues`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalues/)
              * [`getParamValue`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalue/)
              * [`getQueryIds`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getqueryids/)
              * [`hasQuery`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/hasquery/)
...
# `getTableId`
The `getTableId` method returns the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the underlying [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that is backing a query.

```
getTableId[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/gettableid/)(queryId: string): undefined | string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a query.  |  
| returns  | `undefined | string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) backing the query, or `undefined`.  |  
If the query [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) is invalid, the method returns `undefined`.
## Example
...
const queries = createQueries[](https://tinybase.org/api/queries/functions/creation/createqueries/)(createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)()).setQueryDefinition[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setquerydefinition/)(
  'dogColors',
  'pets',
  ({select, where}) => {
    select('color');
...
console.log(queries.getTableId[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/gettableid/)('dogColors'));
// -> 'pets'
console.log(queries.getTableId[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/gettableid/)('catColors'));
// -> undefined
