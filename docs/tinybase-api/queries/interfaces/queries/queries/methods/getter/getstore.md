...
# `getStore`
The `getStore` method returns a reference to the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) that is backing this [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.

```
getStore[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getstore/)(): Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)
```
...
| --- | --- | --- |  
## Example
This example creates a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets its reference in order to update its data.
...
queries
  .getStore[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getstore/)()
  .setRow[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setrow/)('pets', 'fido', {species: 'dog', color: 'brown'});
