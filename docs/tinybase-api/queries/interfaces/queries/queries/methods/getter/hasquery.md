...
# `hasQuery`
The `hasQuery` method returns a boolean indicating whether a given query exists in the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.

```
hasQuery[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/hasquery/)(queryId: string): boolean
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible query in the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.  |  
| returns  | `boolean`  | Whether a query with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
...
console.log(queries.hasQuery[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/hasquery/)('dogColors'));
// -> true
console.log(queries.hasQuery[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/hasquery/)('catColors'));
// -> false
