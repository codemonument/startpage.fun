...
getParamValue[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalue/)(
  queryId: string,
  paramId: string,
): undefined | ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query to get the param for.  |  
| `paramId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the param to get.  |  
| returns  | `undefined | ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/)`  | The value of the param, or `undefined` if the query or param doesn't exist.  |  
## Example
...
console.log(queries.getParamValue[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalue/)('query', 'species'));
// -> 'dog'
