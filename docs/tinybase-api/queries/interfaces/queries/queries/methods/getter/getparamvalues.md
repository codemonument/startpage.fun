...
```
getParamValues[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalues/)(queryId: string): ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query to get the params for.  |  
| returns  | `ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)`  | An object containing all param [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) and their values, or an empty object if the query doesn't exist.  |  
## Example
...
console.log(queries.getParamValues[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalues/)('query'));
// -> {species: 'dog', minAge: 5}

queries.setParamValue[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/configuration/setparamvalue/)('query', 'species', 'cat');
console.log(queries.getParamValues[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getparamvalues/)('query'));
