...
# `getQueryIds`
The `getQueryIds` method returns an array of the query [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) registered with this [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object.

```
getQueryIds[](https://tinybase.org/api/queries/interfaces/queries/queries/methods/getter/getqueryids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| --- | --- | --- |  
## Example
This example creates a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object with two definitions, and then gets the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of the definitions.
