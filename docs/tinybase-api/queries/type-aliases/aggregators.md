...
## `Aggregate`
The [`Aggregate`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregate/) type describes a custom function that takes an array of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) values and returns an aggregate of them. [Read more](https://tinybase.org/api/queries/type-aliases/aggregators/aggregate/).
## `AggregateAdd`
The [`AggregateAdd`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregateadd/) type describes a function that can be used to optimize a custom [`Aggregate`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregate/) by providing a shortcut for when a single value is added to the input values. [Read more](https://tinybase.org/api/queries/type-aliases/aggregators/aggregateadd/).
## `AggregateRemove`
The [`AggregateRemove`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregateremove/) type describes a function that can be used to optimize a custom [`Aggregate`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregate/) by providing a shortcut for when a single value is removed from the input values. [Read more](https://tinybase.org/api/queries/type-aliases/aggregators/aggregateremove/).
## `AggregateReplace`
The [`AggregateReplace`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregatereplace/) type describes a function that can be used to optimize a custom [`Aggregate`](https://tinybase.org/api/queries/type-aliases/aggregators/aggregate/) by providing a shortcut for when a single value in the input values is replaced with another. [Read more](https://tinybase.org/api/queries/type-aliases/aggregators/aggregatereplace/).
