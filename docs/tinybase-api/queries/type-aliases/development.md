...
The [`QueriesListenerStats`](https://tinybase.org/api/queries/type-aliases/development/querieslistenerstats/) type describes the number of listeners registered with the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, and can be used for debugging purposes. [Read more](https://tinybase.org/api/queries/type-aliases/development/querieslistenerstats/).
