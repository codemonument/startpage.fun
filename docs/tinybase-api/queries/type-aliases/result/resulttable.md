...
```
{[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: ResultRow[](https://tinybase.org/api/queries/type-aliases/result/resultrow/)}
```

A `ResultTable` is typically accessed with the [`getResultTable`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresulttable/) method or [`addResultTableListener`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addresulttablelistener/) method. It is similar to the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) type in the [`store`](https://tinybase.org/api/store/) module, but without schema-specific typing, and is a regular JavaScript object containing individual [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) objects, keyed by their [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
## Example
