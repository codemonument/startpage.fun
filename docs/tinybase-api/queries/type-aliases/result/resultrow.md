...
```
{[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: ResultCell[](https://tinybase.org/api/queries/type-aliases/result/resultcell/)}
```

A `ResultRow` is typically accessed with the [`getResultRow`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/result/getresultrow/) method or [`addResultRowListener`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addresultrowlistener/) method. It is similar to the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) type in the [`store`](https://tinybase.org/api/store/) module, but without schema-specific typing, and is a regular JavaScript object containing individual [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) objects, keyed by their [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).
## Example
