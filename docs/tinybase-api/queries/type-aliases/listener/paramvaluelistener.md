...
(
  ...
  paramId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/),
  paramValue: ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/),
): void
```
...
| `queryId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query whose param value changed.  |  
| `paramId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the param whose value changed.  |  
| `paramValue`  | `ParamValue[](https://tinybase.org/api/queries/type-aliases/params/paramvalue/)`  |   |  
| returns  | `void`  | This has no return value.  |  
A `ParamValueListener` is provided when using the [`addParamValueListener`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addparamvaluelistener/) method. See that method for specific examples.
When called, a `ParamValueListener` is given a reference to the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query whose param value changed, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the param whose value changed.
## Since
v7.2.0
