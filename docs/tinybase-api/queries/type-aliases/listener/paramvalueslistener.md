...
(
  ...
  paramValues: ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/),
): void
```
...
| `queryId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query whose param values changed.  |  
| `paramValues`  | `ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)`  |   |  
| returns  | `void`  | This has no return value.  |  
A `ParamValuesListener` is provided when using the [`addParamValuesListener`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addparamvalueslistener/) method. See that method for specific examples.
When called, a `ParamValuesListener` is given a reference to the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query whose param values changed.
## Since
v7.2.0
