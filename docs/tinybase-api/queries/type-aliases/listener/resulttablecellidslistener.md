...
A `ResultTableCellIdsListener` is provided when using the [`addResultTableCellIdsListener`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/listener/addresulttablecellidslistener/) method. See that method for specific examples.
When called, a `ResultTableCellIdsListener` is given a reference to the [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) whose [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) changed (which is the same as the query [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/)).
