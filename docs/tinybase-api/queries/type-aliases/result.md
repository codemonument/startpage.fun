...
# Result type aliases
## `ResultTable`
The [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) type is the data structure representing the results of a query. [Read more](https://tinybase.org/api/queries/type-aliases/result/resulttable/).
## `ResultRow`
The [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) type is the data structure representing a single row in the results of a query. [Read more](https://tinybase.org/api/queries/type-aliases/result/resultrow/).
## `ResultCell`
The [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) type is the data structure representing a single cell in the results of a query. [Read more](https://tinybase.org/api/queries/type-aliases/result/resultcell/).
## `ResultCellOrUndefined`
The [`ResultCellOrUndefined`](https://tinybase.org/api/queries/type-aliases/result/resultcellorundefined/) type is the data structure representing a single cell in the results of a query, or the value `undefined`. [Read more](https://tinybase.org/api/queries/type-aliases/result/resultcellorundefined/).
