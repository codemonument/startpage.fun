...
# Params type aliases
## `ParamValues`
The [`ParamValues`](https://tinybase.org/api/queries/type-aliases/params/paramvalues/) type describes an object of param values, keyed by param [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), used to provide values for a parameterized query. [Read more](https://tinybase.org/api/queries/type-aliases/params/paramvalues/).
## `ParamValue`
The [`ParamValue`](https://tinybase.org/api/queries/type-aliases/params/paramvalue/) type describes a single param value that can be used in a parameterized query. [Read more](https://tinybase.org/api/queries/type-aliases/params/paramvalue/).
