...
# `GetTableCell`
The `GetTableCell` type describes a function that takes a [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and returns the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) value for a particular [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), optionally in a joined [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).
When called with one parameter, this function will return the value of the specified [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) from the query's root [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) for the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) being selected or filtered.

```
(cellId: string): CellOrUndefined[](https://tinybase.org/api/store/type-aliases/store/cellorundefined/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `cellId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) to fetch the value for.  |  
| returns  | `CellOrUndefined[](https://tinybase.org/api/store/type-aliases/store/cellorundefined/)`  | A [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) value or `undefined`.  |  
## Since
v2.0.0
* * *
When called with two parameters, this function will return the value of the specified [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) from a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that has been joined in the query, for the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) being selected or filtered.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `joinedTableId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) to fetch the value from. If the underlying [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) was joined 'as' a different [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), that should instead be used.  |  
| `joinedCellId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) to fetch the value for.  |  
| returns  | `CellOrUndefined[](https://tinybase.org/api/store/type-aliases/store/cellorundefined/)`  | A [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) value or `undefined`.  |  
## Since
v2.0.0
A `GetTableCell` can be provided when setting query definitions, specifically in the [`Select`](https://tinybase.org/api/queries/type-aliases/definition/select/) and [`Where`](https://tinybase.org/api/queries/type-aliases/definition/where/) clauses when you want to create or filter on calculated values. See those methods for specific examples.
## Since
v2.0.0
