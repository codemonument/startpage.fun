...
# `ResultRowCallback`
The `ResultRowCallback` type describes a function that takes a [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) within it.

```
(
  rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/),
  forEachCell: (cellCallback: ResultCellCallback[](https://tinybase.org/api/queries/type-aliases/callback/resultcellcallback/)) => void,
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `rowId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) that the callback can operate on.  |  
| `forEachCell`  | `(cellCallback: ResultCellCallback[](https://tinybase.org/api/queries/type-aliases/callback/resultcellcallback/)) => void`  | A function that will let you iterate over the [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) values in this [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/).  |  
| returns  | `void`  | This has no return value.  |  
A `ResultRowCallback` is provided when using the [`forEachResultRow`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultrow/) method, so that you can do something based on every [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/) in a [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/). See that method for specific examples.
## Since
v2.0.0
