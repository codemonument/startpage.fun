...
# `ResultCellCallback`
The `ResultCellCallback` type describes a function that takes a [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and its value.

```
(
  cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/),
  cell: ResultCell[](https://tinybase.org/api/queries/type-aliases/result/resultcell/),
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `cellId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) that the callback can operate on.  |  
| `cell`  | `ResultCell[](https://tinybase.org/api/queries/type-aliases/result/resultcell/)`  | The value of the [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/).  |  
| returns  | `void`  | This has no return value.  |  
A `ResultCellCallback` is provided when using the [`forEachResultCell`](https://tinybase.org/api/queries/interfaces/queries/queries/methods/iterator/foreachresultcell/) method, so that you can do something based on every [`ResultCell`](https://tinybase.org/api/queries/type-aliases/result/resultcell/) in a [`ResultRow`](https://tinybase.org/api/queries/type-aliases/result/resultrow/). See that method for specific examples.
## Since
v2.0.0
