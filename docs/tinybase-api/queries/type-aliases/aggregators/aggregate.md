...
# `Aggregate`
The `Aggregate` type describes a custom function that takes an array of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) values and returns an aggregate of them.

```
(
  cells: Cell[](https://tinybase.org/api/store/type-aliases/store/cell/)[],
  length: number,
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `cells`  | `Cell[](https://tinybase.org/api/store/type-aliases/store/cell/)[]`  | The array of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) values to be aggregated.  |  
| `length`  | `number`  | The length of the array of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) values to be aggregated.  |  
| returns  | `ResultCell[](https://tinybase.org/api/queries/type-aliases/result/resultcell/)`  | The value of the aggregation.  |  
