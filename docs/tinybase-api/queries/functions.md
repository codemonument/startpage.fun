...
# Functions
## `createQueries`
The [`createQueries`](https://tinybase.org/api/queries/functions/creation/createqueries/) function creates a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, and is the main entry point into the [`queries`](https://tinybase.org/api/queries/) module. [Read more](https://tinybase.org/api/queries/functions/creation/createqueries/).
