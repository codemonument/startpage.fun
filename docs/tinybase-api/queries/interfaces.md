...
# Interfaces
## `Queries`
A [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object lets you create and track queries of the data in [`Store`](https://tinybase.org/api/store/interfaces/store/store/) objects. [Read more](https://tinybase.org/api/queries/interfaces/queries/queries/).
