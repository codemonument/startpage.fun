...
# `getConnection`
The `getConnection` method returns the PartySocket the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getConnection[](https://tinybase.org/api/persister-partykit-client/interfaces/persister/partykitpersister/methods/getter/getconnection/)(): PartySocket
```
  
| returns  | `PartySocket`  | The PartySocket.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the PartySocket back out again.
...
console.log(persister.getConnection[](https://tinybase.org/api/persister-partykit-client/interfaces/persister/partykitpersister/methods/getter/getconnection/)() == partySocket);
// -> true
