...
The [`PartyKitPersisterConfig`](https://tinybase.org/api/persister-partykit-client/type-aliases/configuration/partykitpersisterconfig/) type describes the configuration of a PartyKit [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) on the client side. [Read more](https://tinybase.org/api/persister-partykit-client/type-aliases/configuration/partykitpersisterconfig/).
