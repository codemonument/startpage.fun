        ...
        * [Interfaces](https://tinybase.org/api/store/interfaces/)
          * [`Store`](https://tinybase.org/api/store/interfaces/store/store/)
            ...
            * [Development methods](https://tinybase.org/api/store/interfaces/store/store/methods/development/)
              * [`getListenerStats`](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/)
...
# `getListenerStats`
The `getListenerStats` method provides a set of statistics about the listeners registered with the [`Store`](https://tinybase.org/api/store/interfaces/store/store/), and is used for debugging purposes.

```
getListenerStats[](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/)(): StoreListenerStats[](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/)
```
  
| returns  | `StoreListenerStats[](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/)`  | A [`StoreListenerStats`](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/) object containing [`Store`](https://tinybase.org/api/store/interfaces/store/store/) listener statistics.  |  
| --- | --- | --- |  
...
## Example
This example gets the listener statistics of a small and simple [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
import {createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)();
store.addTablesListener[](https://tinybase.org/api/store/interfaces/store/store/methods/listener/addtableslistener/)(() => console.log('Tables changed'));
store.addRowIdsListener[](https://tinybase.org/api/store/interfaces/store/store/methods/listener/addrowidslistener/)(() => console.log('Row Ids changed'));

const listenerStats = store.getListenerStats[](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/)();
