...
# Development methods
## `getListenerStats`
The [`getListenerStats`](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/) method provides a set of statistics about the listeners registered with the [`Store`](https://tinybase.org/api/store/interfaces/store/store/), and is used for debugging purposes. [Read more](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/).
