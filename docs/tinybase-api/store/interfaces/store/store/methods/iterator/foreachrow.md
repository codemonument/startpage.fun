        ...
        * [Interfaces](https://tinybase.org/api/store/interfaces/)
          * [`Store`](https://tinybase.org/api/store/interfaces/store/store/)
            ...
            * [Iterator methods](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/)
              * [`forEachTable`](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachtable/)
              * [`forEachTableCell`](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachtablecell/)
              * [`forEachRow`](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachrow/)
              * [`forEachCell`](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachcell/)
              * [`forEachValue`](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachvalue/)
...
store.forEachRow[](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachrow/)('pets', (rowId, forEachCell) => {
  console.log(rowId);
  forEachCell[](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachcell/)((cellId) => console.log(`- ${cellId}`));
});
// -> 'fido'
// -> '- species'
// -> 'felix'
