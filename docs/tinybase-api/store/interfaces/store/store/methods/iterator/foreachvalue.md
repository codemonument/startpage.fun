...
# `forEachValue`
The `forEachValue` method takes a function that it will then call for each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
forEachValue[](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachvalue/)(valueCallback: ValueCallback[](https://tinybase.org/api/store/type-aliases/callback/valuecallback/)): void
```
...
This method is useful for iterating over the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) structure of the [`Store`](https://tinybase.org/api/store/interfaces/store/store/) in a functional style. The `valueCallback` parameter is a [`ValueCallback`](https://tinybase.org/api/store/type-aliases/callback/valuecallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and value of each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/).
## Example
This example iterates over each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in a [`Store`](https://tinybase.org/api/store/interfaces/store/store/), and lists its value.
...
store.forEachValue[](https://tinybase.org/api/store/interfaces/store/store/methods/iterator/foreachvalue/)((valueId, value) => {
