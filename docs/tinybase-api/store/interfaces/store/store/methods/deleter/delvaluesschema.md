...
# `delValuesSchema`
The `delValuesSchema` method lets you remove the [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delValuesSchema[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/delvaluesschema/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).  |  
| --- | --- | --- |  
## Example
This example removes the [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
