...
# `delTablesSchema`
The `delTablesSchema` method lets you remove the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) of the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delTablesSchema[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/deltablesschema/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).  |  
| --- | --- | --- |  
## Example
This example removes the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) of a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
