...
# `delSchema`
The `delSchema` method lets you remove both the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delSchema[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/delschema/)(): this
```
...
## Example
This example removes the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
