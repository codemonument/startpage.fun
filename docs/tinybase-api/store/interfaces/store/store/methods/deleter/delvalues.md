...
# `delValues`
The `delValues` method lets you remove all the [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delValues[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/delvalues/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).  |  
| --- | --- | --- |  
If there is a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) applied to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/) and it specifies a default value for any [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), then deletion will result in it being set back to its default value.
## Examples
This example removes all [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/) without a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).
...
This example removes all [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/) with a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) that defaults one of its values.
