...
# `delValue`
The `delValue` method lets you remove a single [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delValue[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/delvalue/)(valueId: string): this
```
...
If there is a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) applied to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/) and it specifies a default value for this [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), then deletion will result in it being set back to its default value.
## Examples
This example removes a [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/) without a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).
...
This example removes a [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/) with a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) that defaults its value.
