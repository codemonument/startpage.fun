...
# `delTable`
The `delTable` method lets you remove a single [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) from the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
delTable[](https://tinybase.org/api/store/interfaces/store/store/methods/deleter/deltable/)(tableId: string): this
```
...
## Example
This example removes a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) from a [`Store`](https://tinybase.org/api/store/interfaces/store/store/).
