...
# `applyChanges`
The `applyChanges` method applies a set of [`Changes`](https://tinybase.org/api/store/type-aliases/transaction/changes/) to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).

```
applyChanges[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/applychanges/)(changes: Changes[](https://tinybase.org/api/store/type-aliases/transaction/changes/)): this
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `changes`  | `Changes[](https://tinybase.org/api/store/type-aliases/transaction/changes/)`  | The [`Changes`](https://tinybase.org/api/store/type-aliases/transaction/changes/) to apply to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).  |  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/).  |  
This method will take a [`Changes`](https://tinybase.org/api/store/type-aliases/transaction/changes/) object (which is available at the end of a transaction) and apply it to a [`Store`](https://tinybase.org/api/store/interfaces/store/store/). The most likely need to do this is to take the changes made during the transaction of one [`Store`](https://tinybase.org/api/store/interfaces/store/store/), and apply it to the content of _another_ [`Store`](https://tinybase.org/api/store/interfaces/store/store/) - such as when persisting and synchronizing data.
Any part of the provided [`Changes`](https://tinybase.org/api/store/type-aliases/transaction/changes/) object are invalid (either because of its type, or because it does not match the schemas associated with the [`Store`](https://tinybase.org/api/store/interfaces/store/store/)) will be ignored silently.
...
store.applyChanges[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/applychanges/)([{pets: {fido: {color: 'black'}}}, {open: undefined}]);
