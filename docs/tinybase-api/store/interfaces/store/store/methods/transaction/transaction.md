...
# `transaction`
Essential
The `transaction` method takes a function that makes multiple mutations to the [`Store`](https://tinybase.org/api/store/interfaces/store/store/), buffering all calls to the relevant listeners until it completes.

```
transaction[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/transaction/)<Return>(
  actions: () => Return,
...
const store = createStore[](https://tinybase.org/api/store/functions/creation/createstore/)().setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {species: 'dog'}}});
store.addCellListener[](https://tinybase.org/api/store/interfaces/store/store/methods/listener/addcelllistener/)(
  'pets',
  'fido',
  'color',
...
store.transaction[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/transaction/)(() =>
  store
    .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'color', 'black')
    .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'color', 'brown')
    .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'color', 'walnut'),
);
// -> 'walnut'
...
store.transaction[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/transaction/)(
  () =>
    store
      .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'color', 'black')
      .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'date0', new Date(0))
      .setCell[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setcell/)('pets', 'fido', 'date1', new Date(1))
      .setValue[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setvalue/)('open', false)
      .setValue[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setvalue/)('date2', new Date(2)),
  () => {
