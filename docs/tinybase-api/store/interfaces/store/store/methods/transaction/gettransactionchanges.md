...
The `getTransactionChanges` method returns the net meaningful changes that have been made to a [`Store`](https://tinybase.org/api/store/interfaces/store/store/) during a transaction.

```
getTransactionChanges[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/gettransactionchanges/)(): Changes[](https://tinybase.org/api/store/type-aliases/transaction/changes/)
```
...
store
  ...
  .finishTransaction[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/finishtransaction/)(() => {
    const [changedCells, changedValues] = store.getTransactionChanges[](https://tinybase.org/api/store/interfaces/store/store/methods/transaction/gettransactionchanges/)();
