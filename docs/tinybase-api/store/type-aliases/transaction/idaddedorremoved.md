...
# `IdAddedOrRemoved`
The `IdAddedOrRemoved` type describes a change made to an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) in either the tabular or keyed-value part of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) (or in other TinyBase modules).

```
1 | -1
```

This type is used in other types like [`ChangedTableIds`](https://tinybase.org/api/store/type-aliases/transaction/changedtableids/), [`ChangedRowIds`](https://tinybase.org/api/store/type-aliases/transaction/changedrowids/), [`ChangedCellIds`](https://tinybase.org/api/store/type-aliases/transaction/changedcellids/), and [`ChangedValueIds`](https://tinybase.org/api/store/type-aliases/transaction/changedvalueids/), as well as in other events or listeners where a list of [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) has changed.
It is a simple number: a 1 indicates that a given [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) was added to a list of [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/), and a -1 indicates that it was removed.
## Since
v4.0.0
