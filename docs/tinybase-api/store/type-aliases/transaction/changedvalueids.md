...
# `ChangedValueIds`
The `ChangedValueIds` type describes the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) that were added or removed during a transaction.

```
{[valueId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: IdAddedOrRemoved[](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/)}
```
...
It is a simple object that has [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) as key, and an [`IdAddedOrRemoved`](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/) number indicating whether the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) was added (1) or removed (-1).
Note that there will be no entry if the content of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) itself changed. For that you should consult the [`ChangedValues`](https://tinybase.org/api/store/type-aliases/transaction/changedvalues/) type.
## Since
v4.0.0
