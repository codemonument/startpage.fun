...
# `ChangedCellIds`
The `ChangedCellIds` type describes the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) that were added or removed during a transaction.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: IdAddedOrRemoved[](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/)}}}
```

It is available to the [`DoRollback`](https://tinybase.org/api/store/type-aliases/callback/dorollback/) function and to a [`TransactionListener`](https://tinybase.org/api/store/type-aliases/listener/transactionlistener/) function via the [`TransactionLog`](https://tinybase.org/api/store/type-aliases/transaction/transactionlog/) object.
It is a nested object that has [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) as a top-level key, and [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), and then CellId as inner keys. The values of the inner objects are [`IdAddedOrRemoved`](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/) numbers indicating whether the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) was added (1) or removed (-1) to the given [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).
Note that there will be no entry if the content of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) itself changed. For that you should consult the [`ChangedCells`](https://tinybase.org/api/store/type-aliases/transaction/changedcells/) type.
## Since
v4.0.0
