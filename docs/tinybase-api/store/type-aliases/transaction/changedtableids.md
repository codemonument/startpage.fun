...
# `ChangedTableIds`
The `ChangedTableIds` type describes the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) that were added or removed during a transaction.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: IdAddedOrRemoved[](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/)}
```
...
It is a simple object that has [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) as key, and an [`IdAddedOrRemoved`](https://tinybase.org/api/store/type-aliases/transaction/idaddedorremoved/) number indicating whether the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) was added (1) or removed (-1).
Note that there will be no entry if the content of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) itself changed. For that you should consult the [`ChangedRowIds`](https://tinybase.org/api/store/type-aliases/transaction/changedrowids/), [`ChangedCellIds`](https://tinybase.org/api/store/type-aliases/transaction/changedcellids/), or [`ChangedCells`](https://tinybase.org/api/store/type-aliases/transaction/changedcells/) types.
## Since
v4.0.0
