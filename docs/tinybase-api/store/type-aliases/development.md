...
## `StoreListenerStats`
The [`StoreListenerStats`](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/) type describes the number of listeners registered with the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and can be used for debugging purposes. [Read more](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/).
