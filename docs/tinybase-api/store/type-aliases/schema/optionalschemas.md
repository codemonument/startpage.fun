...
# `OptionalSchemas`
The `OptionalSchemas` type is used by generic types that can optionally take either or both of a [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
[OptionalTablesSchema[](https://tinybase.org/api/store/type-aliases/schema/optionaltablesschema/), OptionalValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/optionalvaluesschema/)]
```
