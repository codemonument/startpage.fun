...
The `OptionalTablesSchema` type is used by generic types that can optionally take a [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) | NoTablesSchema[](https://tinybase.org/api/store/type-aliases/schema/notablesschema/)
```
