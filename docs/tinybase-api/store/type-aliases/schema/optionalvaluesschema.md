...
The `OptionalValuesSchema` type is used by generic types that can optionally take a [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) | NoValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/novaluesschema/)
```
