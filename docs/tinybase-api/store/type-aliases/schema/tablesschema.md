...
# `TablesSchema`
The `TablesSchema` type describes the tabular structure of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) in terms of valid [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) and the types of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) that can exist within them.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: CellSchema[](https://tinybase.org/api/store/type-aliases/schema/cellschema/)}}
```

A `TablesSchema` comprises a JavaScript object describing each [`Table`](https://tinybase.org/api/store/type-aliases/store/table/), in turn a nested JavaScript object containing information about each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) and its [`CellSchema`](https://tinybase.org/api/store/type-aliases/schema/cellschema/). It is provided to the [`setTablesSchema`](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settablesschema/) method.
## Example
When applied to a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), this `TablesSchema` only allows one [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) called `pets`, in which each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) may contain a string `species` [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/), and is guaranteed to contain a boolean `sold` [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) that defaults to `false`.
