...
# `NoSchemas`
The `NoSchemas` type is used as a default by generic types that can optionally take either or both of a [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
[NoTablesSchema[](https://tinybase.org/api/store/type-aliases/schema/notablesschema/), NoValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/novaluesschema/)]
```
