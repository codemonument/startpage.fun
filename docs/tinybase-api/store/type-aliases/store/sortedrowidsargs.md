...
# `SortedRowIdsArgs`
The `SortedRowIdsArgs` type describes the arguments used to sort [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) using the [`getSortedRowIds`](https://tinybase.org/api/store/interfaces/store/store/methods/getter/getsortedrowids/) method.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in the [`Store`](https://tinybase.org/api/store/interfaces/store/store/), required.  |  
| `cellId?`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The optional [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) whose values are used for the sorting, defaults to sorting by the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) itself.  |  
| `descending?`  | `boolean`  | Whether the sorting should be in descending order, defaulting to false.  |  
| `offset?`  | `number`  | The number of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) to skip for pagination purposes, defaulting to 0.  |  
| `limit?`  | `number`  | The maximum number of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) to return, defaulting to all.  |  
It's an object containing the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in the [`Store`](https://tinybase.org/api/store/interfaces/store/store/), and optional `cellId`, `descending`, `offset`, and `limit` parameters. See the [`getSortedRowIds`](https://tinybase.org/api/store/interfaces/store/store/methods/getter/getsortedrowids/) method for specific examples.
## Since
v6.1.0
