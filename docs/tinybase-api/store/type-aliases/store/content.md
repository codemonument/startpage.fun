...
# `Content`
The `Content` type describes both the [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) and [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
[Tables[](https://tinybase.org/api/store/type-aliases/store/tables/), Values[](https://tinybase.org/api/store/type-aliases/store/values/)]
```
