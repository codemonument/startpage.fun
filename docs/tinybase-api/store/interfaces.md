...
## `Store`
Essential
A [`Store`](https://tinybase.org/api/store/interfaces/store/store/) is the main location for keeping both tabular data and keyed values. [Read more](https://tinybase.org/api/store/interfaces/store/store/).
