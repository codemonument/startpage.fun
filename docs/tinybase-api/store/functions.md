...
## `createStore`
Essential
The [`createStore`](https://tinybase.org/api/store/functions/creation/createstore/) function creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and is the main entry point into the [`store`](https://tinybase.org/api/store/) module. [Read more](https://tinybase.org/api/store/functions/creation/createstore/).
