...
# `createStore`
Essential
The `createStore` function creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and is the main entry point into the [`store`](https://tinybase.org/api/store/) module.

```
createStore[](https://tinybase.org/api/store/functions/creation/createstore/)(): Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)
```
  
| returns  | `Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)`  | A reference to the new [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).  |  
| --- | --- | --- |  
Since (or perhaps _because_) it is the most important function in the whole module, it is trivially simple.
## Examples
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with some initial data:
...
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with some initial data and a [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/):
...
## See also
[The Basics](https://tinybase.org/guides/the-basics/) guides
## Since
v1.0.0
