    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`persister-durable-object-sql-storage`](https://tinybase.org/api/persister-durable-object-sql-storage/)
        ...
        * [Type Aliases](https://tinybase.org/api/persister-durable-object-sql-storage/type-aliases/)
          * [`DpcFragmented`](https://tinybase.org/api/persister-durable-object-sql-storage/type-aliases/configuration/dpcfragmented/)
          * [`DurableObjectSqlDatabasePersisterConfig`](https://tinybase.org/api/persister-durable-object-sql-storage/type-aliases/configuration/durableobjectsqldatabasepersisterconfig/)
...
The `DurableObjectSqlDatabasePersisterConfig` type represents the union of all possible configuration types for a [`DurableObjectSqlStoragePersister`](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/).

```
DpcJson[](https://tinybase.org/api/persisters/type-aliases/configuration/dpcjson/) | DpcFragmented[](https://tinybase.org/api/persister-durable-object-sql-storage/type-aliases/configuration/dpcfragmented/)
```

This allows the persister to support multiple persistence modes.
  * JSON mode (via [`DpcJson`](https://tinybase.org/api/persisters/type-aliases/configuration/dpcjson/)): Stores the entire [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) as JSON in a single row.
  * Fragmented mode (via [`DpcFragmented`](https://tinybase.org/api/persister-durable-object-sql-storage/type-aliases/configuration/dpcfragmented/)): Stores each piece of data as separate rows.
