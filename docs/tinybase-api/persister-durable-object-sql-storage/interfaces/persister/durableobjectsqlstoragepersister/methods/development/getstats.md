...
# `getStats`
The `getStats` method provides a set of statistics about the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/), and is used for debugging purposes.

```
getStats[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/development/getstats/)(): PersisterStats[](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/)
```
  
| returns  | `PersisterStats[](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/)`  | A [`PersisterStats`](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/) object containing [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) load and save statistics.  |  
| --- | --- | --- |  
The [`PersisterStats`](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/) object contains a count of the number of times the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) has loaded and saved data.
The method is intended to be used during development to ensure your persistence layer is acting as expected, for example.
## Example
This example gets the load and save statistics of a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object. Remember that the [`startAutoLoad`](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/load/startautoload/) method invokes an explicit load when it starts, and the [`startAutoSave`](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/save/startautosave/) method invokes an explicit save when it starts - so those numbers are included in addition to the loads and saves invoked by changes to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and to the underlying storage.
...
console.log(persister.getStats[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/development/getstats/)());
// -> {loads: 2, saves: 2}
