...
# `isAutoLoading`
The `isAutoLoading` method lets you find out if the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently automatically loading its content.

```
isAutoLoading[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/load/isautoloading/)(): boolean
```
  
| returns  | `boolean`  | A boolean indicating whether the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently autoLoading.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) and queries whether it is autoLoading.
