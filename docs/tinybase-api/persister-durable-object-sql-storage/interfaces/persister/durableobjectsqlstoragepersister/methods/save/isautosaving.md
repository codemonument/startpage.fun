...
# `isAutoSaving`
The `isAutoSaving` method lets you find out if the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently automatically saving its content.

```
isAutoSaving[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/save/isautosaving/)(): boolean
```
  
| returns  | `boolean`  | A boolean indicating whether the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently autoSaving.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) and queries whether it is autoSaving.
