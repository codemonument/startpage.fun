...
# `delListener`
The `delListener` method removes a listener that was previously added to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/).

```
delListener[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/listener/dellistener/)(listenerId: string): this
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listenerId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the listener to remove.  |  
| returns  | `this`  | A reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/).  |  
Use the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) returned by whichever method was used to add the listener. Note that the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) may re-use this [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for future listeners added to it.
## Example
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/listener/addstatuslistener/)((_persister, status) => {
