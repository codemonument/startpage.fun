...
# `getSqlStorage`
The `getSqlStorage` method returns a reference to the SQL storage that the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getSqlStorage[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/getter/getsqlstorage/)(): SqlStorage
```
  
| returns  | `SqlStorage`  | The reference to the SQL storage.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) (within the [`createPersister`](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/creation/createpersister/) method of a [`WsServerDurableObject`](https://tinybase.org/api/the-essentials/synchronizing-stores/wsserverdurableobject/) instance) and then gets the SQL storage reference back out again.
...
export class MyDurableObject extends WsServerDurableObject[](https://tinybase.org/api/the-essentials/synchronizing-stores/wsserverdurableobject/) {
  createPersister[](https://tinybase.org/api/synchronizer-ws-server-durable-object/classes/creation/wsserverdurableobject/methods/creation/createpersister/)() {
    ...
    console.log(persister.getSqlStorage[](https://tinybase.org/api/persister-durable-object-sql-storage/interfaces/persister/durableobjectsqlstoragepersister/methods/getter/getsqlstorage/)() == this.ctx.storage.sql);
    // -> true
