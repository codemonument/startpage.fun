...
The [`addCheckpointIdsListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointidslistener/) method registers a listener function with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object that will be called whenever its set of checkpoints changes. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointidslistener/).
## `addCheckpointListener`
The [`addCheckpointListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointlistener/) method registers a listener function with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object that will be called whenever the label of a checkpoint changes. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointlistener/).
## `delListener`
The [`delListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/dellistener/) method removes a listener that was previously added to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/dellistener/).
