...
# Lifecycle methods
## `clear`
The [`clear`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clear/) method resets this [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object to its initial state, removing all the checkpoints it has been managing. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clear/).
## `clearForward`
The [`clearForward`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clearforward/) method resets just the 'redo' checkpoints it has been managing. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clearforward/).
## `destroy`
The [`destroy`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/destroy/) method should be called when this [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object is no longer used. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/destroy/).
