        ...
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            ...
            * [Iterator methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/iterator/)
              * [`forEachCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/iterator/foreachcheckpoint/)
...
# Iterator methods
## `forEachCheckpoint`
The [`forEachCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/iterator/foreachcheckpoint/) method takes a function that it will then call for each Checkpoint in a specified [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/iterator/foreachcheckpoint/).
