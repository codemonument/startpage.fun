        ...
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            * [Getter methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/)
              * [`getStore`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getstore/)
              * [`getCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)
              * [`getCheckpointIds`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpointids/)
              * [`hasCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/hascheckpoint/)
...
# `getCheckpoint`
The `getCheckpoint` method fetches the label for a checkpoint, if it had been provided at the time of the [`addCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/) method or set subsequently with the [`setCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/) method.

```
getCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)(checkpointId: string): undefined | string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `checkpointId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint to get the label for.  |  
...
## Examples
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and sets a checkpoint with a label, before retrieving it again.
...
console.log(checkpoints.addCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/)('sale'));
// -> '1'
...
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and sets a checkpoint without a label, setting it subsequently. A non-existent checkpoint return an `undefined` label.
...
checkpoints.setCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/)('1', 'sold');
console.log(checkpoints.getCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)('1'));
// -> 'sold'
