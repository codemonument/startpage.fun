      ...
      * [`checkpoints`](https://tinybase.org/api/checkpoints/)
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            * [Getter methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/)
            * [Setter methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/)
              * [`addCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/)
              * [`setCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/)
            * [Listener methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/)
            * [Configuration methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/configuration/)
            * [Iterator methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/iterator/)
            * [Lifecycle methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/)
            * [Movement methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/movement/)
            * [Development methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/)
...
# `setCheckpoint`
The `setCheckpoint` method updates the label for a checkpoint in the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object after it has been created.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `checkpointId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint to set the label for.  |  
...
| returns  | `Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)`  | A reference to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.  |  
The `label` parameter can be used to describe the actions that changed the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) before the given checkpoint. This can be useful for interfaces that let users 'Undo [last action]'.
Generally you will provide the `label` parameter when the [`addCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/) method is called. Use this `setCheckpoint` method only when you need to change the label at a later point.
You cannot add a label to a checkpoint that does not yet exist.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and sets two checkpoints, one with a label, which are both then re-labelled.
...
console.log(checkpoints.getCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)('1'));
// -> ''
console.log(checkpoints.getCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)('2'));
// -> 'sale'

checkpoints.setCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/)('1', 'identified');
checkpoints.setCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/)('2', '');
...
checkpoints.setCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/)('3', 'unknown');
console.log(checkpoints.getCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpoint/)('3'));
// -> undefined
