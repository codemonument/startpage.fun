        ...
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            ...
            * [Development methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/)
              * [`getListenerStats`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/getlistenerstats/)
...
# Development methods
## `getListenerStats`
The [`getListenerStats`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/getlistenerstats/) method provides a set of statistics about the listeners registered with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and is used for debugging purposes. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/getlistenerstats/).
