...
```
clearForward[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clearforward/)(): Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
```
...
| --- | --- | --- |  
Obviously this method should be used with caution as it destroys the ability to redo recent changes to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) (though of course the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) itself is not reset by this method).
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, adds a listener, makes a change and then clears the forward checkpoints.
...
checkpoints.clearForward[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clearforward/)();
// -> 'checkpoints changed'
