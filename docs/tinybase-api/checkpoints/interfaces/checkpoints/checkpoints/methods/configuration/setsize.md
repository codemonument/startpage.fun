        ...
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            ...
            * [Configuration methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/configuration/)
              * [`setSize`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/configuration/setsize/)
...
# `setSize`
The `setSize` method lets you specify how many checkpoints the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object will store.

```
setSize[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/configuration/setsize/)(size: number): Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `size`  | `number`  | The number of checkpoints that this [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object should hold.  |  
...
The default size for a newly-created [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object is 100.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, reduces the size of the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object dramatically and then creates more than that number of checkpoints to demonstrate the oldest being pruned.

```
import {createCheckpoints, createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)().setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {views: 0}}});

const checkpoints = createCheckpoints[](https://tinybase.org/api/checkpoints/functions/creation/createcheckpoints/)(store);
checkpoints.setSize[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/configuration/setsize/)(2);
...
store.setCell[](https://tinybase.org/api/the-essentials/setting-data/setcell/)('pets', 'fido', 'views', 1);
...
store.setCell[](https://tinybase.org/api/the-essentials/setting-data/setcell/)('pets', 'fido', 'views', 2);
checkpoints.addCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/)();
console.log(checkpoints.getCheckpointIds[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpointids/)());
// -> [['0', '1'], '2', []]

store.setCell[](https://tinybase.org/api/the-essentials/setting-data/setcell/)('pets', 'fido', 'views', 3);
checkpoints.addCheckpoint[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/)();
console.log(checkpoints.getCheckpointIds[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/getter/getcheckpointids/)());
// -> [['1', '2'], '3', []]
