        ...
        * [Interfaces](https://tinybase.org/api/checkpoints/interfaces/)
          * [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
            ...
            * [Listener methods](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/)
              * [`addCheckpointIdsListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointidslistener/)
              * [`addCheckpointListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointlistener/)
              * [`delListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/dellistener/)
...
# `delListener`
The `delListener` method removes a listener that was previously added to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.

```
delListener[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/dellistener/)(listenerId: string): Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)
```
...
Use the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) returned by the [`addCheckpointIdsListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointidslistener/) method. Note that the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object may re-use this [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for future listeners added to it.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, registers a listener, and then removes it.
