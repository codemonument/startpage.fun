...
# Setter methods
## `addCheckpoint`
The [`addCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/) method records a checkpoint of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) into the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object that can be reverted to in the future. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/addcheckpoint/).
## `setCheckpoint`
The [`setCheckpoint`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/) method updates the label for a checkpoint in the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object after it has been created. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/setter/setcheckpoint/).
