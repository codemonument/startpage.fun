...
## `CheckpointCallback`
The [`CheckpointCallback`](https://tinybase.org/api/checkpoints/type-aliases/callback/checkpointcallback/) type describes a function that takes a Checkpoint's [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). [Read more](https://tinybase.org/api/checkpoints/type-aliases/callback/checkpointcallback/).
