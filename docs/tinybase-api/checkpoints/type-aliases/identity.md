...
## `CheckpointIds`
The [`CheckpointIds`](https://tinybase.org/api/checkpoints/type-aliases/identity/checkpointids/) type is a representation of the list of checkpoint [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) stored in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object. [Read more](https://tinybase.org/api/checkpoints/type-aliases/identity/checkpointids/).
