...
The [`CheckpointsListenerStats`](https://tinybase.org/api/checkpoints/type-aliases/development/checkpointslistenerstats/) type describes the number of listeners registered with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and can be used for debugging purposes. [Read more](https://tinybase.org/api/checkpoints/type-aliases/development/checkpointslistenerstats/).
