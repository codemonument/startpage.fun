      ...
      * [`checkpoints`](https://tinybase.org/api/checkpoints/)
        ...
        * [Type Aliases](https://tinybase.org/api/checkpoints/type-aliases/)
          ...
          * [Identity type aliases](https://tinybase.org/api/checkpoints/type-aliases/identity/)
            * [`CheckpointIds`](https://tinybase.org/api/checkpoints/type-aliases/identity/checkpointids/)
...
# `CheckpointIds`
The `CheckpointIds` type is a representation of the list of checkpoint [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) stored in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.

```
[Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/), Id[](https://tinybase.org/api/common/type-aliases/identity/id/) | undefined, Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)]
```
