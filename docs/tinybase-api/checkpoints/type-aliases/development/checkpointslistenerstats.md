      ...
      * [`checkpoints`](https://tinybase.org/api/checkpoints/)
        ...
        * [Type Aliases](https://tinybase.org/api/checkpoints/type-aliases/)
          ...
          * [Development type aliases](https://tinybase.org/api/checkpoints/type-aliases/development/)
            * [`CheckpointsListenerStats`](https://tinybase.org/api/checkpoints/type-aliases/development/checkpointslistenerstats/)
...
The `CheckpointsListenerStats` type describes the number of listeners registered with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and can be used for debugging purposes.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `checkpointIds`  | `number`  | The number of [`CheckpointIdsListener`](https://tinybase.org/api/checkpoints/type-aliases/listener/checkpointidslistener/) functions registered with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.  |  
| `checkpoint`  | `number`  | The number of [`CheckpointListener`](https://tinybase.org/api/checkpoints/type-aliases/listener/checkpointlistener/) functions registered with the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.  |  
A `CheckpointsListenerStats` object is returned from the [`getListenerStats`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/development/getlistenerstats/) method.
## Since
v1.0.0
