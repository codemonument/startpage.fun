...
The `CheckpointIdsListener` type describes a function that is used to listen to changes to the checkpoint [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.

```
(checkpoints: Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)): void
```
...
A `CheckpointIdsListener` is provided when using the [`addCheckpointIdsListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointidslistener/) method. See that method for specific examples.
When called, a `CheckpointIdsListener` is given a reference to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.
## Since
v1.0.0
