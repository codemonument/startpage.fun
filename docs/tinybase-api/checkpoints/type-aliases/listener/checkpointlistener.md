    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`checkpoints`](https://tinybase.org/api/checkpoints/)
        ...
        * [Type Aliases](https://tinybase.org/api/checkpoints/type-aliases/)
          * [Listener type aliases](https://tinybase.org/api/checkpoints/type-aliases/listener/)
            * [`CheckpointIdsListener`](https://tinybase.org/api/checkpoints/type-aliases/listener/checkpointidslistener/)
            * [`CheckpointListener`](https://tinybase.org/api/checkpoints/type-aliases/listener/checkpointlistener/)
          * [Callback type aliases](https://tinybase.org/api/checkpoints/type-aliases/callback/)
          * [Identity type aliases](https://tinybase.org/api/checkpoints/type-aliases/identity/)
          * [Development type aliases](https://tinybase.org/api/checkpoints/type-aliases/development/)
...
# `CheckpointListener`
The `CheckpointListener` type describes a function that is used to listen to changes to a checkpoint's label in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `checkpoints`  | `Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/)`  | A reference to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object that changed.  |  
| `checkpointId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint that changed.  |  
| returns  | `void`  | This has no return value.  |  
A `CheckpointListener` is provided when using the [`addCheckpointListener`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/listener/addcheckpointlistener/) method. See that method for specific examples.
When called, a `CheckpointListener` is given a reference to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint whose label changed.
## Since
v1.0.0
