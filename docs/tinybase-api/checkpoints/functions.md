...
# Functions
## `createCheckpoints`
The [`createCheckpoints`](https://tinybase.org/api/checkpoints/functions/creation/createcheckpoints/) function creates a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, and is the main entry point into the [`checkpoints`](https://tinybase.org/api/checkpoints/) module. [Read more](https://tinybase.org/api/checkpoints/functions/creation/createcheckpoints/).
