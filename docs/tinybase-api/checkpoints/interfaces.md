...
# Interfaces
## `Checkpoints`
A [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object lets you set checkpoints on a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and move forward and backward through them to create undo and redo functionality. [Read more](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/).
