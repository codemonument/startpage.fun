...
# Type Aliases
## `InspectorProps`
[`InspectorProps`](https://tinybase.org/api/ui-react-inspector/type-aliases/props/inspectorprops/) props are used to configure the [`Inspector`](https://tinybase.org/api/the-essentials/using-react/inspector/) component. [Read more](https://tinybase.org/api/ui-react-inspector/type-aliases/props/inspectorprops/).
