      ...
      * [`synchronizer-ws-server-simple`](https://tinybase.org/api/synchronizer-ws-server-simple/)
        * [Interfaces](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/)
          * [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/)
            * [`destroy`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/destroy/)
            * [`getWebSocketServer`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/getwebsocketserver/)
...
# `WsServerSimple`
The `WsServerSimple` interface represents an object that facilitates synchronization between clients that are using [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) instances.
The core functionality is equivalent to the [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/) interface, but without the complications of listeners, persistence, or statistics.
You should use the [`createWsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/functions/creation/createwsserversimple/) function to create a `WsServerSimple` object.
## Since
v5.4.0
## `destroy`
The `destroy` method provides a way to clean up the server at the end of its use. [Read more](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/destroy/).
## `getWebSocketServer`
The `getWebSocketServer` method returns a reference to the WebSocketServer being used for this [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/). [Read more](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/getwebsocketserver/).
