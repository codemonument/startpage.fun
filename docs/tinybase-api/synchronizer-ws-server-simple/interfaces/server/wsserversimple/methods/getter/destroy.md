...
```
destroy[](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/destroy/)(): Promise<void>
```
  
| returns  | `Promise<void>`  |   |  
| --- | --- | --- |  
This closes the underlying WebSocketServer that was provided when the [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/) was created. This method is asynchronous.
## Example
This example creates a [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/) and then destroys it again, closing the underlying WebSocketServer.
