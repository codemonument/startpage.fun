...
# `getWebSocketServer`
The `getWebSocketServer` method returns a reference to the WebSocketServer being used for this [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/).

```
getWebSocketServer[](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/getwebsocketserver/)(): WebSocketServer
```
  
| returns  | `WebSocketServer`  | The WebSocketServer reference.  |  
| --- | --- | --- |  
## Example
This example creates a [`WsServerSimple`](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/) and then gets the WebSocketServer reference back out again.
...
const server = createWsServerSimple[](https://tinybase.org/api/synchronizer-ws-server-simple/functions/creation/createwsserversimple/)(webSocketServer);

console.log(server.getWebSocketServer[](https://tinybase.org/api/synchronizer-ws-server-simple/interfaces/server/wsserversimple/methods/getter/getwebsocketserver/)() == webSocketServer);
// -> true
