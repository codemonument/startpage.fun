...
```
stopSync[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/synchronization/stopsync/)(): Promise<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>
```
  
| returns  | `Promise<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>`  | A Promise containing a reference to the [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) object.  |  
| --- | --- | --- |  
The underlying implementation of a [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) is shared with the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) framework, and so this [`startSync`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/synchronization/startsync/) method is equivalent to stopping both auto-loading (listening to sync messages from other active [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) instances) and auto-saving (sending sync messages to them).
...
await synchronizer1.stopSync[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/synchronization/stopsync/)();
await synchronizer2.stopSync[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/synchronization/stopsync/)();
