...
```
destroy[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/lifecycle/destroy/)(): Promise<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>
```
...
await persister.startAutoSave[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/save/startautosave/)();
