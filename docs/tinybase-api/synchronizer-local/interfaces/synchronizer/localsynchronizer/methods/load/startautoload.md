        ...
        * [Interfaces](https://tinybase.org/api/synchronizer-local/interfaces/)
          * [`LocalSynchronizer`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)
            ...
            * [Load methods](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/stopautoload/)
...
| returns  | `Promise<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
...
await persister.destroy[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/lifecycle/destroy/)();
