...
```
getStore[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/getter/getstore/)(): MergeableStore[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/)
```
...
persister.getStore[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/getter/getstore/)().setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {species: 'dog'}}});
// ...
