...
```
addStatusListener[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<LocalSynchronizer[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/)>`  | The function that will be called whenever the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) starts or stops loading or saving.  |  
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
await persister.save[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/save/save/)();
// -> 'pets persister status changed to 2'
// -> 'pets persister status changed to 0'

persister.delListener[](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/methods/listener/dellistener/)(listenerId);
