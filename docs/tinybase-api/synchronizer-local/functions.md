...
The [`createLocalSynchronizer`](https://tinybase.org/api/synchronizer-local/functions/creation/createlocalsynchronizer/) function creates a [`LocalSynchronizer`](https://tinybase.org/api/synchronizer-local/interfaces/synchronizer/localsynchronizer/) object that can synchronize [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) data to and from other [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) instances on the same local machine. [Read more](https://tinybase.org/api/synchronizer-local/functions/creation/createlocalsynchronizer/).
