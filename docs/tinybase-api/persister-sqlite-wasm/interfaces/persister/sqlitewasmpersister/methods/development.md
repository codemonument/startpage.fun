...
# Development methods
## `getStats`
The [`getStats`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/development/getstats/) method provides a set of statistics about the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/), and is used for debugging purposes. [Read more](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/development/getstats/).
