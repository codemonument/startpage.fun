...
```
getDb[](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/getter/getdb/)(): any
```
...
console.log(persister.getDb[](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/getter/getdb/)() == db);
// -> true
