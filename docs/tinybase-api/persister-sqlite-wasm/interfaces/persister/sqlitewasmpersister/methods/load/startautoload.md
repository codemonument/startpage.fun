      ...
      * [`persister-sqlite-wasm`](https://tinybase.org/api/persister-sqlite-wasm/)
        * [Interfaces](https://tinybase.org/api/persister-sqlite-wasm/interfaces/)
          * [`SqliteWasmPersister`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/)
            * [Getter methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/development/)
...
| returns  | `Promise<SqliteWasmPersister[](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
...
await persister.destroy[](https://tinybase.org/api/persister-sqlite-wasm/interfaces/persister/sqlitewasmpersister/methods/lifecycle/destroy/)();
