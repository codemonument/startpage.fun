...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of external schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizers/interfaces/schematizer/schematizer/methods/conversion/totablesschema/)(schemas: any): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
