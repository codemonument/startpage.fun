...
# `toValuesSchema`
The `toValuesSchema` method converts a mapping of external schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
toValuesSchema[](https://tinybase.org/api/schematizers/interfaces/schematizer/schematizer/methods/conversion/tovaluesschema/)(schemas: any): ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/)
```
