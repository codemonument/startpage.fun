...
The `persister-indexed-db` module of the TinyBase project lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from browser IndexedDB storage.
## See also
