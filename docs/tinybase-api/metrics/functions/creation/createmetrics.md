...
# `createMetrics`
The `createMetrics` function creates a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and is the main entry point into the [`metrics`](https://tinybase.org/api/metrics/) module.

```
createMetrics[](https://tinybase.org/api/metrics/functions/creation/createmetrics/)(store: Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)): Metrics[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `store`  | `Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)`  | The [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) for which to register [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definitions.  |  
| returns  | `Metrics[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)`  | A reference to the new [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.  |  
...
## Examples
This example creates a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.
...
This example creates a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and calls the method a second time for the same [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to return the same object.

```
import {createMetrics, createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/store/functions/creation/createstore/)();
const metrics1 = createMetrics[](https://tinybase.org/api/metrics/functions/creation/createmetrics/)(store);
const metrics2 = createMetrics[](https://tinybase.org/api/metrics/functions/creation/createmetrics/)(store);
