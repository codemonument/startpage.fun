        ...
        * [Interfaces](https://tinybase.org/api/metrics/interfaces/)
          * [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
            * [Getter methods](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/)
              * [`getStore`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getstore/)
              * [`getTableId`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/gettableid/)
              * [`getMetric`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetric/)
              * [`getMetricIds`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetricids/)
              * [`hasMetric`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/hasmetric/)
...
# `getMetric`
The `getMetric` method gets the current value of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/).

```
getMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetric/)(metricId: string): undefined | number
```
...
| returns  | `undefined | number`  | The numeric value of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/), or `undefined`.  |  
If the identified [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) does not exist (or if the definition references a [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) or [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) value that does not exist) then `undefined` is returned.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), creates a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and defines a simple [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) to average the price values in the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). It then uses getMetric to access its value (and also the value of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) that has not been defined).

```
import {createMetrics, createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)().setTable[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/setter/settable/)('species', {
  dog: {price: 5},
  cat: {price: 4},
  worm: {price: 1},
});
...
// -> 5
console.log(metrics.getMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetric/)('lowestPrice'));
// -> undefined
