...
# `hasMetric`
The `hasMetric` method returns a boolean indicating whether a given [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) exists in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and has a value.

```
hasMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/hasmetric/)(metricId: string): boolean
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.  |  
| returns  | `boolean`  | Whether a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
This example shows two simple [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) existence checks.
...
console.log(metrics.hasMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/hasmetric/)('lowestPrice'));
// -> false
console.log(metrics.hasMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/hasmetric/)('highestPrice'));
// -> false
