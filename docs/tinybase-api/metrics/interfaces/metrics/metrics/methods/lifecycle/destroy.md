        ...
        * [Interfaces](https://tinybase.org/api/metrics/interfaces/)
          * [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
            ...
            * [Lifecycle methods](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/)
              * [`destroy`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/destroy/)
...
# `destroy`
The `destroy` method should be called when this [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object is no longer used.

```
destroy[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/destroy/)(): void
```
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), adds a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object with a definition (that registers a [`RowListener`](https://tinybase.org/api/store/type-aliases/listener/rowlistener/) with the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/)), and then destroys it again, removing the listener.
...
console.log(store.getListenerStats[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/)().row);
// -> 1

metrics.destroy[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/destroy/)();
