...
## `delMetricDefinition`
The [`delMetricDefinition`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/) method removes an existing [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/).
## `setMetricDefinition`
The [`setMetricDefinition`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/setmetricdefinition/) method lets you set the definition of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/). [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/setmetricdefinition/).
