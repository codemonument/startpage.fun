        ...
        * [Interfaces](https://tinybase.org/api/metrics/interfaces/)
          * [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
            ...
            * [Iterator methods](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/)
              * [`forEachMetric`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/)
...
# `forEachMetric`
The `forEachMetric` method takes a function that it will then call for each [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.

```
forEachMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/)(metricCallback: MetricCallback[](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/)): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricCallback`  | `MetricCallback[](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/)`  | The function that should be called for every [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over all the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) in a functional style. The `metricCallback` parameter is a [`MetricCallback`](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of each [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) and its value.
## Example
This example iterates over each [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.
...
const metrics = createMetrics[](https://tinybase.org/api/metrics/functions/creation/createmetrics/)(store)
  ...
  .setMetricDefinition[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/setmetricdefinition/)('lowestPrice', 'species', 'min', 'price');

metrics.forEachMetric[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/)((metricId, metric) => {
