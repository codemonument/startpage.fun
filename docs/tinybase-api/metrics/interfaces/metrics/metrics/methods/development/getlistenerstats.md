        ...
        * [Interfaces](https://tinybase.org/api/metrics/interfaces/)
          * [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
            ...
            * [Development methods](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/)
              * [`getListenerStats`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/)
...
# `getListenerStats`
The `getListenerStats` method provides a set of statistics about the listeners registered with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and is used for debugging purposes.

```
getListenerStats[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/)(): MetricsListenerStats[](https://tinybase.org/api/metrics/type-aliases/development/metricslistenerstats/)
```
  
| returns  | `MetricsListenerStats[](https://tinybase.org/api/metrics/type-aliases/development/metricslistenerstats/)`  | A [`MetricsListenerStats`](https://tinybase.org/api/metrics/type-aliases/development/metricslistenerstats/) object containing [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) listener statistics.  |  
| --- | --- | --- |  
...
## Example
This example gets the listener statistics of a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.
...
metrics.addMetricListener[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetriclistener/)(null, () => console.log('Metric changed'));

console.log(metrics.getListenerStats[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/)());
// -> {metric: 1}
