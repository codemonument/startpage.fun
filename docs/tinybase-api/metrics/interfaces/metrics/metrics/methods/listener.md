...
The [`addMetricIdsListener`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetricidslistener/) method registers a listener function with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object that will be called whenever a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition is added or removed. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetricidslistener/).
## `addMetricListener`
The [`addMetricListener`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetriclistener/) method registers a listener function with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object that will be called whenever the value of a specified [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) changes. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetriclistener/).
## `delListener`
The [`delListener`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/dellistener/) method removes a listener that was previously added to the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/dellistener/).
