...
# Iterator methods
## `forEachMetric`
The [`forEachMetric`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/) method takes a function that it will then call for each [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/).
