...
# Development methods
## `getListenerStats`
The [`getListenerStats`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/) method provides a set of statistics about the listeners registered with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and is used for debugging purposes. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/).
