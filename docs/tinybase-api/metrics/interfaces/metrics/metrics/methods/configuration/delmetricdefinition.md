        ...
        * [Interfaces](https://tinybase.org/api/metrics/interfaces/)
          * [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
            ...
            * [Configuration methods](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/)
              * [`delMetricDefinition`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/)
              * [`setMetricDefinition`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/setmetricdefinition/)
...
# `delMetricDefinition`
The `delMetricDefinition` method removes an existing [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition.

```
delMetricDefinition[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/)(metricId: string): Metrics[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) to remove.  |  
...
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), creates a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, defines a simple [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/), and then removes it.
...
metrics.delMetricDefinition[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/)('speciesCount');
console.log(metrics.getMetricIds[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetricids/)());
// -> []
