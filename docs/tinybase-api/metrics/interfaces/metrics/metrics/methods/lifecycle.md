...
# Lifecycle methods
## `destroy`
The [`destroy`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/destroy/) method should be called when this [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object is no longer used. [Read more](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/lifecycle/destroy/).
