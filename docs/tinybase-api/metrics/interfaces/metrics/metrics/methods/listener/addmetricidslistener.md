...
The `addMetricIdsListener` method registers a listener function with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object that will be called whenever a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition is added or removed.

```
addMetricIdsListener[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetricidslistener/)(listener: MetricIdsListener[](https://tinybase.org/api/metrics/type-aliases/listener/metricidslistener/)): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `MetricIdsListener[](https://tinybase.org/api/metrics/type-aliases/listener/metricidslistener/)`  | The function that will be called whenever a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition is added or removed.  |  
| returns  | `string`  |   |  
The provided listener is a [`MetricIdsListener`](https://tinybase.org/api/metrics/type-aliases/listener/metricidslistener/) function, and will be called with a reference to the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and then registers a listener that responds to the addition and the removal of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definition.
...
const listenerId = metrics.addMetricIdsListener[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/listener/addmetricidslistener/)((metrics) => {
  console.log(metrics.getMetricIds[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/getter/getmetricids/)());
});
...
// -> ['highestPrice']
metrics.delMetricDefinition[](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/configuration/delmetricdefinition/)('highestPrice');
// -> []
