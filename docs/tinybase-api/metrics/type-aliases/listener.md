...
## `MetricIdsListener`
The [`MetricIdsListener`](https://tinybase.org/api/metrics/type-aliases/listener/metricidslistener/) type describes a function that is used to listen to [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) definitions being added or removed. [Read more](https://tinybase.org/api/metrics/type-aliases/listener/metricidslistener/).
## `MetricListener`
The [`MetricListener`](https://tinybase.org/api/metrics/type-aliases/listener/metriclistener/) type describes a function that is used to listen to changes to a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/). [Read more](https://tinybase.org/api/metrics/type-aliases/listener/metriclistener/).
