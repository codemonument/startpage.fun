...
The [`MetricsListenerStats`](https://tinybase.org/api/metrics/type-aliases/development/metricslistenerstats/) type describes the number of listeners registered with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and can be used for debugging purposes. [Read more](https://tinybase.org/api/metrics/type-aliases/development/metricslistenerstats/).
