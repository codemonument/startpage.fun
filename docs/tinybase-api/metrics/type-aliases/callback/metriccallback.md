      ...
      * [`metrics`](https://tinybase.org/api/metrics/)
        ...
        * [Type Aliases](https://tinybase.org/api/metrics/type-aliases/)
          ...
          * [Callback type aliases](https://tinybase.org/api/metrics/type-aliases/callback/)
            * [`MetricCallback`](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/)
...
# `MetricCallback`
The `MetricCallback` type describes a function that takes a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) within it.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) that the callback can operate on.  |  
| `metric?`  | `Metric[](https://tinybase.org/api/metrics/type-aliases/metric/metric/)`  | The value of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/).  |  
| returns  | `void`  | This has no return value.  |  
A `MetricCallback` is provided when using the [`forEachMetric`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/iterator/foreachmetric/) method, so that you can do something based on every [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object. See that method for specific examples.
## Since
v1.0.0
