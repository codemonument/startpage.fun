...
The `MetricsListenerStats` type describes the number of listeners registered with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and can be used for debugging purposes.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `metric`  | `number`  | The number of [`MetricListener`](https://tinybase.org/api/metrics/type-aliases/listener/metriclistener/) functions registered with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object.  |  
A `MetricsListenerStats` object is returned from the [`getListenerStats`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/methods/development/getlistenerstats/) method.
## Since
v1.0.0
