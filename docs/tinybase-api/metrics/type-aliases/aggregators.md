    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`metrics`](https://tinybase.org/api/metrics/)
        ...
        * [Type Aliases](https://tinybase.org/api/metrics/type-aliases/)
          * [Listener type aliases](https://tinybase.org/api/metrics/type-aliases/listener/)
          * [Aggregators type aliases](https://tinybase.org/api/metrics/type-aliases/aggregators/)
            * [`MetricAggregate`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/)
            * [`MetricAggregateAdd`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateadd/)
            * [`MetricAggregateRemove`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateremove/)
            * [`MetricAggregateReplace`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregatereplace/)
          * [Callback type aliases](https://tinybase.org/api/metrics/type-aliases/callback/)
          * [Metric type aliases](https://tinybase.org/api/metrics/type-aliases/metric/)
          * [Development type aliases](https://tinybase.org/api/metrics/type-aliases/development/)
...
## `MetricAggregate`
The [`MetricAggregate`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/) type describes a custom function that takes an array of numbers and returns an aggregate that is used as a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/). [Read more](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/).
## `MetricAggregateAdd`
The [`MetricAggregateAdd`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateadd/) type describes a function that can be used to optimize a custom [`MetricAggregate`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/) by providing a shortcut for when a single value is added to the input values. [Read more](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateadd/).
## `MetricAggregateRemove`
The [`MetricAggregateRemove`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateremove/) type describes a function that can be used to optimize a custom [`MetricAggregate`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/) by providing a shortcut for when a single value is removed from the input values. [Read more](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregateremove/).
## `MetricAggregateReplace`
The [`MetricAggregateReplace`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregatereplace/) type describes a function that can be used to optimize a custom [`MetricAggregate`](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregate/) by providing a shortcut for when a single value in the input values is replaced with another. [Read more](https://tinybase.org/api/metrics/type-aliases/aggregators/metricaggregatereplace/).
