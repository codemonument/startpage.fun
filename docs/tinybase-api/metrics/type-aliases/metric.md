...
# Metric type aliases
## `Metric`
The [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) type is simply an alias, but represents a number formed by aggregating multiple other numbers together. [Read more](https://tinybase.org/api/metrics/type-aliases/metric/metric/).
