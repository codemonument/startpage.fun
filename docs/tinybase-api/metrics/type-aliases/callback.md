...
## `MetricCallback`
The [`MetricCallback`](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/) type describes a function that takes a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) within it. [Read more](https://tinybase.org/api/metrics/type-aliases/callback/metriccallback/).
