...
```
getStats[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/development/getstats/)(): PersisterStats[](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/)
```
...
## Example
This example gets the load and save statistics of a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object. Remember that the [`startAutoLoad`](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/load/startautoload/) method invokes an explicit load when it starts, and the [`startAutoSave`](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/save/startautosave/) method invokes an explicit save when it starts - so those numbers are included in addition to the loads and saves invoked by changes to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and to the underlying storage.
...
console.log(persister.getStats[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/development/getstats/)());
// -> {loads: 2, saves: 2}
