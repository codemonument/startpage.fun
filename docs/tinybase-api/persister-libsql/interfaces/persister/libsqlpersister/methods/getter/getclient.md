...
# `getClient`
The `getClient` method returns a reference to the database client the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getClient[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/getter/getclient/)(): Client
```
  
| returns  | `Client`  | A reference to the database client.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the database client back out again.
...
console.log(persister.getClient[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/getter/getclient/)() == client);
// -> true
