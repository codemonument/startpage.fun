...
```
destroy[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/lifecycle/destroy/)(): Promise<LibSqlPersister[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/)>
```
...
await persister.startAutoSave[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/save/startautosave/)();
