...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/load/stopautoload/)(): Promise<LibSqlPersister[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/methods/load/stopautoload/)();
