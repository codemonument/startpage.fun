...
The [`createLibSqlPersister`](https://tinybase.org/api/persister-libsql/functions/creation/createlibsqlpersister/) function creates a [`LibSqlPersister`](https://tinybase.org/api/persister-libsql/interfaces/persister/libsqlpersister/) object that can persist a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local LibSQL database. [Read more](https://tinybase.org/api/persister-libsql/functions/creation/createlibsqlpersister/).
