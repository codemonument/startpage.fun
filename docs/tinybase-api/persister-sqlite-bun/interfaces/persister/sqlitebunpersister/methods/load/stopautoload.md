...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/stopautoload/)(): Promise<SqliteBunPersister[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/stopautoload/)();
