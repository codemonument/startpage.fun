...
# Load methods
## `isAutoLoading`
The [`isAutoLoading`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/isautoloading/) method lets you find out if the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is currently automatically loading its content. [Read more](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/isautoloading/).
## `load`
The [`load`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/load/) method gets persisted data from storage, and loads it into the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with which the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is associated, once. [Read more](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/load/).
## `startAutoLoad`
The [`startAutoLoad`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/startautoload/) method gets persisted data from storage, and loads it into the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with which the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) is associated, once, and then continuously. [Read more](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/startautoload/).
## `stopAutoLoad`
The [`stopAutoLoad`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/stopautoload/) method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/startautoload/) method. [Read more](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/load/stopautoload/).
