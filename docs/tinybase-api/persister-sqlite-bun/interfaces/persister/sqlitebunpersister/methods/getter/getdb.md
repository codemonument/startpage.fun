...
```
getDb[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/getter/getdb/)(): Database
```
...
console.log(persister.getDb[](https://tinybase.org/api/persister-sqlite-bun/interfaces/persister/sqlitebunpersister/methods/getter/getdb/)() == db);
// -> true
