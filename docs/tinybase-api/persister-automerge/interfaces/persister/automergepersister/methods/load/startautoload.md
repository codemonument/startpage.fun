      ...
      * [`persister-automerge`](https://tinybase.org/api/persister-automerge/)
        * [Interfaces](https://tinybase.org/api/persister-automerge/interfaces/)
          * [`AutomergePersister`](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/)
            * [Getter methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<AutomergePersister[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/)>
```
...
| returns  | `Promise<AutomergePersister[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
