...
# `getDocHandle`
The `getDocHandle` method returns the Automerge document handler the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getDocHandle[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/getter/getdochandle/)(): DocHandle<any>
```
  
| returns  | `DocHandle<any>`  | The Automerge document handler.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the Automerge document handler back out again.
...
console.log(persister.getDocHandle[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/getter/getdochandle/)() == docHandler);
// -> true
