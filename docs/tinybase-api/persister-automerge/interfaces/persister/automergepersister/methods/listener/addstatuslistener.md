...
```
addStatusListener[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<AutomergePersister[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/)>): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<AutomergePersister[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/)>`  | The function that will be called whenever the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) starts or stops loading or saving.  |  
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
await persister.load[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/load/load/)();
...
persister.delListener[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/dellistener/)(listenerId);
