...
```
delListener[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/dellistener/)(listenerId: string): this
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-automerge/interfaces/persister/automergepersister/methods/listener/addstatuslistener/)((_persister, status) => {
