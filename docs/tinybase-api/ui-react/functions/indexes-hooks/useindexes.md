...
# `useIndexes`
The `useIndexes` hook is used to get a reference to an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object from within a [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context.

```
useIndexes[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexes/)(id?: string): Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) | undefined
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `id?`  | `string`  | An optional [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for accessing an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object that was named with an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) in the Provider.  |  
| returns  | `Indexes[](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) | undefined`  | A reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object (or `undefined` if not within a Provider context, or if the requested [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object does not exist).  |  
A [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component is used to wrap part of an application in a context. It can contain a default [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object (or a set of [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/)) that can be easily accessed without having to be passed down as props through every component.
The `useIndexes` hook lets you either get a reference to the default [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object (when called without a parameter), or one of the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) objects that are named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) (when called with an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) parameter).
## Examples
This example creates a Provider context into which a default [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object is provided. A component within it then uses the `useIndexes` hook to get a reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object again, without the need to have it passed as a prop.
...
const Pane = () => <span>{useIndexes[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexes/)().getListenerStats[](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/)().sliceIds}</span>;

const indexes = createIndexes[](https://tinybase.org/api/indexes/functions/creation/createindexes/)(createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)());
...
This example creates a Provider context into which an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object is provided, named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). A component within it then uses the `useIndexes` hook with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to get a reference to the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object again, without the need to have it passed as a prop.
...
const App = ({indexes}) => (
  <Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/) indexesById={{petStore: indexes}}>
    <Pane />
  </Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/)>
);
const Pane = () => (
  <span>{useIndexes[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexes/)('petStore').getListenerStats[](https://tinybase.org/api/store/interfaces/store/store/methods/development/getlistenerstats/)().sliceIds}</span>
);
