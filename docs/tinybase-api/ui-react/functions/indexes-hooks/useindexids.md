...
# `useIndexIds`
The `useIndexIds` hook gets an array of the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) registered with an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, and registers a listener so that any changes to that result will cause a re-render.

```
useIndexIds[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexids/)(indexesOrIndexesId?: IndexesOrIndexesId[](https://tinybase.org/api/ui-react/type-aliases/identity/indexesorindexesid/)): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| returns  | `Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)`  | The [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, or an empty array.  |  
A [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component is used to wrap part of an application in a context, and it can contain a default [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object or a set of [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). The `useIndexIds` hook lets you indicate which [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object to get data for: omit the optional final parameter for the default context [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object, or provide an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object explicitly by reference.
When first rendered, this hook will create a listener so that changes to the [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object will cause a re-render. When the component containing this hook is unmounted, the listener will be automatically removed.
## Example
This example creates an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object outside the application, which is used in the `useIndexIds` hook by reference. A newly-registered [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/) re-renders the component.
...
const App = () => <span>{JSON.stringify(useIndexIds[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexids/)(indexes))}</span>;
