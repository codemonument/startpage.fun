...
# `useIndexesIds`
The `useIndexesIds` hook is used to retrieve the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of all the named [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) objects present in the current [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context.

```
useIndexesIds[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexesids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| --- | --- | --- |  
## Example
This example adds two named [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) objects to a Provider context and an inner component accesses their [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/).
...
const App = () => {
  ...
  const indexes1 = useCreateIndexes[](https://tinybase.org/api/ui-react/functions/indexes-hooks/usecreateindexes/)(store1, createIndexes);
  const store2 = useCreateStore[](https://tinybase.org/api/ui-react/functions/store-hooks/usecreatestore/)(createStore);
  const indexes2 = useCreateIndexes[](https://tinybase.org/api/ui-react/functions/indexes-hooks/usecreateindexes/)(store2, createIndexes);
  return (
    <Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/) indexesById={{indexes1, indexes2}}>
      <Pane />
    </Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/)>
  );
};
const Pane = () => <span>{JSON.stringify(useIndexesIds[](https://tinybase.org/api/ui-react/functions/indexes-hooks/useindexesids/)())}</span>;
