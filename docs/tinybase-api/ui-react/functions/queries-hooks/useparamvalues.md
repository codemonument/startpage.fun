...
): ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `queryId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the query to get parameter values for.  |  
...
| returns  | `ParamValues[](https://tinybase.org/api/queries/type-aliases/params/paramvalues/)`  | An object containing all parameter values for the query, or undefined if the query doesn't exist.  |  
A [`Provider`](https://tinybase.org/api/the-essentials/using-react/provider/) component is used to wrap part of an application in a context, and it can contain a default [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object or a set of [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). The `useParamValues` hook lets you indicate which [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object to get data for: omit the optional final parameter for the default context [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object, or provide a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object explicitly by reference.
...
## Examples
This example creates a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object outside the application, which is used in the `useParamValues` hook by reference. A change to the parameter values re-renders the component.
...
const App = () => (
  <span>{JSON.stringify(useParamValues[](https://tinybase.org/api/ui-react/functions/queries-hooks/useparamvalues/)('petsBySpecies', queries))}</span>
);
...
This example creates a Provider context into which a default [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object is provided. A component within it then uses the `useParamValues` hook.
...
const Pane = () => (
  <span>{JSON.stringify(useParamValues[](https://tinybase.org/api/ui-react/functions/queries-hooks/useparamvalues/)('petsBySpecies'))}</span>
);
...
This example creates a Provider context into which a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object is provided, named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). A component within it then uses the `useParamValues` hook.
...
const Pane = () => (
  <span>
    {JSON.stringify(useParamValues[](https://tinybase.org/api/ui-react/functions/queries-hooks/useparamvalues/)('petsBySpecies', 'petQueries'))}
  </span>
);
