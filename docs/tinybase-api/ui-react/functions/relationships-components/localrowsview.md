...
# `LocalRowsView`
The `LocalRowsView` component renders the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects for a given remote [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/), and registers a listener so that any changes to that result will cause a re-render.

```
LocalRowsView[](https://tinybase.org/api/ui-react/functions/relationships-components/localrowsview/)(props: LocalRowsProps[](https://tinybase.org/api/ui-react/type-aliases/props/localrowsprops/)): ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `props`  | `LocalRowsProps[](https://tinybase.org/api/ui-react/type-aliases/props/localrowsprops/)`  | The props for this component.  |  
...
## Examples
This example creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object outside the application, which is used in the `LocalRowsView` component by reference. A change to the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) re-renders the component.
...
This example creates a Provider context into which a default [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object is provided. The `LocalRowsView` component within it then renders the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects (with [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) for readability).
