...
# Metrics hooks
## `useCreateMetrics`
The [`useCreateMetrics`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usecreatemetrics/) hook is used to create a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object within a React application with convenient memoization. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usecreatemetrics/).
## `useMetric`
The [`useMetric`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetric/) hook gets the current value of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetric/).
## `useMetricIds`
The [`useMetricIds`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricids/) hook gets an array of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) registered with a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricids/).
## `useMetricListener`
The [`useMetricListener`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetriclistener/) hook registers a listener function with the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object that will be called whenever the value of a specified [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) changes. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetriclistener/).
## `useMetrics`
The [`useMetrics`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetrics/) hook is used to get a reference to a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object from within a [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetrics/).
## `useMetricsIds`
The [`useMetricsIds`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricsids/) hook is used to retrieve the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of all the named [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) objects present in the current [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricsids/).
## `useMetricsOrMetricsById`
The [`useMetricsOrMetricsById`](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricsormetricsbyid/) hook is used to get a reference to a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object from within a [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context, _or_ have it passed directly to this hook. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/usemetricsormetricsbyid/).
## `useProvideMetrics`
The [`useProvideMetrics`](https://tinybase.org/api/ui-react/functions/metrics-hooks/useprovidemetrics/) hook is used to add a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to a [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component, but imperatively from a component within it. [Read more](https://tinybase.org/api/ui-react/functions/metrics-hooks/useprovidemetrics/).
