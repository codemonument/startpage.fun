...
## `Provider`
Essential
The [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component is used to wrap part of an application in a context that provides default objects to be used by hooks and components within. [Read more](https://tinybase.org/api/ui-react/functions/context-components/provider/).
