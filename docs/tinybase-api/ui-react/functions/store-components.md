...
# Store components
## `TablesView`
The [`TablesView`](https://tinybase.org/api/ui-react/functions/store-components/tablesview/) component renders the tabular contents of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/tablesview/).
## `TableView`
The [`TableView`](https://tinybase.org/api/ui-react/functions/store-components/tableview/) component renders the contents of a single [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/tableview/).
## `SortedTableView`
The [`SortedTableView`](https://tinybase.org/api/ui-react/functions/store-components/sortedtableview/) component renders the contents of a single sorted [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/sortedtableview/).
## `RowView`
The [`RowView`](https://tinybase.org/api/ui-react/functions/store-components/rowview/) component renders the contents of a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a given [`Table`](https://tinybase.org/api/store/type-aliases/store/table/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/rowview/).
## `CellView`
The [`CellView`](https://tinybase.org/api/ui-react/functions/store-components/cellview/) component renders the value of a single [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a given [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), in a given [`Table`](https://tinybase.org/api/store/type-aliases/store/table/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/cellview/).
## `ValuesView`
The [`ValuesView`](https://tinybase.org/api/ui-react/functions/store-components/valuesview/) component renders the keyed value contents of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/valuesview/).
## `ValueView`
The [`ValueView`](https://tinybase.org/api/ui-react/functions/store-components/valueview/) component renders the value of a single [`Value`](https://tinybase.org/api/store/type-aliases/store/value/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/store-components/valueview/).
