...
The `useSetCheckpointCallback` hook returns a parameterized callback that can be used to record a checkpoint of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) into a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object that can be reverted to in the future.

```
useSetCheckpointCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usesetcheckpointcallback/)<Parameter>(
  ...
  then?: (checkpointId: string, checkpoints: Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/), label?: string) => void,
...
| `getCheckpointDeps?`  | `DependencyList`  | An optional array of dependencies for the `getCheckpoint` function, which, if any change, result in the regeneration of the callback. This parameter defaults to an empty array.  |  
| `checkpointsOrCheckpointsId?`  | `CheckpointsOrCheckpointsId[](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/)`  | The [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object to be updated: omit for the default context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, or provide an explicit reference.  |  
| `then?`  | `(checkpointId: string, checkpoints: Checkpoints[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/), label?: string) => void`  | A function which is called after the checkpoint is set, with the new checkpoint [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), a reference to the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object and the label provided, if any.  |  
...
The [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object for which the callback will set the checkpoint (indicated by the hook's `checkpointsOrCheckpointsId` parameter) is always automatically used as a hook dependency for the callback.
## Example
...
const App = () => {
  const handleClick = useSetCheckpointCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usesetcheckpointcallback/)(
