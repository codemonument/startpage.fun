...
The `useGoBackwardCallback` hook returns a callback that moves the state of the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) back to the previous checkpoint, effectively performing an 'undo' on the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data.

```
useGoBackwardCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usegobackwardcallback/)(checkpointsOrCheckpointsId?: CheckpointsOrCheckpointsId[](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/)): Callback[](https://tinybase.org/api/common/type-aliases/callback/callback/)
```
...
const App = () => (
  <span id="span" onClick={useGoBackwardCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usegobackwardcallback/)(checkpoints)}>
    Backward
  </span>
);
