...
The `useGoForwardCallback` hook returns a callback that moves the state of the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) forwards to a future checkpoint, effectively performing an 'redo' on the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data.

```
useGoForwardCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usegoforwardcallback/)(checkpointsOrCheckpointsId?: CheckpointsOrCheckpointsId[](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/)): Callback[](https://tinybase.org/api/common/type-aliases/callback/callback/)
```
...
const App = () => (
  <span id="span" onClick={useGoForwardCallback[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usegoforwardcallback/)(checkpoints)}>
    Forward
  </span>
);
