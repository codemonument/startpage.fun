...
# `useCheckpointsIds`
The `useCheckpointsIds` hook is used to retrieve the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of all the named [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) objects present in the current [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context.

```
useCheckpointsIds[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usecheckpointsids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| --- | --- | --- |  
## Example
This example adds two named [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) objects to a Provider context and an inner component accesses their [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/).
...
const App = () => {
  ...
  const checkpoints1 = useCreateCheckpoints[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usecreatecheckpoints/)(store1, createCheckpoints);
  const store2 = useCreateStore[](https://tinybase.org/api/ui-react/functions/store-hooks/usecreatestore/)(createStore);
  const checkpoints2 = useCreateCheckpoints[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usecreatecheckpoints/)(store2, createCheckpoints);
  return (
    <Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/) checkpointsById={{checkpoints1, checkpoints2}}>
      <Pane />
    </Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/)>
  );
};
const Pane = () => <span>{JSON.stringify(useCheckpointsIds[](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usecheckpointsids/)())}</span>;
