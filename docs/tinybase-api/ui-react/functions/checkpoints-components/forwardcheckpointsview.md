...
The `ForwardCheckpointsView` component renders a list of future checkpoints that the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) can go forwards to.

```
ForwardCheckpointsView[](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/)(props: ForwardCheckpointsProps[](https://tinybase.org/api/ui-react/type-aliases/props/forwardcheckpointsprops/)): ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `props`  | `ForwardCheckpointsProps[](https://tinybase.org/api/ui-react/type-aliases/props/forwardcheckpointsprops/)`  | The props for this component.  |  
| returns  | `ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)`  | A rendering of the future checkpoints, if present.  |  
The component's props identify which future checkpoints to render based on the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object (which is either the default context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, a named context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, or an explicit reference).
...
## Examples
This example creates a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object outside the application, which is used in the `ForwardCheckpointsView` component by reference to render a list of future checkpoints.
...
const App = () => (
  <div>
    <ForwardCheckpointsView[](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/) checkpoints={checkpoints} separator="/" />
  </div>
);
...
This example creates a Provider context into which a default [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object is provided. The `ForwardCheckpointsView` component within it then renders the list of future checkpoints (with [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) for readability).
...
const Pane = () => (
  <div>
    <ForwardCheckpointsView[](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/) debugIds={true} />
  </div>
);
...
This example creates a Provider context into which a default [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object is provided. The `ForwardCheckpointsView` component within it then renders the list of future checkpoints with a custom [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) component and a custom props callback.
