...
```
CheckpointView[](https://tinybase.org/api/ui-react/functions/checkpoints-components/checkpointview/)(props: CheckpointProps[](https://tinybase.org/api/ui-react/type-aliases/props/checkpointprops/)): ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `props`  | `CheckpointProps[](https://tinybase.org/api/ui-react/type-aliases/props/checkpointprops/)`  | The props for this component.  |  
| returns  | `ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)`  | A rendering of the checkpoint: its label if present, or [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/).  |  
The component's props identify which checkpoint to render based on Checkpoint [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object (which is either the default context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, a named context [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, or an explicit reference).
The primary purpose of this component is to render multiple checkpoints in a [`BackwardCheckpointsView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/backwardcheckpointsview/) component or [`ForwardCheckpointsView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/) component.
This component uses the [`useCheckpoint`](https://tinybase.org/api/ui-react/functions/checkpoints-hooks/usecheckpoint/) hook under the covers, which means that any changes to the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) will cause a re-render.
## Example
This example creates a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object outside the application, which is used in the `CheckpointView` component by reference to render a checkpoint with a label (with its [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for readability).
