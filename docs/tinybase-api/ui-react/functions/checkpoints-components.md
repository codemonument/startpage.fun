...
The [`BackwardCheckpointsView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/backwardcheckpointsview/) component renders a list of previous checkpoints that the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) can go back to. [Read more](https://tinybase.org/api/ui-react/functions/checkpoints-components/backwardcheckpointsview/).
## `CheckpointView`
The [`CheckpointView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/checkpointview/) component simply renders the label of a checkpoint. [Read more](https://tinybase.org/api/ui-react/functions/checkpoints-components/checkpointview/).
## `CurrentCheckpointView`
The [`CurrentCheckpointView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/currentcheckpointview/) component renders the current checkpoint that the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is currently on. [Read more](https://tinybase.org/api/ui-react/functions/checkpoints-components/currentcheckpointview/).
## `ForwardCheckpointsView`
The [`ForwardCheckpointsView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/) component renders a list of future checkpoints that the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) can go forwards to. [Read more](https://tinybase.org/api/ui-react/functions/checkpoints-components/forwardcheckpointsview/).
