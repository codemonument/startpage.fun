...
The `useRelationshipsOrRelationshipsById` hook is used to get a reference to a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object from within a [`Provider`](https://tinybase.org/api/the-essentials/using-react/provider/) component context, _or_ have it passed directly to this hook.

```
useRelationshipsOrRelationshipsById[](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationshipsorrelationshipsbyid/)(relationshipsOrRelationshipsId?: RelationshipsOrRelationshipsId[](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/)): Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) | undefined
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipsOrRelationshipsId?`  | `RelationshipsOrRelationshipsId[](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/)`  | Either an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for accessing a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object that was named with an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) in the Provider, or the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object itself.  |  
| returns  | `Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) | undefined`  | A reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object (or `undefined` if not within a Provider context, or if the requested [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object does not exist).  |  
This is mostly of use when you are developing a component that needs a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object and which might have been passed in explicitly to the component or is to be picked up from the context by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) (a common pattern for [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)-based components).
This is unlikely to be used often. For most situations, you will want to use the [`useRelationships`](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationships/) hook.
## Example
This example creates a Provider context into which a default [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object is provided. A component within it then uses the `useRelationshipsOrRelationshipsById` hook to get a reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object again, without the need to have it passed as a prop. Note however, that unlike the [`useRelationships`](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationships/) hook example, this component would also work if you were to pass the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object directly into it, making it more portable.
