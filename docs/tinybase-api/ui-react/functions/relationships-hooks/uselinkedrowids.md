...
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).  |  
| `firstRowId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the first [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in the linked list [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).  |  
| `relationshipsOrRelationshipsId?`  | `RelationshipsOrRelationshipsId[](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/)`  | The [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object to be accessed: omit for the default context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, or provide an explicit reference.  |  
| returns  | `Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)`  | The linked [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).  |  
A [`Provider`](https://tinybase.org/api/the-essentials/using-react/provider/) component is used to wrap part of an application in a context, and it can contain a default [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object or a set of [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). The `useLinkedRowIds` hook lets you indicate which [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object to get data for: omit the optional final parameter for the default context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, or provide a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object explicitly by reference.
When first rendered, this hook will create a listener so that changes to the linked [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) will cause a re-render. When the component containing this hook is unmounted, the listener will be automatically removed.
## Examples
This example creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object outside the application, which is used in the `useLinkedRowIds` hook by reference. A change to the linked [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) re-renders the component.
...
const App = () => (
  <span>
    {JSON.stringify(useLinkedRowIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/uselinkedrowids/)('petSequence', 'fido', relationships))}
  </span>
);
...
store.setCell[](https://tinybase.org/api/the-essentials/setting-data/setcell/)('pets', 'cujo', 'next', 'toto');
console.log(app.innerHTML);
// -> '<span>["fido","felix","cujo","toto"]</span>'

```

This example creates a Provider context into which a default [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object is provided. A component within it then uses the `useLinkedRowIds` hook.
...
const Pane = () => (
  <span>{JSON.stringify(useLinkedRowIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/uselinkedrowids/)('petSequence', 'fido'))}</span>
);

const relationships = createRelationships[](https://tinybase.org/api/relationships/functions/creation/createrelationships/)(
...
).setRelationshipDefinition[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/configuration/setrelationshipdefinition/)('petSequence', 'pets', 'pets', 'next');
...
const App = ({relationships}) => (
  <Provider[](https://tinybase.org/api/the-essentials/using-react/provider/) relationshipsById={{petRelationships: relationships}}>
    <Pane />
  </Provider[](https://tinybase.org/api/the-essentials/using-react/provider/)>
);
const Pane = () => (
  <span>
    {JSON.stringify(
      useLinkedRowIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/uselinkedrowids/)('petSequence', 'fido', 'petRelationships'),
    )}
  </span>
);
