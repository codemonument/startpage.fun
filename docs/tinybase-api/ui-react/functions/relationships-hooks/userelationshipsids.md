...
# `useRelationshipsIds`
The `useRelationshipsIds` hook is used to retrieve the [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) of all the named [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) objects present in the current [`Provider`](https://tinybase.org/api/the-essentials/using-react/provider/) component context.

```
useRelationshipsIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationshipsids/)(): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| --- | --- | --- |  
## Example
This example adds two named [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) objects to a Provider context and an inner component accesses their [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/).
...
const App = () => {
  ...
  const relationships1 = useCreateRelationships[](https://tinybase.org/api/ui-react/functions/relationships-hooks/usecreaterelationships/)(
    store1,
    createRelationships,
  );
  const store2 = useCreateStore[](https://tinybase.org/api/ui-react/functions/store-hooks/usecreatestore/)(createStore);
  const relationships2 = useCreateRelationships[](https://tinybase.org/api/ui-react/functions/relationships-hooks/usecreaterelationships/)(
    store2,
    createRelationships,
  );
  return (
    <Provider[](https://tinybase.org/api/the-essentials/using-react/provider/) relationshipsById={{relationships1, relationships2}}>
      <Pane />
    </Provider[](https://tinybase.org/api/the-essentials/using-react/provider/)>
  );
};
const Pane = () => <span>{JSON.stringify(useRelationshipsIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationshipsids/)())}</span>;
