...
# `useRelationshipIds`
The `useRelationshipIds` hook gets an array of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) registered with a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and registers a listener so that any changes to that result will cause a re-render.

```
useRelationshipIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationshipids/)(relationshipsOrRelationshipsId?: RelationshipsOrRelationshipsId[](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/)): Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)
```
...
| returns  | `Ids[](https://tinybase.org/api/common/type-aliases/identity/ids/)`  | The [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, or an empty array.  |  
A [`Provider`](https://tinybase.org/api/the-essentials/using-react/provider/) component is used to wrap part of an application in a context, and it can contain a default [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object or a set of [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). The `useRelationshipIds` hook lets you indicate which [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object to get data for: omit the optional final parameter for the default context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, or provide a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object explicitly by reference.
When first rendered, this hook will create a listener so that changes to the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) in the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object will cause a re-render. When the component containing this hook is unmounted, the listener will be automatically removed.
## Example
This example creates an [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object outside the application, which is used in the `useRelationshipIds` hook by reference. A newly-registered [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) re-renders the component.
...
const App = () => (
  <span>{JSON.stringify(useRelationshipIds[](https://tinybase.org/api/ui-react/functions/relationships-hooks/userelationshipids/)(relationships))}</span>
);
