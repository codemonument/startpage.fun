...
# `usePersister`
The `usePersister` hook is used to get a reference to a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object from within a [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component context.

```
usePersister[](https://tinybase.org/api/ui-react/functions/persister-hooks/usepersister/)(id?: string): AnyPersister[](https://tinybase.org/api/persisters/type-aliases/mergeable/anypersister/) | undefined
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `id?`  | `string`  | An optional [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for accessing a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object that was named with an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) in the Provider.  |  
| returns  | `AnyPersister[](https://tinybase.org/api/persisters/type-aliases/mergeable/anypersister/) | undefined`  | A reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object (or `undefined` if not within a Provider context, or if the requested [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object does not exist).  |  
A [`Provider`](https://tinybase.org/api/ui-react/functions/context-components/provider/) component is used to wrap part of an application in a context. It can contain a default [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object (or a set of [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) objects named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/)) that can be easily accessed without having to be passed down as props through every component.
The `usePersister` hook lets you either get a reference to the default [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object (when called without a parameter), or one of the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) objects that are named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) (when called with an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) parameter).
## Examples
This example creates a Provider context into which a default [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object is provided. A component within it then uses the `usePersister` hook to get a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object again, without the need to have it passed as a prop.
...
const App = ({persister}) => (
  <Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/) persister={persister}>
    <Pane />
  </Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/)>
);
const Pane = () => <span>{usePersister[](https://tinybase.org/api/ui-react/functions/persister-hooks/usepersister/)().getStatus[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/getstatus/)()}</span>;
...
This example creates a Provider context into which a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object is provided, named by [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). A component within it then uses the `usePersister` hook with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) to get a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object again, without the need to have it passed as a prop.
...
const App = ({persister}) => (
  <Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/) persistersById={{petPersister: persister}}>
    <Pane />
  </Provider[](https://tinybase.org/api/ui-react/functions/context-components/provider/)>
);
const Pane = () => <span>{usePersister[](https://tinybase.org/api/ui-react/functions/persister-hooks/usepersister/)('petPersister').getStatus[](https://tinybase.org/api/persisters/interfaces/persister/persister/methods/lifecycle/getstatus/)()}</span>;
