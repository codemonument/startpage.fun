...
# Indexes components
## `IndexView`
The [`IndexView`](https://tinybase.org/api/ui-react/functions/indexes-components/indexview/) component renders the contents of a [`Index`](https://tinybase.org/api/indexes/type-aliases/concept/index/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/indexes-components/indexview/).
## `SliceView`
The [`SliceView`](https://tinybase.org/api/ui-react/functions/indexes-components/sliceview/) component renders the contents of a [`Slice`](https://tinybase.org/api/indexes/type-aliases/concept/slice/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/indexes-components/sliceview/).
