...
# Metrics components
## `MetricView`
The [`MetricView`](https://tinybase.org/api/ui-react/functions/metrics-components/metricview/) component renders the current value of a [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/), and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-react/functions/metrics-components/metricview/).
