...
## `ComponentReturnType`
[`ComponentReturnType`](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/) is a simple alias for what a React component can return: either a ReactElement, or `null` for an empty component. [Read more](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/).
