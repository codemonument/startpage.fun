...
# `MetricProps`
`MetricProps` props are used for components that refer to a single [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, such as the [`MetricView`](https://tinybase.org/api/ui-react/functions/metrics-components/metricview/) component.

```
{
  metricId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/);
  metrics?: MetricsOrMetricsId[](https://tinybase.org/api/ui-react/type-aliases/identity/metricsormetricsid/);
  debugIds?: boolean;
}
```
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `metricId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) in the [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object to be rendered.  |  
| `metrics?`  | `MetricsOrMetricsId[](https://tinybase.org/api/ui-react/type-aliases/identity/metricsormetricsid/)`  | The [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object to be accessed: omit for the default context [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, provide an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) for a named context [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object, or provide an explicit reference.  |  
| `debugIds?`  | `boolean`  | Whether the component should also render the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Metric`](https://tinybase.org/api/metrics/type-aliases/metric/metric/) to assist with debugging.  |  
## Since
v1.0.0
