...
# `CheckpointProps`
`CheckpointProps` props are used for components that refer to a single checkpoint in a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object, such as the [`CheckpointView`](https://tinybase.org/api/ui-react/functions/checkpoints-components/checkpointview/) component.

```
{
  checkpointId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/);
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `checkpointId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint in the [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object.  |  
...
| `debugIds?`  | `boolean`  | Whether the component should also render the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the checkpoint to assist with debugging.  |  
## Since
v1.0.0
