...
# `ValueProps`
`ValueProps` props are used for components that refer to a single [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), such as the [`ValueView`](https://tinybase.org/api/ui-react/functions/store-components/valueview/) component.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `valueId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) to be rendered.  |  
...
| `debugIds?`  | `boolean`  | Whether the component should also render the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) to assist with debugging.  |  
## Since
v3.0.0
