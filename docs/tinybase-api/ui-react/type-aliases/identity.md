      ...
      * [`ui-react`](https://tinybase.org/api/ui-react/)
        ...
        * [Type Aliases](https://tinybase.org/api/ui-react/type-aliases/)
          ...
          * [Identity type aliases](https://tinybase.org/api/ui-react/type-aliases/identity/)
            * [`StoreOrStoreId`](https://tinybase.org/api/ui-react/type-aliases/identity/storeorstoreid/)
            * [`CheckpointsOrCheckpointsId`](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/)
            * [`GetId`](https://tinybase.org/api/ui-react/type-aliases/identity/getid/)
            * [`IndexesOrIndexesId`](https://tinybase.org/api/ui-react/type-aliases/identity/indexesorindexesid/)
            * [`MetricsOrMetricsId`](https://tinybase.org/api/ui-react/type-aliases/identity/metricsormetricsid/)
            * [`PersisterOrPersisterId`](https://tinybase.org/api/ui-react/type-aliases/identity/persisterorpersisterid/)
            * [`QueriesOrQueriesId`](https://tinybase.org/api/ui-react/type-aliases/identity/queriesorqueriesid/)
            * [`RelationshipsOrRelationshipsId`](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/)
            * [`SynchronizerOrSynchronizerId`](https://tinybase.org/api/ui-react/type-aliases/identity/synchronizerorsynchronizerid/)
...
## `StoreOrStoreId`
The [`StoreOrStoreId`](https://tinybase.org/api/ui-react/type-aliases/identity/storeorstoreid/) type is used when you need to refer to a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/storeorstoreid/).
## `CheckpointsOrCheckpointsId`
The [`CheckpointsOrCheckpointsId`](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/) type is used when you need to refer to a [`Checkpoints`](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/checkpointsorcheckpointsid/).
## `GetId`
The [`GetId`](https://tinybase.org/api/ui-react/type-aliases/identity/getid/) type describes a function which, when passed a parameter, will return an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/). [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/getid/).
## `IndexesOrIndexesId`
The [`IndexesOrIndexesId`](https://tinybase.org/api/ui-react/type-aliases/identity/indexesorindexesid/) type is used when you need to refer to an [`Indexes`](https://tinybase.org/api/indexes/interfaces/indexes/indexes/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/indexesorindexesid/).
## `MetricsOrMetricsId`
The [`MetricsOrMetricsId`](https://tinybase.org/api/ui-react/type-aliases/identity/metricsormetricsid/) type is used when you need to refer to a [`Metrics`](https://tinybase.org/api/metrics/interfaces/metrics/metrics/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/metricsormetricsid/).
## `PersisterOrPersisterId`
The [`PersisterOrPersisterId`](https://tinybase.org/api/ui-react/type-aliases/identity/persisterorpersisterid/) type is used when you need to refer to a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/persisterorpersisterid/).
## `QueriesOrQueriesId`
The [`QueriesOrQueriesId`](https://tinybase.org/api/ui-react/type-aliases/identity/queriesorqueriesid/) type is used when you need to refer to a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/queriesorqueriesid/).
## `RelationshipsOrRelationshipsId`
The [`RelationshipsOrRelationshipsId`](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/) type is used when you need to refer to a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/relationshipsorrelationshipsid/).
## `SynchronizerOrSynchronizerId`
The [`SynchronizerOrSynchronizerId`](https://tinybase.org/api/ui-react/type-aliases/identity/synchronizerorsynchronizerid/) type is used when you need to refer to a [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) object in a React hook or component. [Read more](https://tinybase.org/api/ui-react/type-aliases/identity/synchronizerorsynchronizerid/).
