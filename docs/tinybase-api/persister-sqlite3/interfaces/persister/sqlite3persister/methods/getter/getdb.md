...
```
getDb[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/getter/getdb/)(): Database
```
...
console.log(persister.getDb[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/getter/getdb/)() == db);
// -> true
