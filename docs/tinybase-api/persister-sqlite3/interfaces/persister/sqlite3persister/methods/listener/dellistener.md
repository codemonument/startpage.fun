...
```
delListener[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/listener/dellistener/)(listenerId: string): this
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/listener/addstatuslistener/)((_persister, status) => {
...
persister.delListener[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/listener/dellistener/)(listenerId);
