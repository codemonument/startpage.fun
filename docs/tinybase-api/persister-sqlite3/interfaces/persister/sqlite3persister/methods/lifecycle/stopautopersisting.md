...
```
stopAutoPersisting[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/lifecycle/stopautopersisting/)(stopSaveFirst?: boolean): Promise<Sqlite3Persister[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/)>
```
...
This simply runs the stopAutoLoad and [`stopAutoSave`](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/save/stopautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
...
await persister.stopAutoPersisting[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/lifecycle/stopautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/save/isautosaving/)());
// -> false
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/methods/load/isautoloading/)());
// -> false
