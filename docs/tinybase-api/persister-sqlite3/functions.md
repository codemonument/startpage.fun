...
The [`createSqlite3Persister`](https://tinybase.org/api/persister-sqlite3/functions/creation/createsqlite3persister/) function creates a [`Sqlite3Persister`](https://tinybase.org/api/persister-sqlite3/interfaces/persister/sqlite3persister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local SQLite database. [Read more](https://tinybase.org/api/persister-sqlite3/functions/creation/createsqlite3persister/).
