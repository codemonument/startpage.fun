...
# Interfaces
## `PglitePersister`
The [`PglitePersister`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/) interface represents a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that lets you save and load [`Store`](https://tinybase.org/api/store/interfaces/store/store/) data to and from a local PGlite database. [Read more](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/).
