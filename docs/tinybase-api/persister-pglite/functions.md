...
Essential
The [`createPglitePersister`](https://tinybase.org/api/persister-pglite/functions/creation/createpglitepersister/) function creates a [`PglitePersister`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local PGlite database. [Read more](https://tinybase.org/api/persister-pglite/functions/creation/createpglitepersister/).
