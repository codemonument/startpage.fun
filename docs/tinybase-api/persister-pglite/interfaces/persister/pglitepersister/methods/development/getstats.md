...
```
getStats[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/development/getstats/)(): PersisterStats[](https://tinybase.org/api/persisters/type-aliases/development/persisterstats/)
```
...
console.log(persister.getStats[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/development/getstats/)());
// -> {loads: 2, saves: 2}
