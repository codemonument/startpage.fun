...
```
addStatusListener[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>): string
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
persister.delListener[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/listener/dellistener/)(listenerId);
