...
```
stopAutoPersisting[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/lifecycle/stopautopersisting/)(stopSaveFirst?: boolean): Promise<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>
```
...
This simply runs the stopAutoLoad and [`stopAutoSave`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/save/stopautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
...
await persister.startAutoPersisting[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/lifecycle/startautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/save/isautosaving/)());
// -> true
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/isautoloading/)());
// -> true

await persister.stopAutoPersisting[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/lifecycle/stopautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/save/isautosaving/)());
// -> false
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/isautoloading/)());
// -> false

persister.destroy[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/lifecycle/destroy/)();
