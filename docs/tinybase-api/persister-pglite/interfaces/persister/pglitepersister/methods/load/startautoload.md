      ...
      * [`persister-pglite`](https://tinybase.org/api/persister-pglite/)
        * [Interfaces](https://tinybase.org/api/persister-pglite/interfaces/)
          * [`PglitePersister`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)
            * [Getter methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>
```
...
| returns  | `Promise<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
