...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/stopautoload/)(): Promise<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/load/stopautoload/)();
