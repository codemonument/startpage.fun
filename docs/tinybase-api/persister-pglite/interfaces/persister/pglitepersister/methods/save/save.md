...
```
save[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/methods/save/save/)(): Promise<PglitePersister[](https://tinybase.org/api/persister-pglite/interfaces/persister/pglitepersister/)>
```
