...
```
schedule[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/methods/lifecycle/schedule/)(actions: (() => Promise<any>)[]): Promise<PowerSyncPersister[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/)>
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `actions`  | `(() => Promise<any>)[]`  | One or many functions which will be scheduled, and which can be asynchronous.  |  
| returns  | `Promise<PowerSyncPersister[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/)>`  | A reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
const persister = createCustomPersister[](https://tinybase.org/api/persisters/functions/creation/createcustompersister/)(
  ...
  async (getContent) => {
    // setPersisted
    await persister.schedule[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/methods/lifecycle/schedule/)(
      () => checkRemoteSystemIsReady(),
