...
```
getStore[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/methods/getter/getstore/)(): Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)
```
...
persister.getStore[](https://tinybase.org/api/persister-powersync/interfaces/persister/powersyncpersister/methods/getter/getstore/)().setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {species: 'dog'}}});
// ...
