...
# `persister-file`
The `persister-file` module of the TinyBase project lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a local file system (in an appropriate environment).
## See also
