      ...
      * [`ui-svelte-dom`](https://tinybase.org/api/ui-svelte-dom/)
        * [Functions](https://tinybase.org/api/ui-svelte-dom/functions/)
          ...
          * [Queries components](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/)
            * [`ResultSortedTableInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resultsortedtableinhtmltable/)
            * [`ResultTableInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resulttableinhtmltable/)
...
# Queries components
[![ResultSortedTableInHtmlTable example](https://tinybase.org/shots/resultsortedtableinhtmltable-svelte-demo.png)](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resultsortedtableinhtmltable/)
## `ResultSortedTableInHtmlTable`
The [`SortedTableInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/store-components/sortedtableinhtmltable/) component renders the contents of a single query's sorted [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resultsortedtableinhtmltable/).
[![ResultTableInHtmlTable example](https://tinybase.org/shots/resulttableinhtmltable-svelte-demo.png)](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resulttableinhtmltable/)
## `ResultTableInHtmlTable`
The [`ResultTableInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resulttableinhtmltable/) component renders the contents of a single query's [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) in a [`Queries`](https://tinybase.org/api/queries/interfaces/queries/queries/) object as an HTML <table> element, and registers a listener so that any changes to that result will cause a re-render. [Read more](https://tinybase.org/api/ui-svelte-dom/functions/queries-components/resulttableinhtmltable/).
