...
SortedTablePaginator[](https://tinybase.org/api/ui-svelte-dom/functions/store-components/sortedtablepaginator/)(
  this: void,
  props: SortedTablePaginatorProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sortedtablepaginatorprops/),
): {
  $on?: (type: string, callback: (e: any) => void): () => void;
  $set?: (props: Partial<SortedTablePaginatorProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sortedtablepaginatorprops/)>): void;
}
```
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `SortedTablePaginatorProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sortedtablepaginatorprops/)`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<SortedTablePaginatorProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sortedtablepaginatorprops/)>): void; }`  |   |  
...
The component displays 'previous' and 'next' buttons for paging through the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) if there are more [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) than fit in each page. The component will also display a label that shows which [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Ids`](https://tinybase.org/api/common/type-aliases/identity/ids/) are being displayed.
The component's props identify initial pagination settings, and it will fire an event when the pagination changes.
## Example
This example creates a Provider context into which a default [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is provided. The [`SortedTableInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/store-components/sortedtableinhtmltable/) component within it then renders the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a <table> element with a SortedTablePaginator (the default).
App.svelte
