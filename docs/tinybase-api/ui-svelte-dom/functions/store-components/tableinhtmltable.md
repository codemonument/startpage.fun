...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `( TableInHtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/tableinhtmltableprops/) & HtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/htmltableprops/) )`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<( TableInHtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/tableinhtmltableprops/) & HtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/htmltableprops/) )>): void; }`  |   |  
See the [<TableInHtmlTable /> (Svelte)](https://tinybase.org/demos/ui-components-svelte/tableinhtmltable-svelte/) demo for this component in action:
