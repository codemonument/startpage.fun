      ...
      * [`ui-svelte-dom`](https://tinybase.org/api/ui-svelte-dom/)
        * [Functions](https://tinybase.org/api/ui-svelte-dom/functions/)
          ...
          * [Other components](https://tinybase.org/api/ui-svelte-dom/functions/other-components/)
            * [`RelationshipInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/other-components/relationshipinhtmltable/)
            * [`SliceInHtmlTable`](https://tinybase.org/api/ui-svelte-dom/functions/other-components/sliceinhtmltable/)
...
| --- | --- | --- |  
| `this`  | `void`  |   |  
| `props`  | `( SliceInHtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sliceinhtmltableprops/) & HtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/htmltableprops/) )`  | The props passed to the component.  |  
| returns  | `{ $on?: (type: string, callback: (e: any) => void): () => void; $set?: (props: Partial<( SliceInHtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/sliceinhtmltableprops/) & HtmlTableProps[](https://tinybase.org/api/ui-svelte-dom/type-aliases/props/htmltableprops/) )>): void; }`  |   |  
See the [<SliceInHtmlTable /> (Svelte)](https://tinybase.org/demos/ui-components-svelte/sliceinhtmltable-svelte/) demo for this component in action:
