...
{
  label?: string;
  component?: Component<ResultCellViewProps[](https://tinybase.org/api/ui-svelte/type-aliases/props/resultcellviewprops/)>;
  getComponentProps?: (rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/), cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)) => {[prop: string]: any};
}
```
