      ...
      * [`ui-svelte-dom`](https://tinybase.org/api/ui-svelte-dom/)
        ...
        * [Type Aliases](https://tinybase.org/api/ui-svelte-dom/type-aliases/)
          * [Configuration type aliases](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/)
            * [`ExtraRowCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extrarowcell/)
            * [`CustomCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customcell/)
            * [`CustomResultCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customresultcell/)
            * [`ExtraValueCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extravaluecell/)
...
## `ExtraRowCell`
The [`ExtraRowCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extrarowcell/) object is used to configure the rendering of extra cells in an HTML table that's displaying a [`ResultTable`](https://tinybase.org/api/queries/type-aliases/result/resulttable/) or [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) - before or after the regular data cells. [Read more](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extrarowcell/).
## `CustomCell`
The [`CustomCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customcell/) object is used to configure custom cell rendering in an HTML table. [Read more](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customcell/).
## `CustomResultCell`
The [`CustomResultCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customresultcell/) object is used to configure custom cell rendering for query results in an HTML table. [Read more](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/customresultcell/).
## `ExtraValueCell`
The [`ExtraValueCell`](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extravaluecell/) object is used to configure the rendering of extra cells in an HTML table that's displaying [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) - before or after the regular data cells. [Read more](https://tinybase.org/api/ui-svelte-dom/type-aliases/configuration/extravaluecell/).
