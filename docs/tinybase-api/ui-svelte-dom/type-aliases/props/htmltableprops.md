...
| `headerRow?`  | `boolean`  | Whether a header row should be rendered at the top of the table, defaulting to `true`.  |  
| `idColumn?`  | `boolean`  | Whether an [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) column should be rendered on the left of the table, defaulting to `true`.  |  
## Since
v4.1.0
