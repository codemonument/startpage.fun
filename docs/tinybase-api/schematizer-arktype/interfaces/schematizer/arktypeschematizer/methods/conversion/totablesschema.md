  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-arktype`](https://tinybase.org/api/schematizer-arktype/)
        * [Interfaces](https://tinybase.org/api/schematizer-arktype/interfaces/)
          * [`ArkTypeSchematizer`](https://tinybase.org/api/schematizer-arktype/interfaces/schematizer/arktypeschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-arktype/interfaces/schematizer/arktypeschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-arktype/interfaces/schematizer/arktypeschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-arktype/functions/)
...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of ArkType object schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizer-arktype/interfaces/schematizer/arktypeschematizer/methods/conversion/totablesschema/)(schemas: {[tableId: string]: any}): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
...
const schematizer = createArkTypeSchematizer[](https://tinybase.org/api/schematizer-arktype/functions/creation/createarktypeschematizer/)();

const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-arktype/interfaces/schematizer/arktypeschematizer/methods/conversion/totablesschema/)({
  pets: type({
    species: 'string',
    age: 'number',
