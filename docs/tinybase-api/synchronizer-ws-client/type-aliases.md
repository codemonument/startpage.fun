...
# Type Aliases
## `WebSocketTypes`
The [`WebSocketTypes`](https://tinybase.org/api/synchronizer-ws-client/type-aliases/creation/websockettypes/) type represents the valid types of WebSocket that can be used with the [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/). [Read more](https://tinybase.org/api/synchronizer-ws-client/type-aliases/creation/websockettypes/).
