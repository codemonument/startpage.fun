...
| returns  | `Promise<WsSynchronizer[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/)<WebSocketType>>`  | A Promise containing a reference to the [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) object.  |  
...
await synchronizer1.startSync[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/synchronization/startsync/)();
await synchronizer2.startSync[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/synchronization/startsync/)();
...
await synchronizer1.destroy[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/lifecycle/destroy/)();
await synchronizer2.destroy[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/lifecycle/destroy/)();
...
await synchronizer1.startSync[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/synchronization/startsync/)([{pets: {fido: {species: 'dog'}}}, {}]);
await synchronizer2.startSync[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/synchronization/startsync/)([{pets: {felix: {species: 'cat'}}}, {}]);
