...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/load/stopautoload/)(): Promise<WsSynchronizer[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/)<WebSocketType>>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/methods/load/stopautoload/)();
