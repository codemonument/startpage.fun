...
# Functions
## `createRelationships`
The [`createRelationships`](https://tinybase.org/api/relationships/functions/creation/createrelationships/) function creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and is the main entry point into the [`relationships`](https://tinybase.org/api/relationships/) module. [Read more](https://tinybase.org/api/relationships/functions/creation/createrelationships/).
