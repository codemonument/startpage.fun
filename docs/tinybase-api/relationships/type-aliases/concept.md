...
## `Relationship`
The [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) type represents the concept of a map that connects one [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) object to another, often in another [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). [Read more](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).
