      ...
      * [`relationships`](https://tinybase.org/api/relationships/)
        ...
        * [Type Aliases](https://tinybase.org/api/relationships/type-aliases/)
          ...
          * [Development type aliases](https://tinybase.org/api/relationships/type-aliases/development/)
            * [`RelationshipsListenerStats`](https://tinybase.org/api/relationships/type-aliases/development/relationshipslistenerstats/)
...
The `RelationshipsListenerStats` type describes the number of listeners registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and can be used for debugging purposes.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `remoteRowId`  | `number`  | The number of [`RemoteRowIdListener`](https://tinybase.org/api/relationships/type-aliases/listener/remoterowidlistener/) functions registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.  |  
| `localRowIds`  | `number`  | The number of [`LocalRowIdsListener`](https://tinybase.org/api/relationships/type-aliases/listener/localrowidslistener/) functions registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.  |  
| `linkedRowIds`  | `number`  | The number of LinkedRowId functions registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.  |  
A `RelationshipsListenerStats` object is returned from the [`getListenerStats`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/development/getlistenerstats/) method.
## Since
v1.0.0
