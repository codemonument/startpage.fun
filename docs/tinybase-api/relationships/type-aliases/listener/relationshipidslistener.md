...
The `RelationshipIdsListener` type describes a function that is used to listen to [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) definitions being added or removed.

```
(relationships: Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)): void
```
...
A `RelationshipIdsListener` is provided when using the [`addRelationshipIdsListener`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addrelationshipidslistener/) method. See that method for specific examples.
When called, a `RelationshipIdsListener` is given a reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.
## Since
v1.0.0
