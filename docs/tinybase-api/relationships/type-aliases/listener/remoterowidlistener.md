    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`relationships`](https://tinybase.org/api/relationships/)
        ...
        * [Type Aliases](https://tinybase.org/api/relationships/type-aliases/)
          * [Listener type aliases](https://tinybase.org/api/relationships/type-aliases/listener/)
            * [`LinkedRowIdsListener`](https://tinybase.org/api/relationships/type-aliases/listener/linkedrowidslistener/)
            * [`LocalRowIdsListener`](https://tinybase.org/api/relationships/type-aliases/listener/localrowidslistener/)
            * [`RemoteRowIdListener`](https://tinybase.org/api/relationships/type-aliases/listener/remoterowidlistener/)
            * [`RelationshipIdsListener`](https://tinybase.org/api/relationships/type-aliases/listener/relationshipidslistener/)
          * [Callback type aliases](https://tinybase.org/api/relationships/type-aliases/callback/)
          * [Concept type aliases](https://tinybase.org/api/relationships/type-aliases/concept/)
          * [Development type aliases](https://tinybase.org/api/relationships/type-aliases/development/)
...
# `RemoteRowIdListener`
The `RemoteRowIdListener` type describes a function that is used to listen to changes to the remote [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) end of a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationships`  | `Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)`  | A reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object that changed.  |  
| `relationshipId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) that changed.  |  
| `localRowId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) whose remote [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) changed.  |  
| returns  | `void`  | This has no return value.  |  
A `RemoteRowIdListener` is provided when using the [`addRemoteRowIdListener`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addremoterowidlistener/) method. See that method for specific examples.
When called, a `RemoteRowIdListener` is given a reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) that changed, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) whose remote [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) changed.
## Since
v1.0.0
