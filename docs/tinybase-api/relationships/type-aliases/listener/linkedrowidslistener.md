...
The `LinkedRowIdsListener` type describes a function that is used to listen to changes to the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) ends of a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).
...
| `firstRowId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the first [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) of the linked list whose members changed.  |  
| returns  | `void`  | This has no return value.  |  
A `LinkedRowIdsListener` is provided when using the [`addLinkedRowIdsListener`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addlinkedrowidslistener/) method. See that method for specific examples.
When called, a `LinkedRowIdsListener` is given a reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) that changed, and the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the first [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) of the linked list whose members changed.
## Since
v1.0.0
