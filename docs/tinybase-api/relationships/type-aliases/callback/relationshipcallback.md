      ...
      * [`relationships`](https://tinybase.org/api/relationships/)
        ...
        * [Type Aliases](https://tinybase.org/api/relationships/type-aliases/)
          ...
          * [Callback type aliases](https://tinybase.org/api/relationships/type-aliases/callback/)
            * [`RelationshipCallback`](https://tinybase.org/api/relationships/type-aliases/callback/relationshipcallback/)
...
The `RelationshipCallback` type describes a function that takes a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/)'s [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and a callback to loop over each local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) within it.
...
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipId`  | `Id[](https://tinybase.org/api/common/type-aliases/identity/id/)`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) that the callback can operate on.  |  
| `forEachRow`  | `(rowCallback: RowCallback[](https://tinybase.org/api/store/type-aliases/callback/rowcallback/)) => void`  | A function that will let you iterate over the local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects in this [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).  |  
| returns  | `void`  | This has no return value.  |  
A `RelationshipCallback` is provided when using the [`forEachRelationship`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/iterator/foreachrelationship/) method, so that you can do something based on every [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) in the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object. See that method for specific examples.
## Since
v1.0.0
