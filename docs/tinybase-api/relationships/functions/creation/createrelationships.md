...
# `createRelationships`
The `createRelationships` function creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and is the main entry point into the [`relationships`](https://tinybase.org/api/relationships/) module.

```
createRelationships[](https://tinybase.org/api/relationships/functions/creation/createrelationships/)(store: Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)): Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `store`  | `Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)`  | The [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) for which to register [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/).  |  
| returns  | `Relationships[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/)`  | A reference to the new [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.  |  
...
## Examples
This example creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.
...
This example creates a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and calls the method a second time for the same [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to return the same object.

```
import {createRelationships, createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/store/functions/creation/createstore/)();
const relationships1 = createRelationships[](https://tinybase.org/api/relationships/functions/creation/createrelationships/)(store);
const relationships2 = createRelationships[](https://tinybase.org/api/relationships/functions/creation/createrelationships/)(store);
