...
# Iterator methods
## `forEachRelationship`
The [`forEachRelationship`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/iterator/foreachrelationship/) method takes a function that it will then call for each [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) in a specified [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object. [Read more](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/iterator/foreachrelationship/).
