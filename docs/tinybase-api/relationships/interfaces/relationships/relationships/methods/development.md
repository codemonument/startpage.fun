...
# Development methods
## `getListenerStats`
The [`getListenerStats`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/development/getlistenerstats/) method provides a set of statistics about the listeners registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and is used for debugging purposes. [Read more](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/development/getlistenerstats/).
