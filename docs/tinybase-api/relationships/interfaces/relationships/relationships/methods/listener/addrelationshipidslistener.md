...
The `addRelationshipIdsListener` method registers a listener function with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object that will be called whenever a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) definition is added or removed.

```
addRelationshipIdsListener[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addrelationshipidslistener/)(listener: RelationshipIdsListener[](https://tinybase.org/api/relationships/type-aliases/listener/relationshipidslistener/)): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `RelationshipIdsListener[](https://tinybase.org/api/relationships/type-aliases/listener/relationshipidslistener/)`  | The function that will be called whenever a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) definition is added or removed.  |  
| returns  | `string`  |   |  
The provided listener is a [`RelationshipIdsListener`](https://tinybase.org/api/relationships/type-aliases/listener/relationshipidslistener/) function, and will be called with a reference to the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.
## Example
This example creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and then registers a listener that responds to the addition and the removal of a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) definition.
...
const listenerId = relationships.addRelationshipIdsListener[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addrelationshipidslistener/)(
  (relationships) => {
    console.log(relationships.getRelationshipIds[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/getrelationshipids/)());
  },
);
...
// -> ['petSpecies']
relationships.delRelationshipDefinition[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/configuration/delrelationshipdefinition/)('petSpecies');
// -> []
