...
# `hasRelationship`
The `hasRelationship` method returns a boolean indicating whether a given [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) exists in the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.

```
hasRelationship[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/hasrelationship/)(relationshipId: string): boolean
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of a possible [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) in the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.  |  
| returns  | `boolean`  | Whether a [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) with that [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) exists.  |  
## Example
This example shows two simple [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) existence checks.
...
console.log(relationships.hasRelationship[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/hasrelationship/)('petSpecies'));
// -> true
console.log(relationships.hasRelationship[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/hasrelationship/)('petColor'));
// -> false
