...
# `getRemoteTableId`
The `getRemoteTableId` method returns the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the underlying remote [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) that is used in the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).

```
getRemoteTableId[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/getremotetableid/)(relationshipId: string): undefined | string
```
...
| returns  | `undefined | string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the remote [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) backing the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/), or `undefined`.  |  
...
console.log(relationships.getRemoteTableId[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/getremotetableid/)('petSpecies'));
// -> 'species'
console.log(relationships.getRemoteTableId[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/getter/getremotetableid/)('petColor'));
// -> undefined
