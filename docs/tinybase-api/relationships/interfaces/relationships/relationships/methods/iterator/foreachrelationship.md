...
# `forEachRelationship`
The `forEachRelationship` method takes a function that it will then call for each [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) in a specified [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.

```
forEachRelationship[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/iterator/foreachrelationship/)(relationshipCallback: RelationshipCallback[](https://tinybase.org/api/relationships/type-aliases/callback/relationshipcallback/)): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `relationshipCallback`  | `RelationshipCallback[](https://tinybase.org/api/relationships/type-aliases/callback/relationshipcallback/)`  | The function that should be called for every [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over the structure of the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object in a functional style. The `relationshipCallback` parameter is a [`RelationshipCallback`](https://tinybase.org/api/relationships/type-aliases/callback/relationshipcallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of each [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/), and with a function that can then be used to iterate over each local [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) involved in the [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/).
## Example
This example iterates over each [`Relationship`](https://tinybase.org/api/relationships/type-aliases/concept/relationship/) in a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and lists each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) within them.
...
relationships.forEachRelationship[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/iterator/foreachrelationship/)((relationshipId, forEachRow) => {
