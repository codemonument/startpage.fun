...
# `getListenerStats`
The `getListenerStats` method provides a set of statistics about the listeners registered with the [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object, and is used for debugging purposes.

```
getListenerStats[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/development/getlistenerstats/)(): RelationshipsListenerStats[](https://tinybase.org/api/relationships/type-aliases/development/relationshipslistenerstats/)
```
  
| returns  | `RelationshipsListenerStats[](https://tinybase.org/api/relationships/type-aliases/development/relationshipslistenerstats/)`  | A [`RelationshipsListenerStats`](https://tinybase.org/api/relationships/type-aliases/development/relationshipslistenerstats/) object containing [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) listener statistics.  |  
| --- | --- | --- |  
The [`RelationshipsListenerStats`](https://tinybase.org/api/relationships/type-aliases/development/relationshipslistenerstats/) object contains a breakdown of the different types of listener.
...
## Example
This example gets the listener statistics of a [`Relationships`](https://tinybase.org/api/relationships/interfaces/relationships/relationships/) object.
...
relationships.addRemoteRowIdListener[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addremoterowidlistener/)(null, null, () => {
  console.log('Remote Row Id changed');
});
relationships.addLocalRowIdsListener[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/listener/addlocalrowidslistener/)(null, null, () => {
  console.log('Local Row Id changed');
});

const listenerStats = relationships.getListenerStats[](https://tinybase.org/api/relationships/interfaces/relationships/relationships/methods/development/getlistenerstats/)();
