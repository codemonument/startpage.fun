...
The [`ReactNativeMmkvPersister`](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/) interface represents a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) that lets you save and load [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) data to and from a `react-native-mmkv` storage. [Read more](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/).
