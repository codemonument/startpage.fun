...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/load/stopautoload/)(): Promise<ReactNativeMmkvPersister[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/load/stopautoload/)();
