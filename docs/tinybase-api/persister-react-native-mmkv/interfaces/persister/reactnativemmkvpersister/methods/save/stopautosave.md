...
# `stopAutoSave`
The `stopAutoSave` method stops the automatic save of data to storage previously started with the [`startAutoSave`](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/save/startautosave/) method.

```
stopAutoSave[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/save/stopautosave/)(): Promise<ReactNativeMmkvPersister[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/)>
```
...
await persister.stopAutoSave[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/save/stopautosave/)();
