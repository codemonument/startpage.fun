...
```
schedule[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/lifecycle/schedule/)(actions: (() => Promise<any>)[]): Promise<ReactNativeMmkvPersister[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/)>
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `actions`  | `(() => Promise<any>)[]`  | One or many functions which will be scheduled, and which can be asynchronous.  |  
| returns  | `Promise<ReactNativeMmkvPersister[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/)>`  | A reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
const persister = createCustomPersister[](https://tinybase.org/api/persisters/functions/creation/createcustompersister/)(
  ...
  async (getContent) => {
    // setPersisted
    await persister.schedule[](https://tinybase.org/api/persister-react-native-mmkv/interfaces/persister/reactnativemmkvpersister/methods/lifecycle/schedule/)(
      () => checkRemoteSystemIsReady(),
