    ...
    * [API](https://tinybase.org/api/)
      * [The Essentials](https://tinybase.org/api/the-essentials/)
        ...
        * [Synchronizing stores](https://tinybase.org/api/the-essentials/synchronizing-stores/)
          * [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/)
          * [`WsServerDurableObject`](https://tinybase.org/api/the-essentials/synchronizing-stores/wsserverdurableobject/)
          * [`createWsSynchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/createwssynchronizer/)
...
## `Synchronizer`
Essential
A [`Synchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/) object lets you synchronize [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) data with another TinyBase client or system. [Read more](https://tinybase.org/api/the-essentials/synchronizing-stores/synchronizer/).
## `WsServerDurableObject`
Essential
A [`WsServerDurableObject`](https://tinybase.org/api/the-essentials/synchronizing-stores/wsserverdurableobject/) is the server component (running as a Cloudflare Durable Object) for synchronization between clients that are using [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) instances. [Read more](https://tinybase.org/api/the-essentials/synchronizing-stores/wsserverdurableobject/).
## `createWsSynchronizer`
Essential
The [`createWsSynchronizer`](https://tinybase.org/api/the-essentials/synchronizing-stores/createwssynchronizer/) function creates a [`WsSynchronizer`](https://tinybase.org/api/synchronizer-ws-client/interfaces/synchronizer/wssynchronizer/) object that can synchronize [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) data to and from other [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) instances via WebSockets facilitated by a [`WsServer`](https://tinybase.org/api/synchronizer-ws-server/interfaces/server/wsserver/). [Read more](https://tinybase.org/api/the-essentials/synchronizing-stores/createwssynchronizer/).
