...
## `addRowListener`
Essential
The [`addRowListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addrowlistener/) method registers a listener function with the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) that will be called whenever data in a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) changes. [Read more](https://tinybase.org/api/the-essentials/listening-for-changes/addrowlistener/).
## `addCellListener`
Essential
The [`addCellListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addcelllistener/) method registers a listener function with the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) that will be called whenever data in a [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) changes. [Read more](https://tinybase.org/api/the-essentials/listening-for-changes/addcelllistener/).
## `addValueListener`
Essential
The [`addValueListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/) method registers a listener function with the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) that will be called whenever data in a [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) changes. [Read more](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/).
