...
console.log(store.addRow[](https://tinybase.org/api/the-essentials/setting-data/addrow/)('pets', {species: 'dog'}));
// -> '0'
...
console.log(store.addRow[](https://tinybase.org/api/the-essentials/setting-data/addrow/)('pets', {species: 'cat', bug: new Date(0)}));
// -> '1'
console.log(store.getTables[](https://tinybase.org/api/store/interfaces/store/store/methods/getter/gettables/)());
// -> {pets: {'0': {species: 'dog'}, '1': {species: 'cat'}}}

console.log(store.addRow[](https://tinybase.org/api/the-essentials/setting-data/addrow/)('pets', 42));
// -> undefined
console.log(store.getTables[](https://tinybase.org/api/store/interfaces/store/store/methods/getter/gettables/)());
// -> {pets: {'0': {species: 'dog'}, '1': {species: 'cat'}}}
