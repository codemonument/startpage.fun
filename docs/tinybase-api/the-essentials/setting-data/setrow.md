...
# `setRow`
Essential
The `setRow` method takes an object and sets the entire data of a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
This example attempts to set the data of an existing [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) with partly invalid, and then completely invalid, [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects.
...
store.setRow[](https://tinybase.org/api/the-essentials/setting-data/setrow/)('pets', 'fido', {color: 'brown', bug: new Date(0)});
console.log(store.getTables[](https://tinybase.org/api/store/interfaces/store/store/methods/getter/gettables/)());
// -> {pets: {fido: {color: 'brown'}}}

store.setRow[](https://tinybase.org/api/the-essentials/setting-data/setrow/)('pets', 'fido', 42);
console.log(store.getTables[](https://tinybase.org/api/store/interfaces/store/store/methods/getter/gettables/)());
// -> {pets: {fido: {color: 'brown'}}}
