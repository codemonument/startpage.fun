...
```
Inspector[](https://tinybase.org/api/the-essentials/using-react/inspector/)(props: InspectorProps[](https://tinybase.org/api/ui-react-inspector/type-aliases/props/inspectorprops/)): ComponentReturnType[](https://tinybase.org/api/ui-react/type-aliases/component/componentreturntype/)
```
...
const Pane = () => <Inspector[](https://tinybase.org/api/the-essentials/using-react/inspector/) />;
