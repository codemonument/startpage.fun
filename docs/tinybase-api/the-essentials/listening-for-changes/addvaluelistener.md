    ...
    * [API](https://tinybase.org/api/)
      * [The Essentials](https://tinybase.org/api/the-essentials/)
        ...
        * [Listening for changes](https://tinybase.org/api/the-essentials/listening-for-changes/)
          * [`addRowListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addrowlistener/)
          * [`addCellListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addcelllistener/)
          * [`addValueListener`](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/)
...
addValueListener[](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/)(
  ...
  listener: ValueListener[](https://tinybase.org/api/store/type-aliases/listener/valuelistener/)<Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)>,
  mutator?: boolean,
): string
```
...
| `listener`  | `ValueListener[](https://tinybase.org/api/store/type-aliases/listener/valuelistener/)<Store[](https://tinybase.org/api/the-essentials/creating-stores/store/)>`  | The function that will be called whenever data in the matching [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) changes.  |  
...
const listenerId = store.addValueListener[](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/)(
  'employees',
...
const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)().setValues[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/setvalues/)({open: true, employees: 3});
const listenerId = store.addValueListener[](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/)(null, (store, valueId) => {
...
const listenerId = store.addValueListener[](https://tinybase.org/api/the-essentials/listening-for-changes/addvaluelistener/)(
  'employees',
  (store) => store.setValue[](https://tinybase.org/api/the-essentials/setting-data/setvalue/)('updated', true),
  true,
);
