    ...
    * [API](https://tinybase.org/api/)
      * [The Essentials](https://tinybase.org/api/the-essentials/)
        ...
        * [Persisting stores](https://tinybase.org/api/the-essentials/persisting-stores/)
          * [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/)
          * [`createDurableObjectSqlStoragePersister`](https://tinybase.org/api/the-essentials/persisting-stores/createdurableobjectsqlstoragepersister/)
          * [`createLocalPersister`](https://tinybase.org/api/the-essentials/persisting-stores/createlocalpersister/)
          * [`createPglitePersister`](https://tinybase.org/api/the-essentials/persisting-stores/createpglitepersister/)
          * [`createSessionPersister`](https://tinybase.org/api/the-essentials/persisting-stores/createsessionpersister/)
          * [`createSqliteWasmPersister`](https://tinybase.org/api/the-essentials/persisting-stores/createsqlitewasmpersister/)
...
Essential
The `createLocalPersister` function creates a [`LocalPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to the browser's local storage.
...
| returns  | `LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)`  | A reference to the new [`LocalPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/) object.  |  
A [`LocalPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/) supports both regular [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects.
...
## Example
This example creates a [`LocalPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/) object and persists the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to the browser's local storage.
...
const persister = createLocalPersister[](https://tinybase.org/api/the-essentials/persisting-stores/createlocalpersister/)(store, 'pets');
...
localStorage.clear[](https://tinybase.org/api/checkpoints/interfaces/checkpoints/checkpoints/methods/lifecycle/clear/)();
