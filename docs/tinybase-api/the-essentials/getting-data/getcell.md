    ...
    * [API](https://tinybase.org/api/)
      * [The Essentials](https://tinybase.org/api/the-essentials/)
        ...
        * [Getting data](https://tinybase.org/api/the-essentials/getting-data/)
          * [`getRow`](https://tinybase.org/api/the-essentials/getting-data/getrow/)
          * [`getCell`](https://tinybase.org/api/the-essentials/getting-data/getcell/)
          * [`getValue`](https://tinybase.org/api/the-essentials/getting-data/getvalue/)
