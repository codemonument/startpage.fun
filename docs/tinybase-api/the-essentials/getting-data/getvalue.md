...
```
getValue[](https://tinybase.org/api/the-essentials/getting-data/getvalue/)(valueId: string): ValueOrUndefined[](https://tinybase.org/api/store/type-aliases/store/valueorundefined/)
```
