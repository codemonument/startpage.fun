...
## `getRow`
Essential
The [`getRow`](https://tinybase.org/api/the-essentials/getting-data/getrow/) method returns an object containing the entire data of a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a given [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). [Read more](https://tinybase.org/api/the-essentials/getting-data/getrow/).
## `getCell`
Essential
The [`getCell`](https://tinybase.org/api/the-essentials/getting-data/getcell/) method returns the value of a single [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a given [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), in a given [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). [Read more](https://tinybase.org/api/the-essentials/getting-data/getcell/).
## `getValue`
Essential
The [`getValue`](https://tinybase.org/api/the-essentials/getting-data/getvalue/) method returns a single keyed [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/). [Read more](https://tinybase.org/api/the-essentials/getting-data/getvalue/).
