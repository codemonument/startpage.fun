    ...
    * [API](https://tinybase.org/api/)
      * [The Essentials](https://tinybase.org/api/the-essentials/)
        * [Creating stores](https://tinybase.org/api/the-essentials/creating-stores/)
          * [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/)
...
## `Store`
Essential
A [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is the main location for keeping both tabular data and keyed values. [Read more](https://tinybase.org/api/the-essentials/creating-stores/store/).
## `createMergeableStore`
Essential
The [`createMergeableStore`](https://tinybase.org/api/the-essentials/creating-stores/createmergeablestore/) function creates a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/), and is the main entry point into the [`mergeable-store`](https://tinybase.org/api/mergeable-store/) module. [Read more](https://tinybase.org/api/the-essentials/creating-stores/createmergeablestore/).
## `createStore`
Essential
The [`createStore`](https://tinybase.org/api/the-essentials/creating-stores/createstore/) function creates a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and is the main entry point into the [`store`](https://tinybase.org/api/store/) module. [Read more](https://tinybase.org/api/the-essentials/creating-stores/createstore/).
