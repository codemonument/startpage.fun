...
## `setRow`
Essential
The [`setRow`](https://tinybase.org/api/the-essentials/setting-data/setrow/) method takes an object and sets the entire data of a single [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/). [Read more](https://tinybase.org/api/the-essentials/setting-data/setrow/).
## `addRow`
Essential
The [`addRow`](https://tinybase.org/api/the-essentials/setting-data/addrow/) method takes an object and creates a new [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), returning the unique [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) assigned to it. [Read more](https://tinybase.org/api/the-essentials/setting-data/addrow/).
## `setCell`
Essential
The [`setCell`](https://tinybase.org/api/the-essentials/setting-data/setcell/) method sets the value of a single [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/). [Read more](https://tinybase.org/api/the-essentials/setting-data/setcell/).
## `setValue`
Essential
The [`setValue`](https://tinybase.org/api/the-essentials/setting-data/setvalue/) method sets a single keyed [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/). [Read more](https://tinybase.org/api/the-essentials/setting-data/setvalue/).
## `transaction`
Essential
The [`transaction`](https://tinybase.org/api/the-essentials/setting-data/transaction/) method takes a function that makes multiple mutations to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), buffering all calls to the relevant listeners until it completes. [Read more](https://tinybase.org/api/the-essentials/setting-data/transaction/).
