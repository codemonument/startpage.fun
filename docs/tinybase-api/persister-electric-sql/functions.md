...
The [`createElectricSqlPersister`](https://tinybase.org/api/persister-electric-sql/functions/creation/createelectricsqlpersister/) function creates an [`ElectricSqlPersister`](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/) object that can persist a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local ElectricSQL database. [Read more](https://tinybase.org/api/persister-electric-sql/functions/creation/createelectricsqlpersister/).
