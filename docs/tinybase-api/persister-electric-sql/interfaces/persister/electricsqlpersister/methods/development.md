...
# Development methods
## `getStats`
The [`getStats`](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/development/getstats/) method provides a set of statistics about the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/), and is used for debugging purposes. [Read more](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/development/getstats/).
