...
# `getElectricClient`
The `getElectricClient` method returns a reference to the Electric client the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getElectricClient[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/getter/getelectricclient/)(): ElectricClient<any>
```
  
| returns  | `ElectricClient<any>`  | A reference to the Electric client.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the Electric client back out again.
...
console.log(persister.getElectricClient[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/getter/getelectricclient/)() == electricClient);
// -> true
