...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/load/stopautoload/)(): Promise<ElectricSqlPersister[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/)>
```
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/load/stopautoload/)();
