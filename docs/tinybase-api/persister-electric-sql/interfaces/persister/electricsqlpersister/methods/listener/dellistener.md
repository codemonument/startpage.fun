...
```
delListener[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/listener/dellistener/)(listenerId: string): this
```
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/listener/addstatuslistener/)((_persister, status) => {
