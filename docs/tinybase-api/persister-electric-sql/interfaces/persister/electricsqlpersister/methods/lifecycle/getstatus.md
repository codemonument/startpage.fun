...
```
getStatus[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/lifecycle/getstatus/)(): Status[](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
```
...
console.log(persister.getStatus[](https://tinybase.org/api/persister-electric-sql/interfaces/persister/electricsqlpersister/methods/lifecycle/getstatus/)());
// -> 0
