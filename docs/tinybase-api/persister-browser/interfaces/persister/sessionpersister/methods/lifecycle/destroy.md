...
```
destroy[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/lifecycle/destroy/)(): Promise<SessionPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/)>
```
