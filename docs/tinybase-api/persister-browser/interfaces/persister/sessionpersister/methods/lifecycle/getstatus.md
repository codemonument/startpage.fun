...
```
getStatus[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/lifecycle/getstatus/)(): Status[](https://tinybase.org/api/persisters/enumerations/lifecycle/status/)
```
...
console.log(persister.getStatus[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/lifecycle/getstatus/)());
// -> 0
