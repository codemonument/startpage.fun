...
# `stopAutoSave`
The `stopAutoSave` method stops the automatic save of data to storage previously started with the [`startAutoSave`](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/save/startautosave/) method.

```
stopAutoSave[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/save/stopautosave/)(): Promise<SessionPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/)>
```
...
await persister.stopAutoSave[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/save/stopautosave/)();
