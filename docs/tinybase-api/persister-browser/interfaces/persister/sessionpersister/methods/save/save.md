...
```
save[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/methods/save/save/)(): Promise<SessionPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/sessionpersister/)>
```
