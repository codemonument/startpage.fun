...
```
destroy[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/lifecycle/destroy/)(): Promise<LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)>
```
...
await persister.startAutoSave[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/save/startautosave/)();
