    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`persister-browser`](https://tinybase.org/api/persister-browser/)
        * [Interfaces](https://tinybase.org/api/persister-browser/interfaces/)
          * [`LocalPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)
            * [Getter methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)>
```
...
| returns  | `Promise<LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
...
await persister.destroy[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/lifecycle/destroy/)();
