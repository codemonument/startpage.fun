...
```
addStatusListener[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)>): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<LocalPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/)>`  | The function that will be called whenever the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) starts or stops loading or saving.  |  
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
await persister.save[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/save/save/)();
// -> 'pets persister status changed to 2'
// -> 'pets persister status changed to 0'

persister.delListener[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/listener/dellistener/)(listenerId);
