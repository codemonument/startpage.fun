...
# `getStorageName`
The `getStorageName` method returns the unique key of the storage location the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getStorageName[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/getter/getstoragename/)(): string
```
  
| returns  | `string`  | The unique key of the storage location.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the unique key of the storage location back out again.
...
console.log(persister.getStorageName[](https://tinybase.org/api/persister-browser/interfaces/persister/localpersister/methods/getter/getstoragename/)());
// -> 'pets'
