      ...
      * [`persister-browser`](https://tinybase.org/api/persister-browser/)
        * [Interfaces](https://tinybase.org/api/persister-browser/interfaces/)
          ...
          * [`OpfsPersister`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/)
            * [Getter methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/development/)
...
```
startAutoLoad[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/startautoload/)(initialContent?: Content[](https://tinybase.org/api/store/type-aliases/store/content/) | () => Content[](https://tinybase.org/api/store/type-aliases/store/content/)): Promise<OpfsPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/)>
```
...
| returns  | `Promise<OpfsPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
