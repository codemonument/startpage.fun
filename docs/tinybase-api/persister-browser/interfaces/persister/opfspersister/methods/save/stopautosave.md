...
# `stopAutoSave`
The `stopAutoSave` method stops the automatic save of data to storage previously started with the [`startAutoSave`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/startautosave/) method.

```
stopAutoSave[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/stopautosave/)(): Promise<OpfsPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/)>
```
...
await persister.stopAutoSave[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/stopautosave/)();
