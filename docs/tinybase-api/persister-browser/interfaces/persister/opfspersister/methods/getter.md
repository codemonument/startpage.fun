...
# Getter methods
## `getStore`
The [`getStore`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/getter/getstore/) method returns a reference to the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) or [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) that is backing this [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object. [Read more](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/getter/getstore/).
## `getHandle`
The [`getHandle`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/getter/gethandle/) method returns the handle of the file the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to. [Read more](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/getter/gethandle/).
