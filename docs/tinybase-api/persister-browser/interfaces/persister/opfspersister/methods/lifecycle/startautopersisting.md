...
): Promise<OpfsPersister[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/)>
```
...
This simply runs the startAutoLoad and [`startAutoSave`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/startautosave/) methods in sequence, and returns a Promise that resolves when both have completed.
This method can take `initialContent` to pass to the [`startAutoLoad`](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/startautoload/) method. See its documentation for more details.
...
await persister.startAutoPersisting[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/lifecycle/startautopersisting/)();
console.log(persister.isAutoSaving[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/save/isautosaving/)());
// -> true
console.log(persister.isAutoLoading[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/load/isautoloading/)());
// -> true

persister.destroy[](https://tinybase.org/api/persister-browser/interfaces/persister/opfspersister/methods/lifecycle/destroy/)();
