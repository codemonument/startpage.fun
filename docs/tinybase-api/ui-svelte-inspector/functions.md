...
# Functions
[![Inspector example](https://tinybase.org/shots/inspector-svelte-demo.png)](https://tinybase.org/api/ui-svelte-inspector/functions/development-components/inspector/)
## `Inspector`
Essential
The [`Inspector`](https://tinybase.org/api/ui-svelte-inspector/functions/development-components/inspector/) component renders a tool which allows you to view and edit the content of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) in a debug web environment. [Read more](https://tinybase.org/api/ui-svelte-inspector/functions/development-components/inspector/).
