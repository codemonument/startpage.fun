  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`ui-svelte-inspector`](https://tinybase.org/api/ui-svelte-inspector/)
        * [Functions](https://tinybase.org/api/ui-svelte-inspector/functions/)
        * [Type Aliases](https://tinybase.org/api/ui-svelte-inspector/type-aliases/)
...
# `InspectorProps`
`InspectorProps` props are used to configure the [`Inspector`](https://tinybase.org/api/the-essentials/using-svelte/inspector/) component.
