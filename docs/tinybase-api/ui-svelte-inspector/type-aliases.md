...
# Type Aliases
## `InspectorProps`
[`InspectorProps`](https://tinybase.org/api/ui-svelte-inspector/type-aliases/props/inspectorprops/) props are used to configure the [`Inspector`](https://tinybase.org/api/the-essentials/using-svelte/inspector/) component. [Read more](https://tinybase.org/api/ui-svelte-inspector/type-aliases/props/inspectorprops/).
