...
```
getChannelName[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/getter/getchannelname/)(): string
```
  
| returns  | `string`  | The channel name.  |  
| --- | --- | --- |  
## Example
This example creates a [`BroadcastChannelSynchronizer`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/) object for a newly-created [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) and then gets the channel name back out again.
...
const synchronizer = createBroadcastChannelSynchronizer[](https://tinybase.org/api/synchronizer-broadcast-channel/functions/creation/createbroadcastchannelsynchronizer/)(store, 'channelA');

console.log(synchronizer.getChannelName[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/getter/getchannelname/)());
// -> 'channelA'

await synchronizer.destroy[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/lifecycle/destroy/)();
