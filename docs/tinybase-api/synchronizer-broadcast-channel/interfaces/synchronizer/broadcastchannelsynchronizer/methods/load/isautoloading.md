...
# `isAutoLoading`
The `isAutoLoading` method lets you find out if the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is currently automatically loading its content.

```
isAutoLoading[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/load/isautoloading/)(): boolean
```
  
| returns  | `boolean`  | A boolean indicating whether the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is currently autoLoading.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) and queries whether it is autoLoading.
