...
# `stopAutoLoad`
The `stopAutoLoad` method stops the automatic loading of data from storage previously started with the [`startAutoLoad`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/load/startautoload/) method.

```
stopAutoLoad[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/load/stopautoload/)(): Promise<BroadcastChannelSynchronizer[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/)>
```
...
| --- | --- | --- |  
If the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is not currently set to automatically load, this method has no effect. This method is asynchronous.
## Example
This example creates an empty [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and starts automatically loading data into it from the browser's session storage. Once the automatic loading is stopped, subsequent changes are not reflected in the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
await persister.startAutoLoad[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/load/startautoload/)();
...
await persister.stopAutoLoad[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/load/stopautoload/)();
