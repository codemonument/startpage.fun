...
# `stopSync`
The `stopSync` method is used to stop the process of synchronization between this instance and another matching [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/).

```
stopSync[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/stopsync/)(): Promise<BroadcastChannelSynchronizer[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/)>
```
...
| --- | --- | --- |  
The underlying implementation of a [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) is shared with the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) framework, and so this [`startSync`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/startsync/) method is equivalent to stopping both auto-loading (listening to sync messages from other active [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/) instances) and auto-saving (sending sync messages to them).
...
await synchronizer1.stopSync[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/stopsync/)();
await synchronizer2.stopSync[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/stopsync/)();
