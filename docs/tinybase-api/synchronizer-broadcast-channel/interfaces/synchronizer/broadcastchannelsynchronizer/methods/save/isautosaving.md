...
# `isAutoSaving`
The `isAutoSaving` method lets you find out if the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is currently automatically saving its content.

```
isAutoSaving[](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/save/isautosaving/)(): boolean
```
  
| returns  | `boolean`  | A boolean indicating whether the [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is currently autoSaving.  |  
| --- | --- | --- |  
## Example
This example creates a [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) and queries whether it is autoSaving.
