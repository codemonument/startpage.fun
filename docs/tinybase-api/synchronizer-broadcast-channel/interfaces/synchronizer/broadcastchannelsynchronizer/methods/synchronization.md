...
The [`getSynchronizerStats`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/getsynchronizerstats/) method provides a set of statistics about the [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/), and is used for debugging purposes. [Read more](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/getsynchronizerstats/).
## `startSync`
The [`startSync`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/startsync/) method is used to start the process of synchronization between this instance and another matching [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/). [Read more](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/startsync/).
## `stopSync`
The [`stopSync`](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/stopsync/) method is used to stop the process of synchronization between this instance and another matching [`Synchronizer`](https://tinybase.org/api/synchronizers/interfaces/synchronizer/synchronizer/). [Read more](https://tinybase.org/api/synchronizer-broadcast-channel/interfaces/synchronizer/broadcastchannelsynchronizer/methods/synchronization/stopsync/).
