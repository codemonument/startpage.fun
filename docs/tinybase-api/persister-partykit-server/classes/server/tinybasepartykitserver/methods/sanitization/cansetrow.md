...
# `canSetRow`
The `canSetRow` method lets you allow or disallow any changes to a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) stored on the server, as sent from a client.
...
Return `false` from this method to disallow changes to this [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) on the server, or `true` to allow them (subject to subsequent [`canSetCell`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/sanitization/cansetcell/) method and [`canSetCell`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/sanitization/cansetcell/) method checks). The default implementation returns `true` to allow all changes.
## Example
The following implementation will strip out any attempts by the client to update the 'me' [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) of the 'user' [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) after the initial save:
...
export class MyServer extends TinyBasePartyKitServer[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/) {
  canSetRow[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/sanitization/cansetrow/)(tableId, rowId, initialSave) {
