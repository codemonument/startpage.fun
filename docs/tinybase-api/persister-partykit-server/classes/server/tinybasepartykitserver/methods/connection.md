...
# Connection methods
## `onMessage`
The [`onMessage`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onmessage/) method is called when the server receives a message from a client. [Read more](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onmessage/).
## `onRequest`
The [`onRequest`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/) method is called when a HTTP request is made to the party URL. [Read more](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/).
