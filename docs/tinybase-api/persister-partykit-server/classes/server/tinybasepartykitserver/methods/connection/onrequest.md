          ...
          * [`TinyBasePartyKitServer`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/)
            ...
            * [Methods](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/)
              * [Connection methods](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/)
                * [`onMessage`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onmessage/)
                * [`onRequest`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/)
...
```
onRequest[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/)(request: Request): Promise<Response>
```
...
export class MyServer extends TinyBasePartyKitServer[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/) {
  async onRequest[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/)(request) {
    // custom onRequest code, else:
    return await super.onRequest[](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/methods/connection/onrequest/)(request);
  }
}

```

See the [PartyKit server API documentation](https://docs.partykit.io/reference/partyserver-api/) for more details.
## Since
v4.3.0
