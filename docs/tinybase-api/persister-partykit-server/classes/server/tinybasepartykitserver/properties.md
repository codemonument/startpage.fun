...
# Properties
## `config`
The config property is used to optionally configure the server, using an object of the [`TinyBasePartyKitServerConfig`](https://tinybase.org/api/persister-partykit-server/type-aliases/configuration/tinybasepartykitserverconfig/) type. [Read more](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/properties/configuration/config/).
