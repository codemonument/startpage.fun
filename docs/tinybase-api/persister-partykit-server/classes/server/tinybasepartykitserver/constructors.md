...
# Constructors
## `constructor`
The constructor is used to create the server. [Read more](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/constructors/creation/constructor/).
