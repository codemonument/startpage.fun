        ...
        * [Classes](https://tinybase.org/api/persister-partykit-server/classes/)
          * [`TinyBasePartyKitServer`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/)
            ...
            * [Properties](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/properties/)
              * [`config`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/properties/configuration/config/)
...
# `config`
The config property is used to optionally configure the server, using an object of the [`TinyBasePartyKitServerConfig`](https://tinybase.org/api/persister-partykit-server/type-aliases/configuration/tinybasepartykitserverconfig/) type.
