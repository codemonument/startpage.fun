...
A [`TinyBasePartyKitServer`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/) is the server component for persisting the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to durable PartyKit storage, enabling synchronization of the same [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) across multiple clients. [Read more](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/).
