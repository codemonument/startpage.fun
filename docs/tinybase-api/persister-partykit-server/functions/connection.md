...
## `broadcastChanges`
The [`broadcastChanges`](https://tinybase.org/api/persister-partykit-server/functions/connection/broadcastchanges/) function allows you to broadcast [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) changes to all the client connections of a [`TinyBasePartyKitServer`](https://tinybase.org/api/persister-partykit-server/classes/server/tinybasepartykitserver/). [Read more](https://tinybase.org/api/persister-partykit-server/functions/connection/broadcastchanges/).
