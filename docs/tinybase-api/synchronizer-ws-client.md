...
The synchronizer-ws module of the TinyBase project lets you synchronize [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) data to and from other [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) instances via WebSockets facilitated by a server.
## See also
  * [Synchronization](https://tinybase.org/guides/synchronization/) guide
  * [Todo App v6 (collaboration)](https://tinybase.org/demos/todo-app/todo-app-v6-collaboration/) demo
