...
The `getTransactionMergeableChanges` method returns the net meaningful changes that have been made to a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) during a transaction.

```
getTransactionMergeableChanges[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/transaction/gettransactionmergeablechanges/)(withHashes?: boolean): MergeableChanges[](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablechanges/)<true>
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `withHashes?`  | `boolean`  | Whether to include hashes in the output, defaulting to false.  |  
| returns  | `MergeableChanges[](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablechanges/)<true>`  | A [`MergeableChanges`](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablechanges/) object representing the changes, with hashes.  |  
...
## Example
This example makes changes to the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/). At the end of the transaction, detail about what changed is enumerated.
...
store.setTables[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/setter/settables/)({pets: {fido: {species: 'dog', color: 'brown'}}});
...
store
  ...
  .finishTransaction[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/transaction/finishtransaction/)(() => {
    console.log(store.getTransactionMergeableChanges[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/transaction/gettransactionmergeablechanges/)());
  });
// ->
[
