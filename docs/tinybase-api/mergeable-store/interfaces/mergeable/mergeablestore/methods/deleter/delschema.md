...
# `delSchema`
The `delSchema` method lets you remove both the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
delSchema[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/deleter/delschema/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).  |  
| --- | --- | --- |  
Prior to v3.0, this method removed the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) only.
## Example
This example removes the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) and [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
...
store.delSchema[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/deleter/delschema/)();
