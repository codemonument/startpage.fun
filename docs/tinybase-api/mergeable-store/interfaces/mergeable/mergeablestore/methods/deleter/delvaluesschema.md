...
# `delValuesSchema`
The `delValuesSchema` method lets you remove the [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
delValuesSchema[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/deleter/delvaluesschema/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).  |  
| --- | --- | --- |  
## Example
This example removes the [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/) of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
