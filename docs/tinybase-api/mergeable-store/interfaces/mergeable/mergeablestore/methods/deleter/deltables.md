...
# `delTables`
The `delTables` method lets you remove all of the data in a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
delTables[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/deleter/deltables/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).  |  
| --- | --- | --- |  
## Example
This example removes the data of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
