...
# `delTablesSchema`
The `delTablesSchema` method lets you remove the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) of the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
delTablesSchema[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/deleter/deltablesschema/)(): this
```
  
| returns  | `this`  | A reference to the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).  |  
| --- | --- | --- |  
## Example
This example removes the [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/) of a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
