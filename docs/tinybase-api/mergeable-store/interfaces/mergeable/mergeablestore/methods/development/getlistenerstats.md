        ...
        * [Interfaces](https://tinybase.org/api/mergeable-store/interfaces/)
          * [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/)
            ...
            * [Development methods](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/development/)
              * [`getListenerStats`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/development/getlistenerstats/)
...
# `getListenerStats`
The `getListenerStats` method provides a set of statistics about the listeners registered with the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/), and is used for debugging purposes.

```
getListenerStats[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/development/getlistenerstats/)(): StoreListenerStats[](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/)
```
  
| returns  | `StoreListenerStats[](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/)`  | A [`StoreListenerStats`](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/) object containing [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) listener statistics.  |  
| --- | --- | --- |  
The [`StoreListenerStats`](https://tinybase.org/api/store/type-aliases/development/storelistenerstats/) object contains a breakdown of the different types of listener. Totals include both mutator and non-mutator listeners.
...
## Example
This example gets the listener statistics of a small and simple [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).

```
import {createStore} from 'tinybase';

const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)();
store.addTablesListener[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/listener/addtableslistener/)(() => console.log('Tables changed'));
store.addRowIdsListener[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/listener/addrowidslistener/)(() => console.log('Row Ids changed'));

const listenerStats = store.getListenerStats[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/development/getlistenerstats/)();
