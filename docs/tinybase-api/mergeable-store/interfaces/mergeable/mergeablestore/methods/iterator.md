...
# Iterator methods
## `forEachTable`
The [`forEachTable`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtable/) method takes a function that it will then call for each [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in the [`Store`](https://tinybase.org/api/store/interfaces/store/store/). [Read more](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtable/).
## `forEachTableCell`
The [`forEachTableCell`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtablecell/) method takes a function that it will then call for each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) used across the whole [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). [Read more](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtablecell/).
## `forEachRow`
The [`forEachRow`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachrow/) method takes a function that it will then call for each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a specified [`Table`](https://tinybase.org/api/store/type-aliases/store/table/). [Read more](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachrow/).
## `forEachCell`
The [`forEachCell`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachcell/) method takes a function that it will then call for each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a specified [`Row`](https://tinybase.org/api/store/type-aliases/store/row/). [Read more](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachcell/).
## `forEachValue`
The [`forEachValue`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachvalue/) method takes a function that it will then call for each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) in a [`Store`](https://tinybase.org/api/store/interfaces/store/store/). [Read more](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachvalue/).
