...
# `forEachCell`
The `forEachCell` method takes a function that it will then call for each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a specified [`Row`](https://tinybase.org/api/store/type-aliases/store/row/).

```
forEachCell[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachcell/)(
  tableId: string,
  rowId: string,
  cellCallback: CellCallback[](https://tinybase.org/api/store/type-aliases/callback/cellcallback/),
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) containing the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) to iterate over.  |  
| `rowId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) to iterate over.  |  
| `cellCallback`  | `CellCallback[](https://tinybase.org/api/store/type-aliases/callback/cellcallback/)`  | The function that should be called for every [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) structure of the [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) in a functional style. The `cellCallback` parameter is a [`CellCallback`](https://tinybase.org/api/store/type-aliases/callback/cellcallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) and value of each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/).
## Example
This example iterates over each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) in a [`Row`](https://tinybase.org/api/store/type-aliases/store/row/), and lists its value.
...
store.forEachCell[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachcell/)('pets', 'fido', (cellId, cell) => {
