...
# `forEachTableCell`
The `forEachTableCell` method takes a function that it will then call for each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) used across the whole [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).

```
forEachTableCell[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtablecell/)(
  tableId: string,
  tableCellCallback: TableCellCallback[](https://tinybase.org/api/store/type-aliases/callback/tablecellcallback/),
): void
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `tableId`  | `string`  | The [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) containing the Cells to iterate over.  |  
| `tableCellCallback`  | `TableCellCallback[](https://tinybase.org/api/store/type-aliases/callback/tablecellcallback/)`  | The function that should be called for every [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) used across the whole [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).  |  
| returns  | `void`  | This has no return value.  |  
This method is useful for iterating over the [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) structure of the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in a functional style. The `tableCellCallback` parameter is a [`TableCellCallback`](https://tinybase.org/api/store/type-aliases/callback/tablecellcallback/) function that will be called with the [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) of each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) and the count of Rows in the [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) in which it appears.
## Example
This example iterates over each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) used across the whole [`Table`](https://tinybase.org/api/store/type-aliases/store/table/).
...
store.forEachTableCell[](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/methods/iterator/foreachtablecell/)('pets', (cellId, count) => {
