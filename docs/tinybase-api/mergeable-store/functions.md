...
Essential
The [`createMergeableStore`](https://tinybase.org/api/mergeable-store/functions/creation/createmergeablestore/) function creates a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/), and is the main entry point into the [`mergeable-store`](https://tinybase.org/api/mergeable-store/) module. [Read more](https://tinybase.org/api/mergeable-store/functions/creation/createmergeablestore/).
