      ...
      * [`mergeable-store`](https://tinybase.org/api/mergeable-store/)
        ...
        * [Type Aliases](https://tinybase.org/api/mergeable-store/type-aliases/)
          ...
          * [Syncing type aliases](https://tinybase.org/api/mergeable-store/type-aliases/syncing/)
            * [`TableHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/tablehashes/)
            * [`RowHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/rowhashes/)
            * [`CellHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/cellhashes/)
            * [`ValueHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/valuehashes/)
            * [`ContentHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/contenthashes/)
...
## `TableHashes`
The [`TableHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/tablehashes/) type is used to quickly compare the content of two sets of [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) objects. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/syncing/tablehashes/).
## `RowHashes`
The [`RowHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/rowhashes/) type is used to quickly compare the content of two sets of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/syncing/rowhashes/).
## `CellHashes`
The [`CellHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/cellhashes/) type is used to quickly compare the content of two sets of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) objects. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/syncing/cellhashes/).
## `ValueHashes`
The [`ValueHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/valuehashes/) type is used to quickly compare the content of two sets of [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) objects. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/syncing/valuehashes/).
## `ContentHashes`
The [`ContentHashes`](https://tinybase.org/api/mergeable-store/type-aliases/syncing/contenthashes/) type is used to quickly compare the content of two [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/syncing/contenthashes/).
