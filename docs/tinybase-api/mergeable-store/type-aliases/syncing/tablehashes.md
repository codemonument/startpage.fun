...
# `TableHashes`
The `TableHashes` type is used to quickly compare the content of two sets of [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) objects.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}
```
