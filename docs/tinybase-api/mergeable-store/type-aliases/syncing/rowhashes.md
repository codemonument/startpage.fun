...
# `RowHashes`
The `RowHashes` type is used to quickly compare the content of two sets of [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}}
```
