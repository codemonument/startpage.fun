...
# `ValueHashes`
The `ValueHashes` type is used to quickly compare the content of two sets of [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) objects.

```
{[valueId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}
```

It is simply an object of [`Hash`](https://tinybase.org/api/common/type-aliases/stamps/hash/) types, one for each [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/) in the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/).
