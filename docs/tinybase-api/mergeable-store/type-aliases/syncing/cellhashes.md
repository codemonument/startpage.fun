...
# `CellHashes`
The `CellHashes` type is used to quickly compare the content of two sets of [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) objects.

```
{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: {[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)}}}
```

It is simply a nested object of [`Hash`](https://tinybase.org/api/common/type-aliases/stamps/hash/) types, one for each [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), for each [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) [`Id`](https://tinybase.org/api/common/type-aliases/identity/id/), for each TableId, in the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/).
