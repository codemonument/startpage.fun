...
# `ContentHashes`
The `ContentHashes` type is used to quickly compare the content of two [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects.

```
[tablesHash: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/), valuesHash: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)]
```

It is simply an array of two [`Hash`](https://tinybase.org/api/common/type-aliases/stamps/hash/) types, one for the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/)'s [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) and one for its [`Values`](https://tinybase.org/api/store/type-aliases/store/values/).
