...
# `MergeableContent`
The `MergeableContent` type represents the content of a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) and the metadata about that content) required to merge it with another.

```
[mergeableTables: TablesStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablesstamp/)<true>, mergeableValues: ValuesStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuesstamp/)<true>]
```

It is simply an array of two [`Stamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/) types, one for the [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/)'s [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) and one for its [`Values`](https://tinybase.org/api/store/type-aliases/store/values/).
