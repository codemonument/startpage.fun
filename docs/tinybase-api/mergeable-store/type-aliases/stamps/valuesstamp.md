...
# `ValuesStamp`
The `ValuesStamp` type is used as metadata to decide how to merge two different sets of [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<{[valueId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: ValueStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuestamp/)<Hashed>}, Hashed>
```
