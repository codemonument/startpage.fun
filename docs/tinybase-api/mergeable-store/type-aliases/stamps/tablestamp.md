...
# `TableStamp`
The `TableStamp` type is used as metadata to decide how to merge two different [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) objects together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<{[rowId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: RowStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/rowstamp/)<Hashed>}, Hashed>
```
