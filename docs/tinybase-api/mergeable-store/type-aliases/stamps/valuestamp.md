...
# `ValueStamp`
The `ValueStamp` type is used as metadata to decide how to merge two different [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) objects together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<ValueOrUndefined[](https://tinybase.org/api/store/type-aliases/store/valueorundefined/), Hashed>
```
