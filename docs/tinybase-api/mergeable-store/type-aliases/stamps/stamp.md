...
# `Stamp`
The `Stamp` type is used as metadata to decide how to merge two different [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects together.

```
Hashed extends true ? [thing: Thing, hlc: Hlc[](https://tinybase.org/api/common/type-aliases/stamps/hlc/), hash: Hash[](https://tinybase.org/api/common/type-aliases/stamps/hash/)] : [thing: Thing, hlc?: Hlc[](https://tinybase.org/api/common/type-aliases/stamps/hlc/)]
```

It describes a combination of a value (or object), an [`Hlc`](https://tinybase.org/api/common/type-aliases/stamps/hlc/) timestamp, and optionally a [`Hash`](https://tinybase.org/api/common/type-aliases/stamps/hash/), all in an array.
