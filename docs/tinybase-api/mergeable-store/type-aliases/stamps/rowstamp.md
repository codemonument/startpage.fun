...
# `RowStamp`
The `RowStamp` type is used as metadata to decide how to merge two different [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<{[cellId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: CellStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/cellstamp/)<Hashed>}, Hashed>
```
