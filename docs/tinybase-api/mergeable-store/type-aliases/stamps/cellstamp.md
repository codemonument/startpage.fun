...
# `CellStamp`
The `CellStamp` type is used as metadata to decide how to merge two different [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) objects together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<CellOrUndefined[](https://tinybase.org/api/store/type-aliases/store/cellorundefined/), Hashed>
```
