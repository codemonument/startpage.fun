...
# `TablesStamp`
The `TablesStamp` type is used as metadata to decide how to merge two different sets of [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) together.

```
Stamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)<{[tableId: Id[](https://tinybase.org/api/common/type-aliases/identity/id/)]: TableStamp[](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablestamp/)<Hashed>}, Hashed>
```
