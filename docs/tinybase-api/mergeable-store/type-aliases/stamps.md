    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`mergeable-store`](https://tinybase.org/api/mergeable-store/)
        ...
        * [Type Aliases](https://tinybase.org/api/mergeable-store/type-aliases/)
          * [Mergeable type aliases](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/)
          * [Stamps type aliases](https://tinybase.org/api/mergeable-store/type-aliases/stamps/)
            * [`TablesStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablesstamp/)
            * [`TableStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablestamp/)
            * [`RowStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/rowstamp/)
            * [`CellStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/cellstamp/)
            * [`ValuesStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuesstamp/)
            * [`ValueStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuestamp/)
            * [`Stamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/)
          * [Syncing type aliases](https://tinybase.org/api/mergeable-store/type-aliases/syncing/)
...
# Stamps type aliases
## `TablesStamp`
The [`TablesStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablesstamp/) type is used as metadata to decide how to merge two different sets of [`Tables`](https://tinybase.org/api/store/type-aliases/store/tables/) together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablesstamp/).
## `TableStamp`
The [`TableStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablestamp/) type is used as metadata to decide how to merge two different [`Table`](https://tinybase.org/api/store/type-aliases/store/table/) objects together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/tablestamp/).
## `RowStamp`
The [`RowStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/rowstamp/) type is used as metadata to decide how to merge two different [`Row`](https://tinybase.org/api/store/type-aliases/store/row/) objects together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/rowstamp/).
## `CellStamp`
The [`CellStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/cellstamp/) type is used as metadata to decide how to merge two different [`Cell`](https://tinybase.org/api/store/type-aliases/store/cell/) objects together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/cellstamp/).
## `ValuesStamp`
The [`ValuesStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuesstamp/) type is used as metadata to decide how to merge two different sets of [`Values`](https://tinybase.org/api/store/type-aliases/store/values/) together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuesstamp/).
## `ValueStamp`
The [`ValueStamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuestamp/) type is used as metadata to decide how to merge two different [`Value`](https://tinybase.org/api/store/type-aliases/store/value/) objects together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/valuestamp/).
## `Stamp`
The [`Stamp`](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/) type is used as metadata to decide how to merge two different [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) objects together. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/stamps/stamp/).
