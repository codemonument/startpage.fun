...
## `MergeableChanges`
The [`MergeableChanges`](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablechanges/) type represents changes to the content of a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) and the metadata about that content) required to merge it with another. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablechanges/).
## `MergeableContent`
The [`MergeableContent`](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablecontent/) type represents the content of a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) and the metadata about that content) required to merge it with another. [Read more](https://tinybase.org/api/mergeable-store/type-aliases/mergeable/mergeablecontent/).
