...
The `createExpoSqlitePersister` function creates an [`ExpoSqlitePersister`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/) object that can persist the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local Expo-SQLite database.
...
| `db`  | `SQLiteDatabase`  | The database instance that was returned from `SQLite.openDatabase(...)`.  |  
...
| returns  | `ExpoSqlitePersister[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/)`  | A reference to the new [`ExpoSqlitePersister`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/) object.  |  
An [`ExpoSqlitePersister`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/) supports regular [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) objects, and can also be used to persist the metadata of a [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) when using the JSON serialization mode, as described below.
Note that this [`Persister`](https://tinybase.org/api/the-essentials/persisting-stores/persister/) is currently experimental as Expo themselves iterate on the underlying database library [API](https://tinybase.org/api/).
...
const persister = createExpoSqlitePersister[](https://tinybase.org/api/persister-expo-sqlite/functions/creation/createexposqlitepersister/)(store, db, 'my_tinybase');
...
This example creates a [`ExpoSqlitePersister`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/) object and persists the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) to a local SQLite database with tabular mapping.
...
const db = openDatabaseSync('my.db');
const store = createStore[](https://tinybase.org/api/store/functions/creation/createstore/)().setTables[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settables/)({pets: {fido: {species: 'dog'}}});
const persister = createExpoSqlitePersister[](https://tinybase.org/api/persister-expo-sqlite/functions/creation/createexposqlitepersister/)(store, db, {
  mode: 'tabular',
