...
```
getDb[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/getter/getdb/)(): SQLiteDatabase
```
...
console.log(persister.getDb[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/getter/getdb/)() == db);
// -> true
