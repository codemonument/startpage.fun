  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`persister-expo-sqlite`](https://tinybase.org/api/persister-expo-sqlite/)
        * [Interfaces](https://tinybase.org/api/persister-expo-sqlite/interfaces/)
          * [`ExpoSqlitePersister`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/)
            * [Getter methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/getter/)
            * [Listener methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/listener/)
            * [Lifecycle methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/lifecycle/)
            * [Load methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/)
              * [`isAutoLoading`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/isautoloading/)
              * [`load`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/load/)
              * [`startAutoLoad`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/startautoload/)
              * [`stopAutoLoad`](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/stopautoload/)
            * [Save methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/save/)
            * [Development methods](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/development/)
        * [Functions](https://tinybase.org/api/persister-expo-sqlite/functions/)
...
| returns  | `Promise<ExpoSqlitePersister[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/)>`  | A Promise containing a reference to the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object.  |  
...
await persister.startAutoLoad[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/load/startautoload/)([{pets: {fido: {species: 'dog'}}}, {}]);
...
await persister.destroy[](https://tinybase.org/api/persister-expo-sqlite/interfaces/persister/exposqlitepersister/methods/lifecycle/destroy/)();
