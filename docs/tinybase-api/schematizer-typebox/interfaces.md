...
# Interfaces
## `TypeBoxSchematizer`
The [`TypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/) interface represents a schematizer specifically for converting TypeBox schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/).
