...
v7.1.0
## `toTablesSchema`
The `toTablesSchema` method converts a mapping of TypeBox object schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/). [Read more](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/totablesschema/).
## `toValuesSchema`
The `toValuesSchema` method converts a mapping of TypeBox schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/). [Read more](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/tovaluesschema/).
