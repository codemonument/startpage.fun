  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-typebox`](https://tinybase.org/api/schematizer-typebox/)
        * [Interfaces](https://tinybase.org/api/schematizer-typebox/interfaces/)
          * [`TypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-typebox/functions/)
...
# `toTablesSchema`
The `toTablesSchema` method converts a mapping of TypeBox object schemas into a TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).

```
toTablesSchema[](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/totablesschema/)(schemas: {[tableId: string]: any}): TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `schemas`  | `{[tableId: string]: any}`  | A mapping of table IDs to TypeBox object schemas.  |  
| returns  | `TablesSchema[](https://tinybase.org/api/store/type-aliases/schema/tablesschema/)`  | A TinyBase [`TablesSchema`](https://tinybase.org/api/store/type-aliases/schema/tablesschema/).  |  
This method extracts basic type information (string, number, boolean), default values, and nullable flags from TypeBox schemas. Complex validation rules like min/max, patterns, formats, and custom validators are ignored.
## Example
...
const schematizer = createTypeBoxSchematizer[](https://tinybase.org/api/schematizer-typebox/functions/creation/createtypeboxschematizer/)();

const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/methods/conversion/totablesschema/)({
  pets: Type.Object({
    species: Type.String(),
    age: Type.Number(),
...
const store = createStore[](https://tinybase.org/api/the-essentials/creating-stores/createstore/)().setTablesSchema[](https://tinybase.org/api/store/interfaces/store/store/methods/setter/settablesschema/)(tablesSchema);
