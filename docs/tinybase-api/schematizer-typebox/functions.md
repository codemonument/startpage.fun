...
The [`createTypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/functions/creation/createtypeboxschematizer/) function creates a [`TypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/) object that can convert TypeBox schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-typebox/functions/creation/createtypeboxschematizer/).
