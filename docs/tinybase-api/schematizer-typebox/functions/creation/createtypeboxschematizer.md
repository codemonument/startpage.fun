...
The `createTypeBoxSchematizer` function creates a [`TypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/) object that can convert TypeBox schemas into TinyBase schemas.

```
createTypeBoxSchematizer[](https://tinybase.org/api/schematizer-typebox/functions/creation/createtypeboxschematizer/)(): TypeBoxSchematizer[](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/)
```
  
| returns  | `TypeBoxSchematizer[](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/)`  | A new [`TypeBoxSchematizer`](https://tinybase.org/api/schematizer-typebox/interfaces/schematizer/typeboxschematizer/) instance.  |  
| --- | --- | --- |  
