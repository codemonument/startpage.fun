...
# Interfaces
## `ValibotSchematizer`
The [`ValibotSchematizer`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/) interface represents a schematizer specifically for converting Valibot schemas into TinyBase schemas. [Read more](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/).
