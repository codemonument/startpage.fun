...
The `createValibotSchematizer` function creates a [`ValibotSchematizer`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/) object that can convert Valibot schemas into TinyBase schemas.

```
createValibotSchematizer[](https://tinybase.org/api/schematizer-valibot/functions/creation/createvalibotschematizer/)(): ValibotSchematizer[](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/)
```
  
| returns  | `ValibotSchematizer[](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/)`  | A new [`ValibotSchematizer`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/) instance.  |  
| --- | --- | --- |  
...
const tablesSchema = schematizer.toTablesSchema[](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/methods/conversion/totablesschema/)({
  pets: object({
    species: string(),
  }),
});
