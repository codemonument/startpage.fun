  ...
  * [TinyBase](https://tinybase.org/)
    ...
    * [API](https://tinybase.org/api/)
      ...
      * [`schematizer-valibot`](https://tinybase.org/api/schematizer-valibot/)
        * [Interfaces](https://tinybase.org/api/schematizer-valibot/interfaces/)
          * [`ValibotSchematizer`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/)
            * [`toTablesSchema`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/methods/conversion/totablesschema/)
            * [`toValuesSchema`](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/methods/conversion/tovaluesschema/)
        * [Functions](https://tinybase.org/api/schematizer-valibot/functions/)
...
# `toValuesSchema`
The `toValuesSchema` method converts a mapping of Valibot schemas into a TinyBase [`ValuesSchema`](https://tinybase.org/api/store/type-aliases/schema/valuesschema/).

```
toValuesSchema[](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/methods/conversion/tovaluesschema/)(schemas: {[valueId: string]: any}): ValuesSchema[](https://tinybase.org/api/store/type-aliases/schema/valuesschema/)
```
...
const schematizer = createValibotSchematizer[](https://tinybase.org/api/schematizer-valibot/functions/creation/createvalibotschematizer/)();

const valuesSchema = schematizer.toValuesSchema[](https://tinybase.org/api/schematizer-valibot/interfaces/schematizer/valibotschematizer/methods/conversion/tovaluesschema/)({
