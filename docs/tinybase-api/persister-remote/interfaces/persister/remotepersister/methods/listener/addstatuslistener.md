...
```
addStatusListener[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<RemotePersister[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/)>): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<RemotePersister[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/)>`  | The function that will be called whenever the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) starts or stops loading or saving.  |  
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
persister.delListener[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/methods/listener/dellistener/)(listenerId);
