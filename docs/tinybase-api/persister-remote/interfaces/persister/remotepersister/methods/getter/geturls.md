...
# `getUrls`
The `getUrls` method returns the URLs the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to.

```
getUrls[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/methods/getter/geturls/)(): [string, string]
```
  
| returns  | `[string, string]`  | The load and save URLs as a two-item array.  |  
| --- | --- | --- |  
## Example
This example creates a [`RemotePersister`](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/) object against a newly-created [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) and then gets the URLs back out again.
...
console.log(persister.getUrls[](https://tinybase.org/api/persister-remote/interfaces/persister/remotepersister/methods/getter/geturls/)());
