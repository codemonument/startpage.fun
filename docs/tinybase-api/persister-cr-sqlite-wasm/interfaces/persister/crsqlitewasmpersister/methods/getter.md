...
# Getter methods
## `getStore`
The [`getStore`](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/getter/getstore/) method returns a reference to the underlying [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) or [`MergeableStore`](https://tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/) that is backing this [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) object. [Read more](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/getter/getstore/).
## `getDb`
The [`getDb`](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/getter/getdb/) method returns a reference to the database instance the [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) is being persisted to. [Read more](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/getter/getdb/).
