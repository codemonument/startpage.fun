...
```
addStatusListener[](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/listener/addstatuslistener/)(listener: StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<CrSqliteWasmPersister[](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/)>): string
```
  
|   | Type  | Description  |  
| --- | --- | --- |  
| `listener`  | `StatusListener[](https://tinybase.org/api/persisters/type-aliases/listener/statuslistener/)<CrSqliteWasmPersister[](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/)>`  | The function that will be called whenever the [`Persister`](https://tinybase.org/api/persisters/interfaces/persister/persister/) starts or stops loading or saving.  |  
...
const listenerId = persister.addStatusListener[](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/listener/addstatuslistener/)((persister, status) => {
  console.log(
...
persister.delListener[](https://tinybase.org/api/persister-cr-sqlite-wasm/interfaces/persister/crsqlitewasmpersister/methods/listener/dellistener/)(listenerId);
