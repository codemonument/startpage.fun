...
# Creating A Store
This guide shows you how to create a new [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/).
Creating a [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) requires just a simple call to the [`createStore`](https://tinybase.org/api/the-essentials/creating-stores/createstore/) function from the [`store`](https://tinybase.org/api/store/) module.
...
Easy enough! The returned [`Store`](https://tinybase.org/api/the-essentials/creating-stores/store/) starts off empty of course:
...
To fix that, let's move onto the [Writing To Stores](https://tinybase.org/guides/the-basics/writing-to-stores/) guide.
